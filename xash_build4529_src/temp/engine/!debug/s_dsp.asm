; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27045.0 
	...
	TITLE	C:\Users\USER\Downloads\xash_build4529_src\engine\client\s_dsp.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
$SG138882 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\s_dsp.c', 00H
	ORG $+3
$SG138883 DB	'idelay >= 0 && idelay < MAXDLY', 00H
	ORG $+1
$SG138893 DB	'dsp_profile', 00H
$SG138886 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\s_dsp.c', 00H
	ORG $+3
...
$SG138909 DB	'delay > 0.0f && delay <= MAX_DELAY', 00H
	ORG $+1
$SG138906 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\s_dsp.c', 00H
	ORG $+3
$SG139078 DB	'room_type', 00H
	ORG $+2
$SG138908 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\s_dsp.c', 00H
	ORG $+3
$SG139089 DB	'room_lp', 00H
$SG139090 DB	'room_mod', 00H
	ORG $+3
$SG138910 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\s_dsp.c', 00H
	ORG $+3
...
; File c:\users\user\downloads\xash_build4529_src\engine\client\s_dsp.c
_TEXT	SEGMENT
_res$1 = -28						; size = 8
tv211 = -20						; size = 4
tv210 = -16						; size = 4
