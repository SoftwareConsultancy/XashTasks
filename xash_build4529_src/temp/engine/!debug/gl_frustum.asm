; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27045.0 
	...
	TITLE	C:\Users\USER\Downloads\xash_build4529_src\engine\client\gl_frustum.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	ENDS
_DATA	SEGMENT
$SG137315 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\gl_frustum.c', 00H
	ORG $+2
$SG137316 DB	'side >= 0 && side < FRUSTUM_PLANES', 00H
	ORG $+5
$SG137325 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\gl_frustum.c', 00H
	ORG $+2
$SG137326 DB	'side >= 0 && side < FRUSTUM_PLANES', 00H
	ORG $+5
$SG137337 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\gl_frustum.c', 00H
	ORG $+2
$SG137338 DB	'side >= 0 && side < FRUSTUM_PLANES', 00H
	ORG $+5
$SG137347 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\gl_frustum.c', 00H
	ORG $+2
$SG137348 DB	'side >= 0 && side < FRUSTUM_PLANES', 00H
_DATA	ENDS
; Function compile flags: /Odtp
; File c:\users\user\downloads\xash_build4529_src\engine\client\gl_frustum.c
_TEXT	SEGMENT
tv70 = -4						; size = 4
_out$ = 8						; size = 4
_side$ = 12						; size = 4
