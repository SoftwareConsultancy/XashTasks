; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27045.0 
	...
	TITLE	C:\Users\USER\Documents\GitHub\XashTasks\xash_build4529_src\engine\client\vgui\vgui_draw.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_DATA	SEGMENT
$SG143383 DB	'allow colorstrings in VGUI texts', 00H
	ORG $+3
$SG143384 DB	'0', 00H
	ORG $+2
$SG143385 DB	'vgui_colorstrings', 00H
	ORG $+2
$SG143395 DB	'VGUI_GenerateTexture: VGUI_MAX_TEXTURES limit exceeded', 0aH
	DB	00H
$SG143410 DB	'^1Error:^7 VGUI_UploadTexture: bad texture %i. Ignored', 0aH
	DB	00H
$SG143411 DB	'*vgui%i', 00H
_DATA	ENDS
; Function compile flags: /Odtp
; File c:\users\user\documents\github\xashtasks\xash_build4529_src\engine\client\vgui\vgui_draw.c
_TEXT	SEGMENT
_VGUI_GenerateTexture PROC
...
; 97   : 	r_image.buffer = (byte *)buffer;
	...
	mov	edx, DWORD PTR _buffer$[ebp]
	mov	DWORD PTR _r_image$[ebp+24], edx
...
; 144  : 		GL_Bind( GL_TEXTURE0, g_textures[id] );
	...
	mov	ecx, DWORD PTR _id$[ebp]
	mov	edx, DWORD PTR _g_textures[ecx*4]
	push	edx
	push	0
	call	_GL_Bind
	add	esp, 8
...
$LN4@VGUI_DrawS:
	...
	cmp	ecx, DWORD PTR _g_textureId
...
; 53   : 		GL_FreeTexture( g_textures[i] );
	...
	mov	eax, DWORD PTR _g_textures[edx*4]
	push	eax
