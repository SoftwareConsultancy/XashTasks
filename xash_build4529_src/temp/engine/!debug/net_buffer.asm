...
$SG131963 DB	'Unnamed', 00H
	ORG $+4
$SG131966 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\net_buffer.c', 00H
	ORG $+1
$SG131967 DB	'nBits <= nBytes * 8', 00H
	ORG $+4
$SG132030 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\net_buffer.c', 00H
	ORG $+1
$SG132031 DB	'numbits >= 0 && numbits <= 32', 00H
	ORG $+2
$SG132034 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\net_buffer.c', 00H
	ORG $+1
$SG132035 DB	'( iDWord * 4 + sizeof( long )) <= (uint)MSG_GetMaxBytes('
	DB	' sb )', 00H
	ORG $+2
$SG132047 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\net_buffer.c', 00H
	ORG $+1
$SG132048 DB	'numbits >= 1 && numbits <= 32', 00H
	ORG $+2
$SG132128 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\net_buffer.c', 00H
	ORG $+1
$SG132129 DB	'sizeof( long ) == sizeof( float )', 00H
	ORG $+6
$SG132130 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\net_buffer.c', 00H
	ORG $+1
$SG132131 DB	'sizeof( float ) == 4', 00H
	ORG $+3
$SG132222 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\net_buffer.c', 00H
	ORG $+1
$SG132223 DB	'numbits > 0 && numbits <= 32', 00H
	ORG $+3
$SG132243 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\net_buffer.c', 00H
	ORG $+1
$SG132244 DB	'sizeof( float ) == sizeof( long )', 00H
	ORG $+6
$SG132245 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\net_buffer.c', 00H
	ORG $+1
$SG132246 DB	'sizeof( float ) == 4', 00H
	ORG $+3
$SG132352 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\net_buffer.c', 00H
	ORG $+1
