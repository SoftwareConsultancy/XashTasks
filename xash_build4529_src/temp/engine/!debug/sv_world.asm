; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27045.0 
	...
	TITLE	C:\Users\USER\Documents\GitHub\XashTasks\xash_build4529_src\engine\server\sv_world.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	ENDS
_DATA	SEGMENT
$SG136603 DB	'Entity %i (%s) SOLID_BSP with a non bsp model %s', 0aH, 00H
	ORG $+2
$SG136636 DB	'''%s'' has SOLID_BSP without MOVETYPE_PUSH or MOVETYPE_P'
	DB	'USHSTEP', 0aH, 00H
	ORG $+5
$SG136777 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\server\sv_world.c', 00H
	ORG $+3
$SG136780 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\server\sv_world.c', 00H
	ORG $+3
$SG136853 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\server\sv_world.c', 00H
	ORG $+3
$SG136854 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\server\sv_world.c', 00H
	ORG $+3
$SG137019 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\server\sv_world.c', 00H
	ORG $+3
$SG137025 DB	'trigger in clipping list', 0aH, 00H
	ORG $+6
$SG137038 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\server\sv_world.c', 00H
	ORG $+3
$SG137041 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\server\sv_world.c', 00H
	ORG $+3
$SG137045 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\server\sv_world.c', 00H
	ORG $+3
$SG137303 DB	'SV_GetLightStyle: style: %i >= %d', 00H
_DATA	ENDS
; Function compile flags: /Odtp
; File c:\users\user\documents\github\xashtasks\xash_build4529_src\engine\server\sv_world.c
_TEXT	SEGMENT
_tex$ = -128						; size = 4
_size$ = -124						; size = 4
_tmax$1 = -120						; size = 4
...
; 1561 : 	float		front, back, scale, frac;
; 1562 : 	int		i, map, side, size;
; 1563 : 	float		ds, dt, s, t;
; 1564 : 	int		sample_size;
; 1565 : 	msurface_t	*surf;
; 1566 : 	mtexinfo_t	*tex;
; 1567 : 	mextrasurf_t	*info;
; 1568 : 	color24		*lm;
; 1569 : 	vec3_t		mid;
; 1570 : 
; 1571 : 	// didn't hit anything
; 1572 : 	if( !node || node->contents < 0 )
...
; 1574 : 
; 1575 : 	// calculate mid point
; 1576 : 	front = PlaneDiff( start, node->plane );
...
; 1577 : 	back = PlaneDiff( end, node->plane );
...
$LN27@SV_Recursi:
	...
	cmp	ecx, DWORD PTR _side$[ebp]
	jne	SHORT $LN10@SV_Recursi

; 1581 : 		return SV_RecursiveLightPoint( model, node->children[side], start, end );
...
; 1584 : 
; 1585 : 	VectorLerp( start, frac, end, mid );
...
; 1586 : 
; 1587 : 	// co down front side	
; 1588 : 	if( SV_RecursiveLightPoint( model, node->children[side], start, mid ))
...
; 1589 : 		return true; // hit something
...
; 1592 : 		return false;// didn't hit anything
...
; 1593 : 
; 1594 : 	// check for impact on this node
; 1595 : 	surf = model->surfaces + node->firstsurface;
...
; 1596 : 
; 1597 : 	for( i = 0; i < node->numsurfaces; i++, surf++ )
...
; 1603 : 
; 1604 : 		if( FBitSet( surf->flags, SURF_DRAWTILED ))
...
; 1605 : 			continue;	// no lightmaps

	jmp	SHORT $LN2@SV_Recursi
$LN13@SV_Recursi:

; 1606 : 
; 1607 : 		s = DotProduct( mid, info->lmvecs[0] ) + info->lmvecs[0][3];
...
; 1608 : 		t = DotProduct( mid, info->lmvecs[1] ) + info->lmvecs[1][3];
...
; 1609 : 
; 1610 : 		if( s < info->lightmapmins[0] || t < info->lightmapmins[1] )
...
; 1615 : 		
; 1616 : 		if ( ds > info->lightextents[0] || dt > info->lightextents[1] )
...
; 1621 : 
; 1622 : 		sample_size = Mod_SampleSizeForFace( surf );
...
; 1623 : 		smax = (info->lightextents[0] / sample_size) + 1;
...
; 1624 : 		tmax = (info->lightextents[1] / sample_size) + 1;
...
; 1627 : 
; 1628 : 		VectorClear( sv_pointColor );
...
; 1629 : 
; 1630 : 		lm = surf->samples + Q_rint( dt ) * smax + Q_rint( ds );
...
$LN33@SV_Recursi:
	...
	imul	eax, DWORD PTR _smax$2[ebp]
	imul	ecx, eax, 3
	mov	edx, DWORD PTR _surf$[ebp]
	mov	eax, DWORD PTR [edx+84]
	add	eax, ecx
	imul	ecx, DWORD PTR tv401[ebp], 3
	add	eax, ecx
...
; 1631 : 		size = smax * tmax;
	...
	imul	edx, DWORD PTR _tmax$1[ebp]
	mov	DWORD PTR _size$[ebp], edx

; 1632 : 
; 1633 : 		for( map = 0; map < MAXLIGHTMAPS && surf->styles[map] != 255; map++ )
...
; 1634 : 		{
; 1635 : 			scale = sv.lightstyles[surf->styles[map]].value;

	mov	eax, DWORD PTR _surf$[ebp]
	add	eax, DWORD PTR _map$[ebp]
	movzx	ecx, BYTE PTR [eax+60]
	imul	edx, ecx, 1296
	movss	xmm0, DWORD PTR _sv[edx+334284]
	movss	DWORD PTR _scale$[ebp], xmm0

; 1636 : 
; 1637 : 			sv_pointColor[0] += lm->r * scale;
...
; 1638 : 			sv_pointColor[1] += lm->g * scale;
...
; 1639 : 			sv_pointColor[2] += lm->b * scale;
...
; 1640 : 
; 1641 : 			lm += size; // skip to next lightmap

	imul	edx, DWORD PTR _size$[ebp], 3
...
; 1645 : 
; 1646 : 	// go down back side
; 1647 : 	return SV_RecursiveLightPoint( model, node->children[!side], mid, end );
...
; 1313 : 	trace_t	trace;
; 1314 : 
; 1315 : 	for( l = node->solid_edicts.next; l != &node->solid_edicts; l = next )
...
; 1320 : 
; 1321 : 		if( touch->v.solid != SOLID_BSP || touch == clip->passedict || !( touch->v.flags & FL_WORLDBRUSH ))
...
; 1323 : 
; 1324 : 		if( !BoundsIntersect( clip->boxmins, clip->boxmaxs, touch->v.absmin, touch->v.absmax ))
...
; 1326 : 
; 1327 : 		if( clip->trace.allsolid ) return;
...
; 1328 : 
; 1329 : 		SV_ClipMoveToEntity( touch, clip->start, clip->mins, clip->maxs, clip->end, &trace );
...
; 1330 : 
; 1331 : 		clip->trace = World_CombineTraces( &clip->trace, &trace, touch );
...
; 1333 : 
; 1334 : 	// recurse down both sides
; 1335 : 	if( node->axis == -1 ) return;
...
; 1336 : 
; 1337 : 	if( clip->boxmaxs[node->axis] > node->dist )
...
; 1338 : 		SV_ClipToWorldBrush( node->children[0], clip );
...
; 1339 : 
; 1340 : 	if( clip->boxmins[node->axis] < node->dist )
...
; 1341 : 		SV_ClipToWorldBrush( node->children[1], clip );
...
; 1280 : 	edict_t	*touch;
; 1281 : 
; 1282 : 	// touch linked edicts
; 1283 : 	for( l = node->portal_edicts.next; l != &node->portal_edicts; l = next )
...
; 1288 : 
; 1289 : 		if( !SV_ClipToEntity( touch, clip ))
...
; 1292 : 
; 1293 : 	// recurse down both sides
; 1294 : 	if( node->axis == -1 ) return;
...
; 1295 : 
; 1296 : 	if( clip->boxmaxs[node->axis] > node->dist )
...
; 1297 : 		SV_ClipToPortals( node->children[0], clip );
...
; 1298 : 	if( clip->boxmins[node->axis] < node->dist )
...
; 1299 : 		SV_ClipToPortals( node->children[1], clip );
...
; 1248 : 	edict_t	*touch;
; 1249 : 
; 1250 : 	// touch linked edicts
; 1251 : 	for( l = node->solid_edicts.next; l != &node->solid_edicts; l = next )
...
; 1256 : 
; 1257 : 		if( !SV_ClipToEntity( touch, clip ))
...
; 1260 : 
; 1261 : 	// recurse down both sides
; 1262 : 	if( node->axis == -1 ) return;
...
; 1263 : 
; 1264 : 	if( clip->boxmaxs[node->axis] > node->dist )
...
; 1265 : 		SV_ClipToLinks( node->children[0], clip );
...
; 1266 : 	if( clip->boxmins[node->axis] < node->dist )
...
; 1267 : 		SV_ClipToLinks( node->children[1], clip );
...
; 1144 : 	model_t	*mod;
; 1145 : 
; 1146 : 	if( touch->v.groupinfo && SV_IsValidEdict( clip->passedict ) && clip->passedict->v.groupinfo != 0 )
...
; 1147 : 	{
; 1148 : 		if( svs.groupop == GROUP_OP_AND && !FBitSet( touch->v.groupinfo, clip->passedict->v.groupinfo ))
...
; 1150 : 
; 1151 : 		if( svs.groupop == GROUP_OP_NAND && FBitSet( touch->v.groupinfo, clip->passedict->v.groupinfo ))
...
; 1153 : 	}
; 1154 : 
; 1155 : 	if( touch == clip->passedict || touch->v.solid == SOLID_NOT )
...
; 1157 : 
; 1158 : 	if( touch->v.solid == SOLID_TRIGGER )

	mov	ecx, DWORD PTR _touch$[ebp]
	cmp	DWORD PTR [ecx+396], 1
	jne	SHORT $LN7@SV_ClipToE

; 1159 : 		Host_Error( "trigger in clipping list\n" );
...
; 1160 : 
; 1161 : 	// custom user filter
; 1162 : 	if( svgame.dllFuncs2.pfnShouldCollide )

	cmp	DWORD PTR _svgame+19448, 0
	je	SHORT $LN9@SV_ClipToE

; 1163 : 	{
; 1164 : 		if( !svgame.dllFuncs2.pfnShouldCollide( touch, clip->passedict ))
...
; 1166 : 	}
; 1167 : 
; 1168 : 	// monsterclip filter (solid custom is a static or dynamic bodies)
; 1169 : 	if( touch->v.solid == SOLID_BSP || touch->v.solid == SOLID_CUSTOM )
...
; 1170 : 	{
; 1171 : 		// func_monsterclip works only with monsters that have same flag!
; 1172 : 		if( FBitSet( touch->v.flags, FL_MONSTERCLIP ) && !clip->monsterclip )
...
; 1175 : 	else
; 1176 : 	{
; 1177 : 		// ignore all monsters but pushables
; 1178 : 		if( clip->type == MOVE_NOMONSTERS && touch->v.movetype != MOVETYPE_PUSHSTEP )
...
; 1180 : 	}
; 1181 : 
; 1182 : 	mod = SV_ModelHandle( touch->v.modelindex );
...
; 1183 : 
; 1184 : 	if( mod && mod->type == mod_brush && clip->ignoretrans )
...
; 1185 : 	{
; 1186 : 		// we ignore brushes with rendermode != kRenderNormal and without FL_WORLDBRUSH set
; 1187 : 		if( touch->v.rendermode != kRenderNormal && !FBitSet( touch->v.flags, FL_WORLDBRUSH ))
...
; 1189 : 	}
; 1190 : 
; 1191 : 	if( !BoundsIntersect( clip->boxmins, clip->boxmaxs, touch->v.absmin, touch->v.absmax ))
...
; 1193 : 
; 1194 : 	// aditional check to intersects clients with sphere
; 1195 : 	if( touch->v.solid != SOLID_SLIDEBOX && !SV_CheckSphereIntersection( touch, clip->start, clip->end ))
...
; 1197 : 
; 1198 : 	// Xash3D extension
; 1199 : 	if( SV_IsValidEdict( clip->passedict ) && clip->passedict->v.solid == SOLID_TRIGGER )

	push	1199					; 000004afH
	push	OFFSET $SG137038
	mov	edx, DWORD PTR _clip$[ebp]
	mov	eax, DWORD PTR [edx+64]
	push	eax
	call	_SV_CheckEdict
...
; 1200 : 	{
; 1201 : 		// never collide items and player (because call "give" always stuck item in player
; 1202 : 		// and total trace returns fail (old half-life bug)
; 1203 : 		// items touch should be done in SV_TouchLinks not here
; 1204 : 		if( FBitSet( touch->v.flags, FL_CLIENT|FL_FAKECLIENT ))
...
; 1206 : 	}
; 1207 : 
; 1208 : 	// g-cont. make sure what size is really zero - check all the components
; 1209 : 	if( SV_IsValidEdict( clip->passedict ) && !VectorIsNull( clip->passedict->v.size ) && VectorIsNull( touch->v.size ))

	push	1209					; 000004b9H
	push	OFFSET $SG137041
	mov	edx, DWORD PTR _clip$[ebp]
	mov	eax, DWORD PTR [edx+64]
	push	eax
	call	_SV_CheckEdict
	...
	mov	ecx, 4
	shl	ecx, 0
	movss	xmm0, DWORD PTR [eax+ecx+372]
	ucomiss	xmm0, DWORD PTR __real@00000000
	lahf
	test	ah, 68					; 00000044H
	jp	SHORT $LN22@SV_ClipToE
...
; 1210 : 		return true; // points never interact
...
; 1211 : 
; 1212 : 	// might intersect, so do an exact clip
; 1213 : 	if( clip->trace.allsolid ) return false;
...
; 1214 : 
; 1215 : 	if( SV_IsValidEdict( clip->passedict ))

	push	1215					; 000004bfH
	push	OFFSET $SG137045
	mov	ecx, DWORD PTR _clip$[ebp]
	mov	edx, DWORD PTR [ecx+64]
	push	edx
	call	_SV_CheckEdict
...
; 1216 : 	{
; 1217 : 	 	if( touch->v.owner == clip->passedict )
...
; 1218 : 			return true; // don't clip against own missiles

	mov	eax, 1
	jmp	$LN1@SV_ClipToE
$LN25@SV_ClipToE:

; 1219 : 		if( clip->passedict->v.owner == touch )
...
; 1220 : 			return true; // don't clip against owner
...
; 1221 : 	}
; 1222 : 
; 1223 : 	// make sure we don't hit the world if we're inside the portal
; 1224 : 	if( touch->v.solid == SOLID_PORTAL )

	mov	eax, DWORD PTR _touch$[ebp]
	cmp	DWORD PTR [eax+396], 6
	jne	SHORT $LN27@SV_ClipToE

; 1225 : 		SV_PortalCSG( touch, clip->mins, clip->maxs, clip->start, clip->end, &clip->trace );
...
; 1226 : 
; 1227 : 	if( touch->v.solid == SOLID_CUSTOM )

	mov	edx, DWORD PTR _touch$[ebp]
	cmp	DWORD PTR [edx+396], 5
	jne	SHORT $LN28@SV_ClipToE

; 1228 : 		SV_CustomClipMoveToEntity( touch, clip->start, clip->mins, clip->maxs, clip->end, &trace );
...
; 1229 : 	else if( FBitSet( touch->v.flags, FL_MONSTER ))
...
; 1230 : 		SV_ClipMoveToEntity( touch, clip->start, clip->mins2, clip->maxs2, clip->end, &trace );
...
; 1231 : 	else SV_ClipMoveToEntity( touch, clip->start, clip->mins, clip->maxs, clip->end, &trace );
...
; 1232 : 
; 1233 : 	clip->trace = World_CombineTraces( &clip->trace, &trace, touch );
...
_model$ = -152						; size = 4
_frac$4 = -148						; size = 4
_portalradius$ = -144					; size = 4
_bestfrac$ = -140					; size = 4
_k$ = -136						; size = 4
_hitplane$ = -132					; size = 4
_plane$ = -128						; size = 4
_nearest$5 = -124					; size = 12
_planes$ = -112						; size = 96
_worldpos$ = -16					; size = 12
__$ArrayPad$ = -4					; size = 4
_portal$ = 8						; size = 4
...
; 1023 : 	else VectorCopy( trace->endpos, worldpos );
	...
	mov	DWORD PTR _worldpos$[ebp+ecx], edx
	mov	eax, 4
	shl	eax, 0
	mov	ecx, 4
	shl	ecx, 0
	...
	mov	DWORD PTR _worldpos$[ebp+edx], ecx
$LN15@SV_PortalC:
...
; 1034 : 	planes[2][3] = DotProduct( portal->v.origin, planes[2] ) - portalradius;
	...
	imul	ecx, ecx, 0
	mov	esi, DWORD PTR _portal$[ebp]
	movss	xmm0, DWORD PTR [esi+eax+136]
	mulss	xmm0, DWORD PTR [edx+ecx]
	mov	edx, 4
	shl	edx, 0
	mov	eax, 16					; 00000010H
...
; 1035 : 	planes[3][3] = DotProduct( portal->v.origin, planes[3] ) - portalradius;
	...
	mov	eax, 16					; 00000010H
	imul	ecx, eax, 3
	lea	eax, DWORD PTR _planes$[ebp+ecx]
	mov	ecx, 4
	imul	ecx, ecx, 0
	mov	esi, DWORD PTR _portal$[ebp]
	movss	xmm0, DWORD PTR [esi+edx+136]
...
; 1042 : 		float	d = DotProduct( worldpos, planes[plane] );
	...
	mov	eax, 4
	imul	eax, eax, 0
	movss	xmm0, DWORD PTR _worldpos$[ebp+edx]
	mulss	xmm0, DWORD PTR [ecx+eax]
	mov	ecx, 4
	shl	ecx, 0
	...
	mov	edx, 4
	shl	edx, 0
	movss	xmm1, DWORD PTR _worldpos$[ebp+ecx]
	mulss	xmm1, DWORD PTR [eax+edx]
	addss	xmm0, xmm1
	mov	eax, 4
	shl	eax, 1
...
$LN29@SV_PortalC:
	...
	movss	DWORD PTR _nearest$5[ebp+ecx*4], xmm0
...
; 1051 : 			planes[plane][3] -= DotProduct( nearest, planes[plane] );
	...
	mov	edi, 4
	imul	edi, edi, 0
	movss	xmm0, DWORD PTR _nearest$5[ebp+ecx]
	...
	mov	edi, 4
	shl	edi, 0
	movss	xmm1, DWORD PTR _nearest$5[ebp+ecx]
...
; 1076 : 			frac = (ds) / (ds - de);
	...
	divss	xmm1, xmm0
	movss	DWORD PTR _frac$4[ebp], xmm1

; 1077 : 			if( frac < bestfrac )

	movss	xmm0, DWORD PTR _bestfrac$[ebp]
	comiss	xmm0, DWORD PTR _frac$4[ebp]
	jbe	SHORT $LN22@SV_PortalC
...
; 1080 : 					frac = 0;
	...
	xorps	xmm0, xmm0
	movss	DWORD PTR _frac$4[ebp], xmm0
$LN23@SV_PortalC:

; 1081 : 				bestfrac = frac;

	movss	xmm0, DWORD PTR _frac$4[ebp]
	movss	DWORD PTR _bestfrac$[ebp], xmm0

; 1082 : 				hitplane = plane;

	mov	edx, DWORD PTR _plane$[ebp]
	mov	DWORD PTR _hitplane$[ebp], edx
$LN22@SV_PortalC:
...
; 1100 : 		VectorCopy( planes[hitplane], trace->plane.normal );
	...
	mov	edx, DWORD PTR _hitplane$[ebp]
	shl	edx, 4
	lea	eax, DWORD PTR _planes$[ebp+edx]
	mov	ecx, 4
	shl	ecx, 0
...
; 601  : 		if( ent->num_leafs > ( MAX_ENT_LEAFS - 1 ))
	...
	cmp	DWORD PTR [edx+20], 47			; 0000002fH
...
$LN12@SV_FindTou:
	...
	comiss	xmm0, DWORD PTR [ecx+eax*4+336]
...
; 446  : 	VectorCopy( mins, mins2 );	
	...
	mov	DWORD PTR _mins2$[ebp+ecx], edx
	mov	eax, 4
	shl	eax, 0
	mov	ecx, 4
	shl	ecx, 0
	...
	mov	DWORD PTR _mins2$[ebp+edx], ecx
...
; 447  : 	VectorCopy( maxs, maxs1 );	
	...
	mov	ecx, DWORD PTR _maxs$[ebp]
	mov	eax, DWORD PTR [ecx+eax]
	mov	DWORD PTR _maxs1$[ebp+edx], eax
	mov	ecx, 4
	shl	ecx, 0
	mov	edx, 4
	shl	edx, 0
	mov	eax, DWORD PTR _maxs$[ebp]
	mov	ecx, DWORD PTR [eax+ecx]
	mov	DWORD PTR _maxs1$[ebp+edx], ecx
	mov	edx, 4
	shl	edx, 1
	mov	eax, 4
	shl	eax, 1
...
; 450  : 	maxs1[anode->axis] = mins2[anode->axis] = anode->dist;
	...
	mov	DWORD PTR _mins2$[ebp+edx*4], ecx
	mov	edx, DWORD PTR _anode$[ebp]
	mov	eax, DWORD PTR [edx]
	mov	ecx, DWORD PTR _anode$[ebp]
	mov	edx, DWORD PTR [ecx]
	mov	eax, DWORD PTR _mins2$[ebp+eax*4]
	mov	DWORD PTR _maxs1$[ebp+edx*4], eax

; 451  : 	anode->children[0] = SV_CreateAreaNode( depth+1, mins2, maxs2 );

	lea	ecx, DWORD PTR _maxs2$[ebp]
	push	ecx
	lea	edx, DWORD PTR _mins2$[ebp]
	push	edx
...
; 452  : 	anode->children[1] = SV_CreateAreaNode( depth+1, mins1, maxs1 );
	...
	lea	edx, DWORD PTR _maxs1$[ebp]
	push	edx
	lea	eax, DWORD PTR _mins1$[ebp]
	push	eax
...
_TEXT	SEGMENT
_iBlend$1 = -76						; size = 4
_pseqdesc$2 = -72					; size = 4
tv167 = -68						; size = 4
tv93 = -64						; size = 4
$T3 = -60						; size = 4
_pstudio$4 = -56					; size = 4
_useComplexHull$ = -52					; size = 4
_hull$ = -48						; size = 4
_controller$5 = -44					; size = 4
_scale$ = -40						; size = 4
_mod$ = -36						; size = 4
_blending$6 = -32					; size = 2
_angles$7 = -28						; size = 12
_size$ = -16						; size = 12
__$ArrayPad$ = -4					; size = 4
_ent$ = 8						; size = 4
_mins$ = 12						; size = 4
...
; 342  : 	if( VectorIsNull( size ) && !FBitSet( svgame.globals->trace_flags, FTRACE_SIMPLEBOX ))
	...
	mov	edx, 4
	shl	edx, 1
	movss	xmm0, DWORD PTR _size$[ebp+edx]
	ucomiss	xmm0, DWORD PTR __real@00000000
	lahf
	test	ah, 68					; 00000044H
	jp	$LN6@SV_HullFor
...
; 376  : 			pstudio = Mod_StudioExtradata( mod );
	...
	add	esp, 4
	mov	DWORD PTR _pstudio$4[ebp], eax

; 377  : 			pseqdesc = (mstudioseqdesc_t *)((byte *)pstudio + pstudio->seqindex) + ent->v.sequence;

	mov	ecx, DWORD PTR _pstudio$4[ebp]
	mov	edx, DWORD PTR _pstudio$4[ebp]
	add	edx, DWORD PTR [ecx+168]
	mov	eax, DWORD PTR _ent$[ebp]
	imul	ecx, DWORD PTR [eax+424], 176
	add	edx, ecx
	mov	DWORD PTR _pseqdesc$2[ebp], edx
...
; 378  : 			VectorCopy( ent->v.angles, angles );
	...
	mov	DWORD PTR _angles$7[ebp+edx], eax
	mov	ecx, 4
	shl	ecx, 0
	mov	edx, 4
	shl	edx, 0
	...
	mov	DWORD PTR _angles$7[ebp+edx], ecx
	mov	edx, 4
	shl	edx, 1
	mov	eax, 4
	shl	eax, 1
	...
	mov	DWORD PTR _angles$7[ebp+eax], edx
...
; 380  : 			SV_StudioPlayerBlend( pseqdesc, &iBlend, &angles[PITCH] );
	...
	mov	eax, 4
	imul	ecx, eax, 0
	lea	edx, DWORD PTR _angles$7[ebp+ecx]
	push	edx
	lea	eax, DWORD PTR _iBlend$1[ebp]
	push	eax
	mov	ecx, DWORD PTR _pseqdesc$2[ebp]
	push	ecx
...
; 384  : 			blending[0] = (byte)iBlend;
	...
	mov	edx, 1
	imul	eax, edx, 0
	mov	cl, BYTE PTR _iBlend$1[ebp]
	mov	BYTE PTR _blending$6[ebp+eax], cl
...
$LN14@SV_HullFor:
	...
	mov	BYTE PTR _blending$6[ebp+edx], 0
...
; 387  : 			hull = Mod_HullForStudio( mod, ent->v.frame, ent->v.sequence, angles, ent->v.origin, size, controller, blending, numhitboxes, ent );
	...
	push	ecx
	lea	edx, DWORD PTR _blending$6[ebp]
	push	edx
	...
	push	edx
	lea	eax, DWORD PTR _angles$7[ebp]
	push	eax
	mov	ecx, DWORD PTR _ent$[ebp]
...
tv138 = -36						; size = 4
_hull$ = -32						; size = 4
_hullmins$ = -28					; size = 12
_hullmaxs$ = -16					; size = 12
__$ArrayPad$ = -4					; size = 4
_ent$ = 8						; size = 4
_mins$ = 12						; size = 4
_maxs$ = 16						; size = 4
_offset$ = 20						; size = 4
_SV_HullForEntity PROC
...
; 310  : 		VectorSubtract( ent->v.maxs, mins, hullmaxs );
	...
	mov	ecx, DWORD PTR _ent$[ebp]
	mov	esi, DWORD PTR _mins$[ebp]
	movss	xmm0, DWORD PTR [ecx+eax+360]
	subss	xmm0, DWORD PTR [esi+edx]
	mov	edx, 4
	imul	eax, edx, 0
	...
	mov	ecx, DWORD PTR _ent$[ebp]
	mov	esi, DWORD PTR _mins$[ebp]
	movss	xmm0, DWORD PTR [ecx+edx+360]
	subss	xmm0, DWORD PTR [esi+eax]
...
tv142 = -40						; size = 4
_lastdiff$ = -36					; size = 4
_hullNumber$ = -32					; size = 4
_curdiff$ = -28						; size = 4
_hull$ = -24						; size = 4
_i$ = -20						; size = 4
_clip_size$ = -16					; size = 12
__$ArrayPad$ = -4					; size = 4
_model$ = 8						; size = 4
_mins$ = 12						; size = 4
_maxs$ = 16						; size = 4
...
; 191  : 		VectorSubtract( model->hulls[i].clip_maxs, model->hulls[i].clip_mins, clip_size );
	...
	mov	edx, 4
	imul	eax, edx, 0
	movss	DWORD PTR _clip_size$[ebp+eax], xmm0
	imul	ecx, DWORD PTR _i$[ebp], 40
	mov	edx, DWORD PTR _model$[ebp]
	lea	eax, DWORD PTR [edx+ecx+208]
	mov	ecx, 4
	...
	mov	esi, DWORD PTR _model$[ebp]
	lea	edx, DWORD PTR [esi+edx+208]
	mov	esi, 4
	shl	esi, 0
	movss	xmm0, DWORD PTR [eax+ecx+28]
	subss	xmm0, DWORD PTR [edx+esi+16]
	mov	eax, 4
	shl	eax, 0
	movss	DWORD PTR _clip_size$[ebp+eax], xmm0
	imul	ecx, DWORD PTR _i$[ebp], 40
...
; 192  : 		curdiff = floor( VectorAvg( size )) - floor( VectorAvg( clip_size ));
	...
	mov	eax, 4
	shl	eax, 0
	movss	xmm1, DWORD PTR _clip_size$[ebp+edx]
	addss	xmm1, DWORD PTR _clip_size$[ebp+eax]
	mov	ecx, 4
	shl	ecx, 1
	addss	xmm1, DWORD PTR _clip_size$[ebp+ecx]
...
; 197  : 			hullNumber = i;
	...
	mov	DWORD PTR _hullNumber$[ebp], edx
...
; 166  : 	box_planes[3].dist = mins[1];
	...
	mov	eax, DWORD PTR _mins$[ebp]
	mov	edx, DWORD PTR [eax+edx]
	mov	DWORD PTR _box_planes[ecx+12], edx
...
tv146 = -56						; size = 4
_mod$ = -52						; size = 4
_radiusSquared$ = -48					; size = 4
_pseqdesc$ = -44					; size = 4
_sequence$ = -40					; size = 4
_pstudiohdr$ = -36					; size = 4
_i$ = -32						; size = 4
_traceOrg$ = -28					; size = 12
_traceDir$ = -16					; size = 12
__$ArrayPad$ = -4					; size = 4
_ent$ = 8						; size = 4
_start$ = 12						; size = 4
_end$ = 16						; size = 4
_SV_CheckSphereIntersection PROC
...
; 149  : 	return SphereIntersect( ent->v.origin, radiusSquared, traceOrg, traceDir );
	...
	lea	edx, DWORD PTR _traceDir$[ebp]
	push	edx
	lea	eax, DWORD PTR _traceOrg$[ebp]
	push	eax
	push	ecx
...
; 66   : 		box_clipnodes[i].planenum = i;
	...
	mov	ecx, DWORD PTR _i$[ebp]
	mov	edx, DWORD PTR _i$[ebp]
	mov	DWORD PTR _box_clipnodes[ecx*8], edx
...
; 70   : 		box_clipnodes[i].children[side] = CONTENTS_EMPTY;
	...
	or	edx, -1
	mov	eax, DWORD PTR _i$[ebp]
	mov	WORD PTR _box_clipnodes[ecx+eax*8+4], dx
...
; 71   : 		if( i != 5 ) box_clipnodes[i].children[side^1] = i + 1;
	...
	shl	edx, 1
	mov	eax, DWORD PTR _i$[ebp]
	mov	WORD PTR _box_clipnodes[edx+eax*8+4], cx
...
; 74   : 		box_planes[i].type = i>>1;
	...
	mov	BYTE PTR _box_planes[edx+16], cl
...
; 76   : 		box_planes[i].signbits = 0;
	...
	imul	edx, DWORD PTR _i$[ebp], 20
	mov	BYTE PTR _box_planes[edx+17], 0
...
; 1724 : 	vec3_t	start, end;
; 1725 : 
; 1726 : 	if( FBitSet( pEdict->v.effects, EF_FULLBRIGHT ) || !sv.worldmodel->lightdata )
...
; 1728 : 
; 1729 : 	// player has more precision light level that come from client-side
; 1730 : 	if( FBitSet( pEdict->v.flags, FL_CLIENT ))
...
; 1731 : 		return pEdict->v.light_level;
...
; 1732 : 
; 1733 : 	VectorCopy( pEdict->v.origin, start );
...
; 1734 : 	VectorCopy( pEdict->v.origin, end );
...
; 1735 : 
; 1736 : 	if( FBitSet( pEdict->v.effects, EF_INVLIGHT ))
...
; 1737 : 		end[2] = start[2] + world.size[2];
	...
	addss	xmm0, DWORD PTR _world[edx+2624]
	mov	eax, 4
	shl	eax, 1
...
; 1738 : 	else end[2] = start[2] - world.size[2];
	...
	shl	edx, 1
	movss	xmm0, DWORD PTR _start$[ebp+ecx]
	subss	xmm0, DWORD PTR _world[edx+2624]
	mov	eax, 4
	shl	eax, 1
	movss	DWORD PTR _end$[ebp+eax], xmm0
$LN6@SV_LightFo:

; 1739 : 	VectorSet( sv_pointColor, 1.0f, 1.0f, 1.0f );
...
; 1740 : 
; 1741 : 	SV_RecursiveLightPoint( sv.worldmodel, sv.worldmodel->nodes, start, end );
...
; 1742 : 
; 1743 : 	return VectorAvg( sv_pointColor );

	mov	ecx, 4
	imul	edx, ecx, 0
	mov	eax, 4
	shl	eax, 0
	movss	xmm0, DWORD PTR _sv_pointColor[edx]
	addss	xmm0, DWORD PTR _sv_pointColor[eax]
	mov	ecx, 4
	shl	ecx, 1
	addss	xmm0, DWORD PTR _sv_pointColor[ecx]
...
; 1709 : 	if( style >= MAX_LIGHTSTYLES )

	cmp	DWORD PTR _style$[ebp], 64		; 00000040H
	jl	SHORT $LN3@SV_GetLigh

; 1710 : 		Host_Error( "SV_GetLightStyle: style: %i >= %d", style, MAX_LIGHTSTYLES );
...
; 1711 : 
; 1712 : 	return sv.lightstyles[style].pattern;

	imul	eax, DWORD PTR _style$[ebp], 1296
	add	eax, OFFSET _sv+333000
...
; 1679 : 	int	j, k;
; 1680 : 
; 1681 : 	Q_strncpy( sv.lightstyles[style].pattern, s, sizeof( sv.lightstyles[0].pattern ));
...
; 1682 : 	sv.lightstyles[style].time = f;

	imul	edx, DWORD PTR _style$[ebp], 1296
	movss	xmm0, DWORD PTR _f$[ebp]
	movss	DWORD PTR _sv[edx+334292], xmm0
...
; 1685 : 	sv.lightstyles[style].length = j;

	imul	ecx, DWORD PTR _style$[ebp], 1296
	mov	edx, DWORD PTR _j$[ebp]
	mov	DWORD PTR _sv[ecx+334280], edx
...
; 1688 : 		sv.lightstyles[style].map[k] = (float)(s[k] - 'a');
	...
	imul	ecx, DWORD PTR _style$[ebp], 1296
	mov	edx, DWORD PTR _k$[ebp]
	movss	DWORD PTR _sv[ecx+edx*4+333256], xmm0
	jmp	SHORT $LN2@SV_SetLigh
$LN3@SV_SetLigh:

; 1689 : 
; 1690 : 	if( sv.state != ss_active ) return;
...
; 1691 : 
; 1692 : 	// tell the clients about changed lightstyle
; 1693 : 	MSG_BeginServerCmd( &sv.reliable_datagram, svc_lightstyle );
...
; 1694 : 	MSG_WriteByte( &sv.reliable_datagram, style );
...
; 1695 : 	MSG_WriteString( &sv.reliable_datagram, sv.lightstyles[style].pattern );
...
; 1696 : 	MSG_WriteFloat( &sv.reliable_datagram, sv.lightstyles[style].time );

	imul	edx, DWORD PTR _style$[ebp], 1296
	push	ecx
	movss	xmm0, DWORD PTR _sv[edx+334292]
	movss	DWORD PTR [esp], xmm0
	push	OFFSET _sv+1195756
...
; 1652 : 	int		i, ofs;
; 1653 : 	lightstyle_t	*ls;
; 1654 : 	float		scale;
; 1655 : 
; 1656 : 	scale = sv_lighting_modulate->value;
...
; 1657 : 
; 1658 : 	// run lightstyles animation
; 1659 : 	for( i = 0, ls = sv.lightstyles; i < MAX_LIGHTSTYLES; i++, ls++ )

	mov	DWORD PTR _i$[ebp], 0
	mov	DWORD PTR _ls$[ebp], OFFSET _sv+333000
...
; 1662 : 		ofs = (ls->time * 10);
	...
	mov	edx, DWORD PTR _ls$[ebp]
	movss	xmm0, DWORD PTR [edx+1292]
	mulss	xmm0, DWORD PTR __real@41200000
	cvttss2si eax, xmm0
	mov	DWORD PTR _ofs$[ebp], eax

; 1663 : 
; 1664 : 		if( ls->length == 0 ) ls->value = scale; // disable this light
	...
	movss	DWORD PTR [edx+1284], xmm0
	jmp	SHORT $LN8@SV_RunLigh
$LN5@SV_RunLigh:

; 1665 : 		else if( ls->length == 1 ) ls->value = ( ls->map[0] / 12.0f ) * scale;
	...
	imul	edx, ecx, 0
	mov	eax, DWORD PTR _ls$[ebp]
	movss	xmm0, DWORD PTR [eax+edx+256]
...
; 1666 : 		else ls->value = ( ls->map[ofs % ls->length] / 12.0f ) * scale;
...
; 578  : 	if( ent->v.absmax[node->axis] > node->dist )
	...
	mov	edx, DWORD PTR _ent$[ebp]
	mov	eax, DWORD PTR _node$[ebp]
	movss	xmm0, DWORD PTR [edx+ecx*4+336]
...
; 580  : 	if( ent->v.absmin[node->axis] < node->dist )
	...
	mov	eax, DWORD PTR _ent$[ebp]
	movss	xmm0, DWORD PTR [edx+4]
	comiss	xmm0, DWORD PTR [eax+ecx*4+324]
...
; 638  : 	if( ent == svgame.edicts ) return;		// don't add the world
	...
	mov	edx, DWORD PTR _ent$[ebp]
	cmp	edx, DWORD PTR _svgame+7928
...
; 658  : 			SV_FindTouchedLeafs( ent, sv.worldmodel->nodes, &headnode );
	...
	lea	ecx, DWORD PTR _headnode$[ebp]
	push	ecx
	mov	edx, DWORD PTR _sv+1359676
...
; 660  : 		if( ent->num_leafs > MAX_ENT_LEAFS )
	...
	mov	edx, DWORD PTR _ent$[ebp]
	cmp	DWORD PTR [edx+20], 48			; 00000030H
...
; 678  : 		if( ent->v.absmin[node->axis] > node->dist )
	...
	mov	ecx, DWORD PTR _ent$[ebp]
	mov	edx, DWORD PTR _node$[ebp]
	movss	xmm0, DWORD PTR [ecx+eax*4+324]
	comiss	xmm0, DWORD PTR [edx+4]
...
; 680  : 		else if( ent->v.absmax[node->axis] < node->dist )
	...
	mov	ecx, DWORD PTR _ent$[ebp]
	movss	xmm0, DWORD PTR [eax+4]
	comiss	xmm0, DWORD PTR [ecx+edx*4+336]
...
_trace$ = -132						; size = 56
_end$ = -76						; size = 12
_original_avelocity$ = -64				; size = 12
_original_angles$ = -52					; size = 12
_original_velocity$ = -40				; size = 12
_original_origin$ = -28					; size = 12
_move$ = -16						; size = 12
__$ArrayPad$ = -4					; size = 4
$T2 = 8							; size = 4
_tossent$ = 12						; size = 4
...
; 1509 : 	float 	gravity;
; 1510 : 	vec3_t	move, end;
; 1511 : 	vec3_t	original_origin;
; 1512 : 	vec3_t	original_velocity;
; 1513 : 	vec3_t	original_angles;
; 1514 : 	vec3_t	original_avelocity;
; 1515 : 	trace_t	trace;
; 1516 : 	int	i;
; 1517 : 
; 1518 : 	VectorCopy( tossent->v.origin, original_origin );
...
; 1519 : 	VectorCopy( tossent->v.velocity, original_velocity );
...
; 1520 : 	VectorCopy( tossent->v.angles, original_angles );
	...
	mov	ecx, DWORD PTR _tossent$[ebp]
	mov	eax, DWORD PTR [ecx+eax+208]
	mov	DWORD PTR _original_angles$[ebp+edx], eax
	mov	ecx, 4
	shl	ecx, 0
	mov	edx, 4
	shl	edx, 0
	mov	eax, DWORD PTR _tossent$[ebp]
	mov	ecx, DWORD PTR [eax+ecx+208]
	mov	DWORD PTR _original_angles$[ebp+edx], ecx
	mov	edx, 4
	shl	edx, 1
	mov	eax, 4
	shl	eax, 1
...
; 1521 : 	VectorCopy( tossent->v.avelocity, original_avelocity );
...
; 1522 : 	gravity = tossent->v.gravity * svgame.movevars.gravity * 0.05f;
...
; 1527 : 		tossent->v.velocity[2] -= gravity;
...
; 1528 : 		VectorMA( tossent->v.angles, 0.05f, tossent->v.avelocity, tossent->v.angles );
...
; 1529 : 		VectorScale( tossent->v.velocity, 0.05f, move );
...
; 1530 : 		VectorAdd( tossent->v.origin, move, end );
...
; 1531 : 		trace = SV_Move( tossent->v.origin, tossent->v.mins, tossent->v.maxs, end, MOVE_NORMAL, tossent, false );
...
; 1532 : 		VectorCopy( trace.endpos, tossent->v.origin );
...
; 1533 : 		if( trace.fraction < 1.0f ) break;
...
; 1535 : 
; 1536 : 	VectorCopy( original_origin, tossent->v.origin );
...
; 1537 : 	VectorCopy( original_velocity, tossent->v.velocity );
...
; 1538 : 	VectorCopy( original_angles, tossent->v.angles );
...
; 1539 : 	VectorCopy( original_avelocity, tossent->v.avelocity );
...
; 1458 : 	matrix4x4		matrix;
; 1459 : 	model_t		*bmodel;
; 1460 : 	hull_t		*hull;
; 1461 : 	vec3_t		start_l, end_l;
; 1462 : 	vec3_t		offset;
; 1463 : 
; 1464 : 	bmodel = SV_ModelHandle( ent->v.modelindex );
...
; 1465 : 	if( !bmodel || bmodel->type != mod_brush )
...
; 1467 : 
; 1468 : 	hull = SV_HullForBsp( ent, vec3_origin, vec3_origin, offset );
...
; 1469 : 
; 1470 : 	VectorSubtract( start, offset, start_l );
...
; 1471 : 	VectorSubtract( end, offset, end_l );
...
; 1472 : 
; 1473 : 	// rotate start and end into the models frame of reference
; 1474 : 	if( !VectorIsNull( ent->v.angles ))
...
; 1475 : 	{
; 1476 : 		Matrix4x4_CreateFromEntity( matrix, ent->v.angles, offset, 1.0f );
...
; 1477 : 		Matrix4x4_VectorITransform( matrix, start, start_l );
...
; 1478 : 		Matrix4x4_VectorITransform( matrix, end, end_l );
...
; 1479 : 	}
; 1480 : 
; 1481 : 	return PM_RecursiveSurfCheck( bmodel, &bmodel->nodes[hull->firstclipnode], start_l, end_l );
...
; 1494 : 	msurface_t	*surf = SV_TraceSurface( ent, start, end );
...
; 1495 : 
; 1496 : 	if( !surf || !surf->texinfo || !surf->texinfo->texture )
...
; 1498 : 
; 1499 : 	return surf->texinfo->texture->name;
...
; 1401 : 	return SV_Move( start, mins, maxs, end, type, e, false );
...
; File c:\users\user\documents\github\xashtasks\xash_build4529_src\engine\server\sv_world.c
_TEXT	SEGMENT
_trace_fraction$ = -160					; size = 4
tv93 = -156						; size = 4
_clip$ = -152						; size = 136
_trace_endpos$ = -16					; size = 12
__$ArrayPad$ = -4					; size = 4
$T1 = 8							; size = 4
_start$ = 12						; size = 4
_mins$ = 16						; size = 4
...
; 1411 : 	moveclip_t	clip;
; 1412 : 	vec3_t		trace_endpos;
; 1413 : 	float		trace_fraction;
; 1414 : 
; 1415 : 	memset( &clip, 0, sizeof( moveclip_t ));
...
; 1416 : 	SV_ClipMoveToEntity( EDICT_NUM( 0 ), start, mins, maxs, end, &clip.trace );

	lea	ecx, DWORD PTR _clip$[ebp+68]
	push	ecx
	mov	edx, DWORD PTR _end$[ebp]
	push	edx
	mov	eax, DWORD PTR _maxs$[ebp]
...
; 1417 : 
; 1418 : 	if( clip.trace.fraction != 0.0f )
...
; 1419 : 	{
; 1420 : 		VectorCopy( clip.trace.endpos, trace_endpos );
...
; 1421 : 		trace_fraction = clip.trace.fraction;

	movss	xmm0, DWORD PTR _clip$[ebp+84]
	movss	DWORD PTR _trace_fraction$[ebp], xmm0

; 1422 : 		clip.trace.fraction = 1.0f;

	movss	xmm0, DWORD PTR __real@3f800000
	movss	DWORD PTR _clip$[ebp+84], xmm0

; 1423 : 		clip.start = start;

	mov	edx, DWORD PTR _start$[ebp]
	mov	DWORD PTR _clip$[ebp+56], edx

; 1424 : 		clip.end = trace_endpos;

	lea	eax, DWORD PTR _trace_endpos$[ebp]
	mov	DWORD PTR _clip$[ebp+60], eax

; 1425 : 		clip.type = (type & 0xFF);

	mov	ecx, DWORD PTR _type$[ebp]
	and	ecx, 255				; 000000ffH
	mov	DWORD PTR _clip$[ebp+124], ecx

; 1426 : 		clip.ignoretrans = type >> 8;

	mov	edx, DWORD PTR _type$[ebp]
	sar	edx, 8
	mov	DWORD PTR _clip$[ebp+128], edx

; 1427 : 		clip.monsterclip = false;

	mov	DWORD PTR _clip$[ebp+132], 0

; 1428 : 		clip.passedict = (e) ? e : EDICT_NUM( 0 );
...
; 1429 : 		clip.mins = mins;
	...
	mov	edx, DWORD PTR _mins$[ebp]
	mov	DWORD PTR _clip$[ebp+24], edx
...
; 1431 : 
; 1432 : 		VectorCopy( mins, clip.mins2 );
	...
	mov	eax, DWORD PTR _mins$[ebp]
	mov	edx, DWORD PTR [eax+edx]
	mov	DWORD PTR _clip$[ebp+ecx+32], edx
	mov	eax, 4
	shl	eax, 0
	mov	ecx, 4
	shl	ecx, 0
	...
	mov	eax, DWORD PTR _mins$[ebp]
	mov	ecx, DWORD PTR [eax+ecx]
	mov	DWORD PTR _clip$[ebp+edx+32], ecx

; 1433 : 		VectorCopy( maxs, clip.maxs2 );
	...
	mov	ecx, DWORD PTR _maxs$[ebp]
	mov	eax, DWORD PTR [ecx+eax]
	mov	DWORD PTR _clip$[ebp+edx+44], eax
	mov	ecx, 4
	shl	ecx, 0
	mov	edx, 4
	shl	edx, 0
	mov	eax, DWORD PTR _maxs$[ebp]
	mov	ecx, DWORD PTR [eax+ecx]
	mov	DWORD PTR _clip$[ebp+edx+44], ecx
	mov	edx, 4
	shl	edx, 1
	mov	eax, 4
	shl	eax, 1
...
; 1434 : 
; 1435 : 		World_MoveBounds( start, clip.mins2, clip.maxs2, trace_endpos, clip.boxmins, clip.boxmaxs );
...
; 1436 : 		SV_ClipToWorldBrush( sv_areanodes, &clip );
...
; 1437 : 		SV_ClipToPortals( sv_areanodes, &clip );
...
; 1438 : 
; 1439 : 		clip.trace.fraction *= trace_fraction;

	movss	xmm0, DWORD PTR _clip$[ebp+84]
	mulss	xmm0, DWORD PTR _trace_fraction$[ebp]
	movss	DWORD PTR _clip$[ebp+84], xmm0

; 1440 : 		svgame.globals->trace_ent = clip.trace.ent;

	mov	edx, DWORD PTR _svgame+19236
	mov	eax, DWORD PTR _clip$[ebp+116]
	mov	DWORD PTR [edx+116], eax
$LN2@SV_MoveNoE:

; 1441 : 	}
; 1442 : 
; 1443 : 	SV_CopyTraceToGlobal( &clip.trace );
...
; 1351 : 	moveclip_t	clip;
; 1352 : 	vec3_t		trace_endpos;
; 1353 : 	float		trace_fraction;
; 1354 : 
; 1355 : 	memset( &clip, 0, sizeof( moveclip_t ));
...
; 1356 : 	SV_ClipMoveToEntity( EDICT_NUM( 0 ), start, mins, maxs, end, &clip.trace );
...
; 1357 : 
; 1358 : 	if( clip.trace.fraction != 0.0f )
...
; 1359 : 	{
; 1360 : 		VectorCopy( clip.trace.endpos, trace_endpos );
...
; 1361 : 		trace_fraction = clip.trace.fraction;

	movss	xmm0, DWORD PTR _clip$[ebp+84]
	movss	DWORD PTR _trace_fraction$[ebp], xmm0

; 1362 : 		clip.trace.fraction = 1.0f;

	movss	xmm0, DWORD PTR __real@3f800000
	movss	DWORD PTR _clip$[ebp+84], xmm0

; 1363 : 		clip.start = start;

	mov	edx, DWORD PTR _start$[ebp]
	mov	DWORD PTR _clip$[ebp+56], edx

; 1364 : 		clip.end = trace_endpos;

	lea	eax, DWORD PTR _trace_endpos$[ebp]
	mov	DWORD PTR _clip$[ebp+60], eax

; 1365 : 		clip.type = (type & 0xFF);

	mov	ecx, DWORD PTR _type$[ebp]
	and	ecx, 255				; 000000ffH
	mov	DWORD PTR _clip$[ebp+124], ecx

; 1366 : 		clip.ignoretrans = type >> 8;

	mov	edx, DWORD PTR _type$[ebp]
	sar	edx, 8
	mov	DWORD PTR _clip$[ebp+128], edx

; 1367 : 		clip.monsterclip = false;

	mov	DWORD PTR _clip$[ebp+132], 0

; 1368 : 		clip.passedict = (e) ? e : EDICT_NUM( 0 );
...
; 1371 : 
; 1372 : 		if( monsterclip && !FBitSet( host.features, ENGINE_QUAKE_COMPATIBLE ))
...
; 1373 : 			clip.monsterclip = true;

	mov	DWORD PTR _clip$[ebp+132], 1
$LN3@SV_Move:

; 1374 : 
; 1375 : 		if( clip.type == MOVE_MISSILE )

	cmp	DWORD PTR _clip$[ebp+124], 2
	jne	$LN4@SV_Move

; 1376 : 		{
; 1377 : 			VectorSet( clip.mins2, -15.0f, -15.0f, -15.0f );
...
; 1378 : 			VectorSet( clip.maxs2,  15.0f,  15.0f,  15.0f );
...
; 1380 : 		else
; 1381 : 		{
; 1382 : 			VectorCopy( mins, clip.mins2 );
...
; 1383 : 			VectorCopy( maxs, clip.maxs2 );
...
; 1384 : 		}
; 1385 : 
; 1386 : 		World_MoveBounds( start, clip.mins2, clip.maxs2, trace_endpos, clip.boxmins, clip.boxmaxs );
...
; 1387 : 		SV_ClipToLinks( sv_areanodes, &clip );
...
; 1388 : 		SV_ClipToPortals( sv_areanodes, &clip );
...
; 1389 : 
; 1390 : 		clip.trace.fraction *= trace_fraction;

	movss	xmm0, DWORD PTR _clip$[ebp+84]
	mulss	xmm0, DWORD PTR _trace_fraction$[ebp]
	movss	DWORD PTR _clip$[ebp+84], xmm0

; 1391 : 		svgame.globals->trace_ent = clip.trace.ent;
...
; 1392 : 	}
; 1393 : 
; 1394 : 	SV_CopyTraceToGlobal( &clip.trace );
...
_end$ = 24						; size = 4
_trace$ = 28						; size = 4
_SV_CustomClipMoveToEntity PROC
...
; 1116 : 	// initialize custom trace
; 1117 : 	memset( trace, 0, sizeof( trace_t ));
...
; 1118 : 	VectorCopy( end, trace->endpos );
...
; 1119 : 	trace->allsolid = true;

	mov	edx, DWORD PTR _trace$[ebp]
	mov	DWORD PTR [edx], 1

; 1120 : 	trace->fraction = 1.0f;
...
; 1121 : 
; 1122 : 	if( svgame.physFuncs.ClipMoveToEntity != NULL )

	cmp	DWORD PTR _svgame+19504, 0
	je	SHORT $LN2@SV_CustomC

; 1123 : 	{
; 1124 : 		// do custom sweep test
; 1125 : 		svgame.physFuncs.ClipMoveToEntity( ent, start, mins, maxs, end, trace );
...
; 1127 : 	else
; 1128 : 	{
; 1129 : 		// function is missed, so we didn't hit anything
; 1130 : 		trace->allsolid = false;
...
tv325 = -236						; size = 4
tv268 = -232						; size = 4
_last_hitgroup$ = -228					; size = 4
_model$ = -224						; size = 4
_rotated$ = -220					; size = 4
_hullcount$ = -216					; size = 4
_transform_bbox$ = -212					; size = 4
_i$ = -208						; size = 4
_hull$ = -204						; size = 4
_j$ = -200						; size = 4
_trace_hitbox$ = -196					; size = 56
_out_maxs$1 = -140					; size = 12
_matrix$ = -128						; size = 64
_temp$ = -64						; size = 12
_out_mins$2 = -52					; size = 12
_start_l$ = -40						; size = 12
_end_l$ = -28						; size = 12
_offset$ = -16						; size = 12
__$ArrayPad$ = -4					; size = 4
...
; 883  : 		hull = SV_HullForStudioModel( ent, mins, maxs, offset, &hullcount );
	...
	lea	ecx, DWORD PTR _hullcount$[ebp]
	push	ecx
	lea	edx, DWORD PTR _offset$[ebp]
	push	edx
	mov	eax, DWORD PTR _maxs$[ebp]
...
; 899  : 		if(( check_angles( ent->v.angles[0] ) || check_angles( ent->v.angles[2] )) && !VectorIsNull( mins ))
	...
	imul	edx, ecx, 0
	mov	eax, DWORD PTR _ent$[ebp]
	cvttss2si ecx, DWORD PTR [eax+edx+208]
...
; 919  : 			VectorSubtract( hull->clip_mins, out_mins, offset ); // calc new local offset
	...
	mov	ecx, DWORD PTR _hull$[ebp]
	movss	xmm0, DWORD PTR [ecx+eax+16]
	subss	xmm0, DWORD PTR _out_mins$2[ebp+edx]
	mov	edx, 4
	imul	eax, edx, 0
...
; 949  : 			VectorCopy( end, trace_hitbox.endpos );
	...
	mov	ecx, DWORD PTR _end$[ebp]
	mov	eax, DWORD PTR [ecx+eax]
	mov	DWORD PTR _trace_hitbox$[ebp+edx+20], eax
	mov	ecx, 4
	shl	ecx, 0
	mov	edx, 4
	shl	edx, 0
	mov	eax, DWORD PTR _end$[ebp]
	mov	ecx, DWORD PTR [eax+ecx]
	mov	DWORD PTR _trace_hitbox$[ebp+edx+20], ecx
	mov	edx, 4
	shl	edx, 1
	mov	eax, 4
	shl	eax, 1
...
; 964  : 				last_hitgroup = i;
	...
	mov	ecx, DWORD PTR _i$[ebp]
	mov	DWORD PTR _last_hitgroup$[ebp], ecx
$LN32@SV_ClipMov:
...
; 968  : 		trace->hitgroup = Mod_HitgroupForStudioHull( last_hitgroup );
	...
	mov	edx, DWORD PTR _last_hitgroup$[ebp]
	push	edx
...
; 984  : 			trace->plane.dist = DotProduct( trace->endpos, trace->plane.normal );
	...
	mulss	xmm0, DWORD PTR [esi+ecx+32]
	mov	ecx, 4
	shl	ecx, 0
	mov	edx, 4
	shl	edx, 0
	...
	mulss	xmm1, DWORD PTR [esi+edx+32]
	addss	xmm0, xmm1
	mov	ecx, 4
	shl	ecx, 1
	mov	edx, 4
...
; 472  : 		sv.lightstyles[i].value = 256.0f;
	...
	movss	DWORD PTR _sv[ecx+334284], xmm0
...
; 835  : 	trace = SV_Move( ent->v.origin, ent->v.mins, ent->v.maxs, ent->v.origin, MOVE_NORMAL, ent, monsterClip );
	...
	mov	edx, DWORD PTR _monsterClip$[ebp]
	push	edx
	mov	eax, DWORD PTR _ent$[ebp]
	push	eax
	push	0
