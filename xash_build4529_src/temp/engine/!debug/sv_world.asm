; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27045.0 
	...
	TITLE	C:\Users\USER\Downloads\xash_build4529_src\engine\server\sv_world.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
$SG136636 DB	'''%s'' has SOLID_BSP without MOVETYPE_PUSH or MOVETYPE_P'
	DB	'USHSTEP', 0aH, 00H
	ORG $+5
$SG136777 DB	'c:\users\user\downloads\xash_build4529_src\engine\server'
	DB	'\sv_world.c', 00H
	ORG $+4
$SG136780 DB	'c:\users\user\downloads\xash_build4529_src\engine\server'
	DB	'\sv_world.c', 00H
	ORG $+4
$SG136853 DB	'c:\users\user\downloads\xash_build4529_src\engine\server'
	DB	'\sv_world.c', 00H
	ORG $+4
$SG136854 DB	'c:\users\user\downloads\xash_build4529_src\engine\server'
	DB	'\sv_world.c', 00H
	ORG $+4
$SG137019 DB	'c:\users\user\downloads\xash_build4529_src\engine\server'
	DB	'\sv_world.c', 00H
$SG137025 DB	'trigger in clipping list', 0aH, 00H
	ORG $+2
$SG137038 DB	'c:\users\user\downloads\xash_build4529_src\engine\server'
	DB	'\sv_world.c', 00H
	ORG $+4
$SG137041 DB	'c:\users\user\downloads\xash_build4529_src\engine\server'
	DB	'\sv_world.c', 00H
	ORG $+4
$SG137045 DB	'c:\users\user\downloads\xash_build4529_src\engine\server'
	DB	'\sv_world.c', 00H
$SG137303 DB	'SV_GetLightStyle: style: %i >= %d', 00H
_DATA	ENDS
; Function compile flags: /Odtp
; File c:\users\user\downloads\xash_build4529_src\engine\server\sv_world.c
_TEXT	SEGMENT
_tex$ = -128						; size = 4
_size$ = -124						; size = 4
_tmax$1 = -120						; size = 4
