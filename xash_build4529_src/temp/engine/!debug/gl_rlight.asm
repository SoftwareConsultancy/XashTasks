; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27045.0 
	...
	TITLE	C:\Users\USER\Documents\GitHub\XashTasks\xash_build4529_src\engine\client\gl_rlight.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
; File c:\users\user\documents\github\xashtasks\xash_build4529_src\engine\client\gl_rlight.c
_TEXT	SEGMENT
_pnodes$1 = -192					; size = 4
tv239 = -188						; size = 4
tv218 = -184						; size = 4
tv197 = -180						; size = 4
tv173 = -176						; size = 4
_last_fraction$ = -172					; size = 4
tv350 = -168						; size = 4
tv346 = -164						; size = 4
tv342 = -160						; size = 4
_maxEnts$ = -156					; size = 4
tv84 = -152						; size = 4
_i$ = -148						; size = 4
_ilength$2 = -144					; size = 4
_pe$3 = -140						; size = 4
_cv$ = -136						; size = 16
_light$ = -120						; size = 16
_matrix$4 = -104					; size = 64
_start_l$5 = -40					; size = 12
_end_l$6 = -28						; size = 12
_offset$7 = -16						; size = 12
...
; 398  : 			maxEnts = clgame.pmove->numphysent;
	...
	mov	DWORD PTR _maxEnts$[ebp], edx
$LN9@R_LightVec:
...
$LN4@R_LightVec:
	...
	cmp	ecx, DWORD PTR _maxEnts$[ebp]
	jge	$LN3@R_LightVec
...
; 411  : 			pnodes = &pe->model->nodes[pe->model->hulls[0].firstclipnode];
	...
	imul	ecx, ecx, 0
	imul	edx, DWORD PTR [edx+ecx+216], 52
	add	edx, DWORD PTR [eax+164]
	mov	DWORD PTR _pnodes$1[ebp], edx
...
; 412  : 			VectorSubtract( pe->model->hulls[0].clip_mins, vec3_origin, offset );
	...
	mov	eax, 4
	imul	ecx, eax, 0
	movss	DWORD PTR _offset$7[ebp+ecx], xmm0
	mov	edx, DWORD PTR _pe$3[ebp]
	mov	eax, DWORD PTR [edx+48]
	mov	ecx, 40					; 00000028H
	imul	edx, ecx, 0
	...
	mov	eax, 4
	shl	eax, 0
	movss	DWORD PTR _offset$7[ebp+eax], xmm0
	mov	ecx, DWORD PTR _pe$3[ebp]
	mov	edx, DWORD PTR [ecx+48]
	...
	movss	DWORD PTR _offset$7[ebp+edx], xmm0
...
; 413  : 			VectorAdd( offset, pe->origin, offset );
	...
	imul	eax, edx, 0
	mov	edx, DWORD PTR _pe$3[ebp]
	movss	xmm0, DWORD PTR _offset$7[ebp+ecx]
	...
	shl	eax, 0
	mov	ecx, DWORD PTR _pe$3[ebp]
	movss	xmm0, DWORD PTR _offset$7[ebp+edx]
	...
	shl	ecx, 1
	mov	edx, DWORD PTR _pe$3[ebp]
	movss	xmm0, DWORD PTR _offset$7[ebp+eax]
...
; 414  : 			VectorSubtract( start, offset, start_l );
	...
	subss	xmm0, DWORD PTR _offset$7[ebp+ecx]
	mov	ecx, 4
	imul	edx, ecx, 0
	...
	subss	xmm0, DWORD PTR _offset$7[ebp+edx]
...
; 415  : 			VectorSubtract( end, offset, end_l );
	...
	mov	edx, 4
	imul	eax, edx, 0
	movss	DWORD PTR _end_l$6[ebp+eax], xmm0
	mov	ecx, 4
	shl	ecx, 0
	mov	edx, 4
	shl	edx, 0
	...
	mov	ecx, 4
	shl	ecx, 0
	movss	DWORD PTR _end_l$6[ebp+ecx], xmm0
	mov	edx, 4
	shl	edx, 1
	mov	eax, 4
	shl	eax, 1
	...
	subss	xmm0, DWORD PTR _offset$7[ebp+eax]
	movss	DWORD PTR tv239[ebp], xmm0
	mov	edx, 4
	shl	edx, 1
	movss	xmm0, DWORD PTR tv239[ebp]
	movss	DWORD PTR _end_l$6[ebp+edx], xmm0
...
; 420  : 				Matrix4x4_CreateFromEntity( matrix, pe->angles, offset, 1.0f );
	...
	lea	ecx, DWORD PTR _offset$7[ebp]
	push	ecx
	mov	edx, DWORD PTR _pe$3[ebp]
...
; 422  : 				Matrix4x4_VectorITransform( matrix, end, end_l );
	...
	lea	ecx, DWORD PTR _end_l$6[ebp]
	push	ecx
...
; 425  : 			VectorClear( g_trace_lightspot );
	...
	shl	edx, 0
	xorps	xmm0, xmm0
	movss	DWORD PTR _g_trace_lightspot[edx], xmm0
	mov	eax, 4
	imul	ecx, eax, 0
	xorps	xmm0, xmm0
	movss	DWORD PTR _g_trace_lightspot[ecx], xmm0
...
; 429  : 			if( !R_RecursiveLightPoint( pe->model, pnodes, 0.0f, 1.0f, &cv, start_l, end_l ))
	...
	lea	eax, DWORD PTR _end_l$6[ebp]
	push	eax
	lea	ecx, DWORD PTR _start_l$5[ebp]
	push	ecx
	...
	xorps	xmm0, xmm0
	movss	DWORD PTR [esp], xmm0
	mov	eax, DWORD PTR _pnodes$1[ebp]
	push	eax
	mov	ecx, DWORD PTR _pe$3[ebp]
	mov	edx, DWORD PTR [ecx+48]
	push	edx
...
; 435  : 				if( lvec ) VectorNormalize2( g_trace_lightvec, lvec );
	...
	mov	eax, 4
	imul	ecx, eax, 0
	movss	xmm0, DWORD PTR _g_trace_lightvec[edx]
	mulss	xmm0, DWORD PTR _g_trace_lightvec[ecx]
	mov	edx, 4
	shl	edx, 0
	mov	eax, 4
	shl	eax, 0
	movss	xmm1, DWORD PTR _g_trace_lightvec[edx]
	mulss	xmm1, DWORD PTR _g_trace_lightvec[eax]
	addss	xmm0, xmm1
	mov	ecx, 4
	shl	ecx, 1
	mov	edx, 4
...
_back$ = -164						; size = 4
_front$ = -160						; size = 4
_sample_size$ = -156					; size = 4
_frac$ = -152						; size = 4
_side$ = -148						; size = 4
_map$ = -144						; size = 4
_ilength$4 = -140					; size = 4
_ilength$5 = -136					; size = 4
_ilength$6 = -132					; size = 4
_dm$ = -128						; size = 4
_lm$ = -124						; size = 4
_scale$7 = -120						; size = 4
_ds$ = -116						; size = 4
...
_info$ = -108						; size = 4
_surf$ = -104						; size = 4
_srcNormal$8 = -100					; size = 12
_faceNormal$9 = -88					; size = 12
_lightNormal$10 = -76					; size = 12
_tbn$ = -64						; size = 48
_mid$ = -16						; size = 12
__$ArrayPad$ = -4					; size = 4
_model$ = 8						; size = 4
...
; 273  : 	VectorCopy( mid, g_trace_lightspot );
	...
	mov	DWORD PTR _g_trace_lightspot[edx], eax
	mov	ecx, 4
	shl	ecx, 0
	mov	edx, 4
	shl	edx, 0
	mov	eax, DWORD PTR _mid$[ebp+ecx]
	mov	DWORD PTR _g_trace_lightspot[edx], eax
	mov	ecx, 4
	shl	ecx, 1
	mov	edx, 4
...
$LN42@R_Recursiv:
	...
	imul	eax, DWORD PTR _smax$3[ebp]
	imul	ecx, eax, 3
	mov	edx, DWORD PTR _surf$[ebp]
	mov	eax, DWORD PTR [edx+84]
	add	eax, ecx
	imul	ecx, DWORD PTR tv429[ebp], 3
	add	eax, ecx
...
; 318  : 				VectorNegate( surf->plane->normal, faceNormal );
	...
	mov	edx, 4
	imul	eax, edx, 0
	movss	DWORD PTR _faceNormal$9[ebp+eax], xmm0
	mov	ecx, DWORD PTR _surf$[ebp]
	mov	edx, DWORD PTR [ecx+4]
	mov	eax, 4
	shl	eax, 0
	...
	mov	ecx, 4
	shl	ecx, 0
	movss	DWORD PTR _faceNormal$9[ebp+ecx], xmm0
	mov	edx, DWORD PTR _surf$[ebp]
	...
	movss	DWORD PTR _faceNormal$9[ebp+edx], xmm0
...
; 319  : 			else VectorCopy( surf->plane->normal, faceNormal );
	...
	mov	DWORD PTR _faceNormal$9[ebp+edx], eax
	mov	ecx, DWORD PTR _surf$[ebp]
	mov	edx, DWORD PTR [ecx+4]
	mov	eax, 4
	shl	eax, 0
	...
	mov	DWORD PTR _faceNormal$9[ebp+ecx], edx
	mov	eax, DWORD PTR _surf$[ebp]
	mov	ecx, DWORD PTR [eax+4]
	mov	edx, 4
	shl	edx, 1
	...
	mov	DWORD PTR _faceNormal$9[ebp+eax], ecx
$LN21@R_Recursiv:
...
; 325  : 			Vector4Set( tbn[2], faceNormal[0], faceNormal[1], faceNormal[2], 0.0f );
	...
	mov	eax, 4
	imul	ecx, eax, 0
	movss	xmm0, DWORD PTR _faceNormal$9[ebp+ecx]
	mov	edx, 16					; 00000010H
	shl	edx, 1
	lea	eax, DWORD PTR _tbn$[ebp+edx]
	mov	ecx, 4
	...
	mov	eax, 4
	shl	eax, 0
	movss	xmm0, DWORD PTR _faceNormal$9[ebp+eax]
	mov	ecx, 16					; 00000010H
	shl	ecx, 1
	lea	edx, DWORD PTR _tbn$[ebp+ecx]
	mov	eax, 4
...
$LN22@R_Recursiv:
	...
	mov	eax, 16					; 00000010H
	imul	ecx, eax, 0
	lea	eax, DWORD PTR _tbn$[ebp+ecx]
	movss	DWORD PTR [eax+edx], xmm0
	mov	ecx, 16					; 00000010H
	imul	edx, ecx, 0
	lea	eax, DWORD PTR _tbn$[ebp+edx]
...
; 339  : 			uint	scale = tr.lightstylevalue[surf->styles[map]];
	...
	mov	DWORD PTR _scale$7[ebp], eax

; 340  : 
; 341  : 			if( tr.ignore_lightgamma )

	cmp	DWORD PTR _tr+66684, 0
...
; 343  : 				cv->r += lm->r * scale;
	...
	imul	edx, DWORD PTR _scale$7[ebp]
	mov	eax, DWORD PTR _cv$[ebp]
...
; 344  : 				cv->g += lm->g * scale;
	...
	imul	eax, DWORD PTR _scale$7[ebp]
	mov	ecx, DWORD PTR _cv$[ebp]
...
; 345  : 				cv->b += lm->b * scale;
	...
	imul	ecx, DWORD PTR _scale$7[ebp]
	mov	edx, DWORD PTR _cv$[ebp]
...
; 353  : 			lm += size; // skip to next lightmap
	...
	imul	ecx, DWORD PTR _size$[ebp], 3
	add	ecx, DWORD PTR _lm$[ebp]
...
; 360  : 				VectorSet( srcNormal, ((float)dm->r - 128.0f) * f, ((float)dm->g - 128.0f) * f, ((float)dm->b - 128.0f) * f );
	...
	mulss	xmm0, DWORD PTR _f$2[ebp]
	mov	ecx, 4
	imul	edx, ecx, 0
	movss	DWORD PTR _srcNormal$8[ebp+edx], xmm0
...
; 361  : 				Matrix3x4_VectorIRotate( tbn, srcNormal, lightNormal );		// turn to world space
	...
	lea	eax, DWORD PTR _lightNormal$10[ebp]
	push	eax
	lea	ecx, DWORD PTR _srcNormal$8[ebp]
	push	ecx
...
; 362  : 				VectorScale( lightNormal, (float)scale * -1.0f, lightNormal );	// turn direction from light
	...
	mov	eax, 4
	imul	ecx, eax, 0
	mov	edx, DWORD PTR _scale$7[ebp]
	...
	mulss	xmm0, DWORD PTR _lightNormal$10[ebp+ecx]
	mov	ecx, 4
	imul	edx, ecx, 0
	movss	DWORD PTR _lightNormal$10[ebp+edx], xmm0
	mov	eax, 4
	shl	eax, 0
	mov	ecx, DWORD PTR _scale$7[ebp]
	...
	mulss	xmm0, DWORD PTR __real@bf800000
	mulss	xmm0, DWORD PTR _lightNormal$10[ebp+eax]
	mov	eax, 4
	shl	eax, 0
	movss	DWORD PTR _lightNormal$10[ebp+eax], xmm0
	mov	ecx, 4
	shl	ecx, 1
	mov	edx, DWORD PTR _scale$7[ebp]
	...
	mulss	xmm0, DWORD PTR __real@bf800000
	movss	xmm1, DWORD PTR _lightNormal$10[ebp+ecx]
	mulss	xmm1, xmm0
	movss	DWORD PTR tv936[ebp], xmm1
	mov	ecx, 4
	shl	ecx, 1
	movss	xmm0, DWORD PTR tv936[ebp]
	movss	DWORD PTR _lightNormal$10[ebp+ecx], xmm0
...
; 363  : 				VectorAdd( g_trace_lightvec, lightNormal, g_trace_lightvec );
	...
	addss	xmm0, DWORD PTR _lightNormal$10[ebp+edx]
	mov	eax, 4
	imul	ecx, eax, 0
	...
	shl	eax, 0
	movss	xmm0, DWORD PTR _g_trace_lightvec[edx]
	addss	xmm0, DWORD PTR _lightNormal$10[ebp+eax]
	mov	ecx, 4
	shl	ecx, 0
	movss	DWORD PTR _g_trace_lightvec[ecx], xmm0
	mov	edx, 4
...
; 186  : 		numDlights++;
	...
	mov	ecx, DWORD PTR _numDlights$[ebp]
	add	ecx, 1
	mov	DWORD PTR _numDlights$[ebp], ecx
...
; 466  : 	if( CVAR_TO_BOOL( r_lighting_extended ) && lspot != NULL && lvec != NULL )
	...
	cmp	DWORD PTR _r_lighting_extended, 0
	je	SHORT $LN5@R_LightVec
	mov	ecx, DWORD PTR _r_lighting_extended
...
; 50   : 	for( i = 0, ls = cl.lightstyles; i < MAX_LIGHTSTYLES; i++, ls++ )
	...
	mov	DWORD PTR _i$[ebp], 0
	mov	DWORD PTR _ls$[ebp], OFFSET _cl+1852744
...
; 54   : 			tr.lightstylevalue[i] = 256 * 256;
	...
	mov	ecx, DWORD PTR _i$[ebp]
	mov	DWORD PTR _tr[ecx*4+66708], 65536	; 00010000H
...
; 68   : 			tr.lightstylevalue[i] = 256 * scale;
	...
	cvttss2si eax, xmm0
	mov	ecx, DWORD PTR _i$[ebp]
	mov	DWORD PTR _tr[ecx*4+66708], eax
...
; 79   : 			tr.lightstylevalue[i] = ls->map[flight%ls->length] * 22 * scale;
	...
	mov	DWORD PTR _tr[edx*4+66708], ecx
...
; 92   : 		tr.lightstylevalue[i] = (int)l * scale;
	...
	cvttss2si edx, DWORD PTR _l$[ebp]
	cvtsi2ss xmm0, edx
	mulss	xmm0, DWORD PTR _scale$[ebp]
	cvttss2si eax, xmm0
	mov	ecx, DWORD PTR _i$[ebp]
