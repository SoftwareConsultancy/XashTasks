...
$SG132401 DB	'net_qport', 00H
	ORG $+2
$SG132402 DB	'c:\users\user\downloads\xash_build4529_src\engine\common'
	DB	'\net_chan.c', 00H
...
$SG132631 DB	'Compressing split packet (%d -> %d bytes)', 0aH, 00H
	ORG $+1
$SG132406 DB	'c:\users\user\downloads\xash_build4529_src\engine\common'
	DB	'\net_chan.c', 00H
$SG132674 DB	'reconnect', 0aH, 00H
	ORG $+1
$SG132417 DB	'c:\users\user\downloads\xash_build4529_src\engine\common'
	DB	'\net_chan.c', 00H
...
$SG132708 DB	'Compressing filebuffer (%s -> %s)', 0aH, 00H
	ORG $+1
$SG132466 DB	'c:\users\user\downloads\xash_build4529_src\engine\common'
	DB	'\net_chan.c', 00H
$SG132786 DB	'NetMessage', 00H
	ORG $+1
$SG132468 DB	'c:\users\user\downloads\xash_build4529_src\engine\common'
	DB	'\net_chan.c', 00H
$SG132791 DB	'^1Error:^7 buffer to small to decompress message', 0aH, 00H
	ORG $+2
$SG132479 DB	'c:\users\user\downloads\xash_build4529_src\engine\common'
	DB	'\net_chan.c', 00H
$SG132814 DB	'NetMessage', 00H
	ORG $+1
$SG132493 DB	'c:\users\user\downloads\xash_build4529_src\engine\common'
	DB	'\net_chan.c', 00H
$SG132819 DB	'^1Error:^7 file fragment received with bad path, ignorin'
	DB	'g', 0aH, 00H
	ORG $+1
$SG132503 DB	'c:\users\user\downloads\xash_build4529_src\engine\common'
	DB	'\net_chan.c', 00H
$SG132959 DB	'^1Error:^7 %s:outgoing message overflow', 0aH, 00H
	ORG $+3
$SG132539 DB	'c:\users\user\downloads\xash_build4529_src\engine\common'
	DB	'\net_chan.c', 00H
...
$SG132976 DB	'rb', 00H
	ORG $+1
$SG132585 DB	'c:\users\user\downloads\xash_build4529_src\engine\common'
	DB	'\net_chan.c', 00H
$SG132977 DB	'rb', 00H
	ORG $+1
$SG132628 DB	'c:\users\user\downloads\xash_build4529_src\engine\common'
	DB	'\net_chan.c', 00H
...
$SG132989 DB	'^3Warning:^7 Netchan_Transmit: unreliable message overfl'
	DB	'ow', 0aH, 00H
$SG132710 DB	'c:\users\user\downloads\xash_build4529_src\engine\common'
	DB	'\net_chan.c', 00H
...
$SG133000 DB	' %s --> sz=%i seq=%i ack=%i rel=%i tm=%f', 0aH, 00H
	ORG $+2
$SG132753 DB	'c:\users\user\downloads\xash_build4529_src\engine\common'
	DB	'\net_chan.c', 00H
$SG133056 DB	' %s <-- sz=%i seq=%i ack=%i rel=%i tm=%f', 0aH, 00H
	ORG $+2
$SG132754 DB	'c:\users\user\downloads\xash_build4529_src\engine\common'
	DB	'\net_chan.c', 00H
$SG133062 DB	'%s:out of order packet %i at %i', 0aH, 00H
	ORG $+3
$SG132768 DB	'c:\users\user\downloads\xash_build4529_src\engine\common'
	DB	'\net_chan.c', 00H
	ORG $+4
$SG132787 DB	'c:\users\user\downloads\xash_build4529_src\engine\common'
	DB	'\net_chan.c', 00H
	ORG $+4
$SG132817 DB	'^1Error:^7 file fragment received with no filename', 0aH
	DB	'Flushing input queue', 0aH, 00H
	ORG $+7
$SG132823 DB	'c:\users\user\downloads\xash_build4529_src\engine\common'
	DB	'\net_chan.c', 00H
	ORG $+4
$SG132826 DB	'c:\users\user\downloads\xash_build4529_src\engine\common'
	DB	'\net_chan.c', 00H
	ORG $+4
$SG132828 DB	'c:\users\user\downloads\xash_build4529_src\engine\common'
	DB	'\net_chan.c', 00H
	ORG $+4
$SG132829 DB	'c:\users\user\downloads\xash_build4529_src\engine\common'
	DB	'\net_chan.c', 00H
	ORG $+4
$SG132833 DB	'c:\users\user\downloads\xash_build4529_src\engine\common'
	DB	'\net_chan.c', 00H
	ORG $+4
$SG132834 DB	'c:\users\user\downloads\xash_build4529_src\engine\common'
	DB	'\net_chan.c', 00H
