; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27045.0 
	...
	TITLE	C:\Users\USER\Downloads\xash_build4529_src\engine\server\sv_cmds.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
$SG136218 DB	'next map can''t be found', 0aH, 00H
	ORG $+3
$SG136220 DB	'bsp', 00H
$SG136223 DB	'c:\users\user\downloads\xash_build4529_src\engine\server'
	DB	'\sv_cmds.c', 00H
	ORG $+1
$SG136224 DB	'failed to load next map', 0aH, 00H
	ORG $+3
$SG136225 DB	'c:\users\user\downloads\xash_build4529_src\engine\server'
	DB	'\sv_cmds.c', 00H
	ORG $+1
...
$SG136409 DB	'Total %i symbols', 0aH, 00H
	ORG $+2
$SG136401 DB	'c:\users\user\downloads\xash_build4529_src\engine\server'
	DB	'\sv_cmds.c', 00H
	ORG $+1
$SG136411 DB	'Usage: localinfo [ <key> <value> ]', 0aH, 00H
$SG136402 DB	'c:\users\user\downloads\xash_build4529_src\engine\server'
	DB	'\sv_cmds.c', 00H
	ORG $+1
...
$SG136456 DB	'c:\users\user\downloads\xash_build4529_src\engine\server'
	DB	'\sv_cmds.c', 00H
	ORG $+1
...
; File c:\users\user\downloads\xash_build4529_src\engine\server\sv_cmds.c
_TEXT	SEGMENT
_i$ = -8						; size = 4
_ent$ = -4						; size = 4
