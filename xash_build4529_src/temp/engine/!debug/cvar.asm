; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27045.0 
	...
	TITLE	C:\Users\USER\Documents\GitHub\XashTasks\xash_build4529_src\engine\common\cvar.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
$SG131000 DB	'empty', 00H
	ORG $+2
$SG131026 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\cvar.c', 00H
	ORG $+3
$SG131042 DB	'var != NULL', 00H
$SG131029 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\cvar.c', 00H
	ORG $+3
$SG131047 DB	'sv_cheats', 00H
	ORG $+2
$SG131031 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\cvar.c', 00H
	ORG $+3
$SG131092 DB	'assert failed at %s:%i', 0aH, 00H
$SG131156 DB	'%s is read-only.', 0aH, 00H
	ORG $+2
$SG131033 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\cvar.c', 00H
	ORG $+3
$SG131130 DB	'assert failed at %s:%i', 0aH, 00H
$SG131192 DB	'Cvar_Set: variable ''%s'' not found', 0aH, 00H
	ORG $+1
$SG131034 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\cvar.c', 00H
	ORG $+3
$SG131158 DB	'%s is cheat protected.', 0aH, 00H
$SG131203 DB	'%d', 00H
	ORG $+1
$SG131041 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\cvar.c', 00H
	ORG $+3
$SG131204 DB	'%f', 00H
	ORG $+1
$SG131091 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\cvar.c', 00H
	ORG $+3
...
$SG131101 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\cvar.c', 00H
	ORG $+3
...
$SG131264 DB	'%s "%s"', 0aH, 00H
	ORG $+3
$SG131102 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\cvar.c', 00H
	ORG $+3
...
$SG131270 DB	'Usage: toggle <variable>', 0aH, 00H
	ORG $+2
$SG131107 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\cvar.c', 00H
	ORG $+3
$SG131271 DB	'%i', 00H
	ORG $+1
$SG131108 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\cvar.c', 00H
	ORG $+3
$SG131276 DB	'Usage: setgl <variable> <value>', 0aH, 00H
	ORG $+3
$SG131109 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\cvar.c', 00H
	ORG $+3
$SG131281 DB	'Usage: reset <variable>', 0aH, 00H
	ORG $+3
$SG131110 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\cvar.c', 00H
	ORG $+3
$SG131299 DB	'"^2%s^7"', 00H
	ORG $+3
$SG131111 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\cvar.c', 00H
	ORG $+3
$SG131302 DB	' %-*s %s ^3%s^7', 0aH, 00H
	ORG $+3
$SG131112 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\cvar.c', 00H
	ORG $+3
$SG131303 DB	' %-*s %s ^3%s^7', 0aH, 00H
	ORG $+3
$SG131113 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\cvar.c', 00H
	ORG $+3
$SG131304 DB	0aH, '%i cvars', 0aH, 00H
	ORG $+1
$SG131129 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\cvar.c', 00H
	ORG $+3
...
$SG131135 DB	'^1Error:^7 can''t register variable ''%s'', is already d'
	DB	'efined as command', 0aH, 00H
$SG131138 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\cvar.c', 00H
	ORG $+3
...
$SG131315 DB	'host_gameuiloaded', 00H
	ORG $+2
$SG131168 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\cvar.c', 00H
	ORG $+3
$SG131316 DB	'unlink %i cvars', 0aH, 00H
	ORG $+3
$SG131169 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\cvar.c', 00H
	ORG $+3
$SG131320 DB	'enable simple condition checking and variable operations'
	DB	00H
	ORG $+3
$SG131183 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\cvar.c', 00H
	ORG $+3
$SG131321 DB	'0', 00H
	ORG $+2
$SG131184 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\cvar.c', 00H
	ORG $+3
$SG131298 DB	'"%s"', 00H
	ORG $+3
...
; File c:\users\user\documents\github\xashtasks\xash_build4529_src\engine\common\cvar.c
_TEXT	SEGMENT
_count$ = -16						; size = 4
_value$ = -12						; size = 4
_match$ = -8						; size = 4
