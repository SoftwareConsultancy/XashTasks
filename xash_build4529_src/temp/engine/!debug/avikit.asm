; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27045.0 
	...
	TITLE	C:\Users\USER\Downloads\xash_build4529_src\engine\common\avikit.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
$SG149431 DB	'^1Error:^7 Couldn''t get ACM conversion stream size.', 0aH
	DB	00H
	ORG $+7
$SG149432 DB	'c:\users\user\downloads\xash_build4529_src\engine\common'
	DB	'\avikit.c', 00H
	ORG $+6
$SG149433 DB	'c:\users\user\downloads\xash_build4529_src\engine\common'
	DB	'\avikit.c', 00H
	ORG $+2
$SG149436 DB	'^1Error:^7 couldn''t prepare stream headers.', 0aH, 00H
	ORG $+7
$SG149555 DB	'c:\users\user\downloads\xash_build4529_src\engine\common'
	DB	'\avikit.c', 00H
	ORG $+6
$SG149557 DB	'c:\users\user\downloads\xash_build4529_src\engine\common'
	DB	'\avikit.c', 00H
	ORG $+6
$SG149558 DB	'c:\users\user\downloads\xash_build4529_src\engine\common'
	DB	'\avikit.c', 00H
	ORG $+2
...
$SG149645 DB	'^1Error:^7 no handler found (or file not found).', 0aH, 00H
	ORG $+6
$SG149652 DB	'c:\users\user\downloads\xash_build4529_src\engine\common'
	DB	'\avikit.c', 00H
	ORG $+6
$SG149656 DB	'c:\users\user\downloads\xash_build4529_src\engine\common'
	DB	'\avikit.c', 00H
	ORG $+2
...
$SG149688 DB	'Couldn''t load %s from packfile. Please extract it', 0aH
	DB	00H
	ORG $+1
$SG149689 DB	'c:\users\user\downloads\xash_build4529_src\engine\common'
	DB	'\avikit.c', 00H
	ORG $+6
$SG149696 DB	'c:\users\user\downloads\xash_build4529_src\engine\common'
	DB	'\avikit.c', 00H
	ORG $+2
...
; File c:\users\user\downloads\xash_build4529_src\engine\common\avikit.c
_TEXT	SEGMENT
_breaker$ = -4						; size = 4
_Avi$ = 8						; size = 4
_offset$ = 12						; size = 4
