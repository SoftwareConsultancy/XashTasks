; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27045.0 
	...
	TITLE	C:\Users\USER\Documents\GitHub\XashTasks\xash_build4529_src\engine\client\vgui\vgui_int.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_BSS	ENDS
CONST	SEGMENT
$SG136165 DB	'fraps32.dll', 00H
$SG136166 DB	'fraps64.dll', 00H
CONST	ENDS
...
; File c:\users\user\documents\github\xashtasks\xash_build4529_src\engine\client\vgui\vgui_int.cpp
_TEXT	SEGMENT
?VGui_SetRootPanelSize@@YAXXZ PROC			; VGui_SetRootPanelSize
...
_x$ = 8							; size = 4
_y$ = 12						; size = 4
?getCursorPos@CEngineApp@@UAEXAAH0@Z PROC		; CEngineApp::getCursorPos
; _this$ = ecx
...
_x$ = 8							; size = 4
_y$ = 12						; size = 4
?setCursorPos@CEngineApp@@UAEXHH@Z PROC			; CEngineApp::setCursorPos
; _this$ = ecx
...
_TEXT	SEGMENT
_extents$ = 8						; size = 4
_VGui_ViewportPaintBackground PROC
...
; 114  : 		rootPanel->getAbsExtents( extents[0], extents[1], extents[2], extents[3] );
	...
	lea	ecx, DWORD PTR _extents$[ebp+eax]
	push	ecx
	mov	edx, DWORD PTR ?rootPanel@@3PAVPanel@vgui@@A ; rootPanel
	mov	eax, DWORD PTR [edx]
	mov	ecx, DWORD PTR ?rootPanel@@3PAVPanel@vgui@@A ; rootPanel
...
; 86   : 	delete engSurface;
	...
	mov	edx, DWORD PTR ?engSurface@@3PAVCEngineSurface@@A ; engSurface
	mov	DWORD PTR $T1[ebp], edx
	mov	eax, DWORD PTR $T1[ebp]
...
$LN5@VGui_Start:
	...
	mov	DWORD PTR ?rootPanel@@3PAVPanel@vgui@@A, edx ; rootPanel
...
$LN7@VGui_Start:
	...
	mov	DWORD PTR $T1[ebp], edx
	mov	eax, DWORD PTR $T1[ebp]
	mov	DWORD PTR ?engSurface@@3PAVCEngineSurface@@A, eax ; engSurface
