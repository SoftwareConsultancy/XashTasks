; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27045.0 
	...
	TITLE	C:\Users\USER\Documents\GitHub\XashTasks\xash_build4529_src\engine\server\sv_move.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	ENDS
_DATA	SEGMENT
$SG136147 DB	'player/pl_wade1.wav', 00H
$SG136149 DB	'player/pl_wade2.wav', 00H
$SG136151 DB	'player/pl_wade3.wav', 00H
$SG136153 DB	'player/pl_wade4.wav', 00H
$SG136165 DB	'player/pl_wade1.wav', 00H
$SG136167 DB	'player/pl_wade2.wav', 00H
$SG136169 DB	'player/pl_wade3.wav', 00H
$SG136171 DB	'player/pl_wade4.wav', 00H
$SG136213 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\server\sv_move.c', 00H
_DATA	ENDS
; Function compile flags: /Odtp
; File c:\users\user\documents\github\xashtasks\xash_build4529_src\engine\server\sv_move.c
_TEXT	SEGMENT
tv326 = -68						; size = 8
tv415 = -60						; size = 8
tv321 = -52						; size = 8
...
; 125  : 	watertype = ent->v.watertype;
	...
	mov	DWORD PTR _watertype$[ebp], eax
...
; 132  : 			if( ent->v.air_finished > sv.time && ent->v.pain_finished > sv.time )
	...
	mov	edx, DWORD PTR _ent$[ebp]
	cvtss2sd xmm0, DWORD PTR [edx+636]
	comisd	xmm0, QWORD PTR _sv+16
	jbe	SHORT $LN13@SV_WaterMo
	mov	eax, DWORD PTR _ent$[ebp]
	cvtss2sd xmm0, DWORD PTR [eax+640]
	comisd	xmm0, QWORD PTR _sv+16
	jbe	SHORT $LN13@SV_WaterMo
...
; 178  : 		if((!( flags & ( FL_IMMUNE_LAVA|FL_GODMODE ))) && ent->v.dmgtime < sv.time )
	...
	mov	eax, DWORD PTR _ent$[ebp]
	cvtss2sd xmm0, DWORD PTR [eax+612]
...
; 180  : 			if( ent->v.radsuit_finished < sv.time )
	...
	mov	ecx, DWORD PTR _ent$[ebp]
	cvtss2sd xmm0, DWORD PTR [ecx+644]
	movsd	xmm1, QWORD PTR _sv+16
	comisd	xmm1, xmm0
...
; 187  : 		if((!( flags & ( FL_IMMUNE_SLIME|FL_GODMODE ))) && ent->v.dmgtime < sv.time )
	...
	jne	SHORT $LN28@SV_WaterMo
	mov	edx, DWORD PTR _ent$[ebp]
	cvtss2sd xmm0, DWORD PTR [edx+612]
	movsd	xmm1, QWORD PTR _sv+16
	comisd	xmm1, xmm0
...
; 189  : 			if( ent->v.radsuit_finished < sv.time )
	...
	mov	eax, DWORD PTR _ent$[ebp]
	cvtss2sd xmm0, DWORD PTR [eax+644]
	movsd	xmm1, QWORD PTR _sv+16
	comisd	xmm1, xmm0
	jbe	SHORT $LN28@SV_WaterMo
...
; 223  : 		VectorMA( ent->v.velocity, ( ent->v.waterlevel * -0.8f * sv.frametime ), ent->v.velocity, ent->v.velocity );
	...
	imul	ecx, eax, 0
	mov	edx, DWORD PTR _ent$[ebp]
	cvtsi2ss xmm0, DWORD PTR [edx+576]
	...
	shl	edx, 1
	mov	eax, DWORD PTR _ent$[ebp]
	cvtsi2ss xmm0, DWORD PTR [eax+576]
	mulss	xmm0, DWORD PTR __real@bf4ccccd
	mulss	xmm0, DWORD PTR _sv+32
	mov	ecx, 4
	shl	ecx, 1
...
; 43   : 	VectorAdd( ent->v.origin, ent->v.mins, mins );
	...
	addss	xmm0, DWORD PTR [esi+eax+348]
	mov	eax, 4
	imul	ecx, eax, 0
...
; 73   : 	start[1] = stop[1] = (mins[1] + maxs[1]) * 0.5f;
	...
	movss	DWORD PTR _stop$[ebp+ecx], xmm0
	mov	edx, 4
	shl	edx, 0
	movss	xmm0, DWORD PTR tv215[ebp]
	movss	DWORD PTR _start$[ebp+edx], xmm0
...
; 83   : 	mid = bottom = trace.endpos[2];
	...
	mov	edx, 4
	shl	edx, 1
	movss	xmm0, DWORD PTR _trace$[ebp+edx+20]
...
$LN34@SV_CheckBo:
	...
	movss	DWORD PTR _stop$[ebp+eax], xmm0
	mov	ecx, 4
	shl	ecx, 0
	movss	xmm0, DWORD PTR tv268[ebp]
	movss	DWORD PTR _start$[ebp+ecx], xmm0
...
; 99   : 			if( trace.fraction == 1.0f || mid - trace.endpos[2] > svgame.movevars.stepsize )
	...
	subss	xmm0, DWORD PTR _trace$[ebp+ecx+20]
...
; 556  : 				SV_NewChaseDir( ent, vecDist, dist );
	...
	movss	xmm0, DWORD PTR _dist$[ebp]
	movss	DWORD PTR [esp], xmm0
	lea	edx, DWORD PTR _vecDist$[ebp]
	push	edx
	mov	eax, DWORD PTR _ent$[ebp]
	push	eax
...
; 561  : 			vecDist[0] -= ent->v.origin[0];
	...
	imul	ecx, eax, 0
	mov	eax, DWORD PTR _ent$[ebp]
	movss	xmm0, DWORD PTR _vecDist$[ebp+edx]
	subss	xmm0, DWORD PTR [eax+ecx+136]
	mov	ecx, 4
	imul	edx, ecx, 0
...
; 568  : 			VectorNormalize( vecDist );
	...
	imul	edx, ecx, 0
	movss	xmm0, DWORD PTR _vecDist$[ebp+eax]
	mulss	xmm0, DWORD PTR _vecDist$[ebp+edx]
	mov	eax, 4
	shl	eax, 0
	mov	ecx, 4
	shl	ecx, 0
	...
	mov	eax, 4
	shl	eax, 1
	movss	xmm1, DWORD PTR _vecDist$[ebp+edx]
	mulss	xmm1, DWORD PTR _vecDist$[ebp+eax]
	addss	xmm0, xmm1
	cvtss2sd xmm0, xmm0
	sub	esp, 8
	movsd	QWORD PTR [esp], xmm0
...
; 377  : 	neworg[2] += temp;
	...
	mov	edx, 4
	shl	edx, 1
	movss	xmm0, DWORD PTR _neworg$[ebp+edx]
...
; 378  : 	VectorCopy( neworg, end );
	...
	mov	eax, 4
	imul	ecx, eax, 0
	mov	edx, DWORD PTR _neworg$[ebp+edx]
	mov	DWORD PTR _end$[ebp+ecx], edx
	mov	eax, 4
	shl	eax, 0
	mov	ecx, 4
	shl	ecx, 0
	mov	edx, DWORD PTR _neworg$[ebp+eax]
	mov	DWORD PTR _end$[ebp+ecx], edx
	mov	eax, 4
	shl	eax, 1
	mov	ecx, 4
...
$LN31@SV_MoveSte:
	...
	mov	DWORD PTR _monsterClip$[ebp], ecx
...
; 281  : 				else if( dz < 30.0f ) neworg[2] += 8.0f;
	...
	mov	ecx, 4
	shl	ecx, 1
	movss	xmm0, DWORD PTR _neworg$[ebp+ecx]
...
; 312  : 		VectorCopy( neworg, end );
	...
	mov	ecx, 4
	imul	edx, ecx, 0
	mov	eax, DWORD PTR _neworg$[ebp+eax]
	mov	DWORD PTR _end$[ebp+edx], eax
	mov	ecx, 4
	shl	ecx, 0
	mov	edx, 4
	shl	edx, 0
	mov	eax, DWORD PTR _neworg$[ebp+ecx]
	mov	DWORD PTR _end$[ebp+edx], eax
	mov	ecx, 4
	shl	ecx, 1
	mov	edx, 4
...
; 313  : 		end[2] -= dz * 2.0f;
	...
	movss	xmm0, DWORD PTR _dz$[ebp]
	mulss	xmm0, DWORD PTR __real@40000000
	movss	xmm1, DWORD PTR _end$[ebp+ecx]
	subss	xmm1, xmm0
	mov	edx, 4
	shl	edx, 1
	movss	DWORD PTR _end$[ebp+edx], xmm1
