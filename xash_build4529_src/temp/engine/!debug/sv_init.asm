; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27045.0 
	...
	TITLE	C:\Users\USER\Downloads\xash_build4529_src\engine\server\sv_init.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
$SG136424 DB	'  %s', 0aH, 00H
	ORG $+2
$SG136425 DB	'----------------------------------', 0aH, 00H
$SG136426 DB	'c:\users\user\downloads\xash_build4529_src\engine\server'
	DB	'\sv_init.c', 00H
	ORG $+1
$SG136454 DB	'!', 00H
	ORG $+2
...
$SG136482 DB	'models/player.mdl', 00H
	ORG $+2
$SG136484 DB	'c:\users\user\downloads\xash_build4529_src\engine\server'
	DB	'\sv_init.c', 00H
	ORG $+1
$SG136524 DB	'sv_newunit', 00H
	ORG $+1
$SG136491 DB	'c:\users\user\downloads\xash_build4529_src\engine\server'
	DB	'\sv_init.c', 00H
	ORG $+1
...
$SG136619 DB	'Loading map "%s"', 0aH, 00H
	ORG $+2
$SG136590 DB	'c:\users\user\downloads\xash_build4529_src\engine\server'
	DB	'\sv_init.c', 00H
	ORG $+1
...
; File c:\users\user\downloads\xash_build4529_src\engine\server\sv_init.c
_TEXT	SEGMENT
tv190 = -40						; size = 8
tv154 = -32						; size = 4
tv187 = -28						; size = 4
