; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27045.0 
	...
	TITLE	C:\Users\USER\Documents\GitHub\XashTasks\xash_build4529_src\engine\client\s_mix.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	??_C@_0FC@NICCMIK@c?3?2users?2user?2documents?2github?2@ ; `string'
...
CONST	ENDS
_DATA	SEGMENT
$SG139106 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\client\s_mix.c', 00H
	ORG $+2
$SG139107 DB	'pSource != NULL', 00H
	ORG $+4
$SG139158 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\client\s_mix.c', 00H
	ORG $+6
$SG139159 DB	'floor( sampleFrac + rate * ( outSampleCount - 1 )) <= av'
	DB	'ailableSamples', 00H
	ORG $+1
$SG139188 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\client\s_mix.c', 00H
	ORG $+2
$SG139189 DB	'outputRate <= SOUND_DMA_SPEED', 00H
	ORG $+6
$SG139190 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\client\s_mix.c', 00H
	ORG $+6
$SG139191 DB	'!(( endtime - paintedtime ) & 0x3 ) || ( outputRate == S'
	DB	'OUND_DMA_SPEED )', 00H
	ORG $+7
$SG139265 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\client\s_mix.c', 00H
	ORG $+2
$SG139266 DB	'upCount <= PAINTBUFFER_SIZE', 00H
$SG139267 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\client\s_mix.c', 00H
	ORG $+6
$SG139268 DB	'outpos <= ( sizeof( temppaintbuffer ) / sizeof( temppain'
	DB	'tbuffer[0] ))', 00H
	ORG $+2
$SG139269 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\client\s_mix.c', 00H
	ORG $+2
$SG139270 DB	'cfltmem >= 3', 00H
	ORG $+7
$SG139288 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\client\s_mix.c', 00H
	ORG $+2
$SG139289 DB	'upCount <= PAINTBUFFER_SIZE', 00H
$SG139290 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\client\s_mix.c', 00H
	ORG $+2
$SG139291 DB	'cfltmem >= 1', 00H
	ORG $+7
$SG139355 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\client\s_mix.c', 00H
	ORG $+2
$SG139356 DB	'count <= PAINTBUFFER_SIZE', 00H
	ORG $+2
$SG139357 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\client\s_mix.c', 00H
	ORG $+2
$SG139358 DB	'ibuf1 < CPAINTBUFFERS', 00H
	ORG $+6
$SG139359 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\client\s_mix.c', 00H
	ORG $+2
$SG139360 DB	'ibuf2 < CPAINTBUFFERS', 00H
	ORG $+6
$SG139361 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\client\s_mix.c', 00H
	ORG $+2
$SG139362 DB	'ibuf3 < CPAINTBUFFERS', 00H
	ORG $+6
$SG139384 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\client\s_mix.c', 00H
	ORG $+2
$SG139385 DB	'ifilter < CPAINTFILTERS', 00H
_DATA	ENDS
...
_DATA	ENDS
;	COMDAT ??_C@_0FC@NICCMIK@c?3?2users?2user?2documents?2github?2@
_DATA	SEGMENT
??_C@_0FC@NICCMIK@c?3?2users?2user?2documents?2github?2@ DB 'c:\users\use'
	DB	'r\documents\github\xashtasks\xash_build4529_src\engine\client'
	DB	'\s_mix.c', 00H				; `string'
_DATA	ENDS
; Function compile flags: /Odtp
; File c:\users\user\documents\github\xashtasks\xash_build4529_src\engine\client\s_mix.c
_TEXT	SEGMENT
_end$ = 8						; size = 4
_count$ = 12						; size = 4
_MIX_UpsampleAllPaintbuffers PROC
...
; 958  : 			pbuf[j-paintedtime].left += ( ch->rawsamples[j & ( ch->max_samples - 1 )].left * ch->leftvol ) >> 8;
	...
	mov	eax, DWORD PTR [edx+eax*8+76]
...
; 922  : 			pbuf[i-paintedtime].left = ( ch->rawsamples[i & ( ch->max_samples - 1 )].left * ch->leftvol ) >> 8;
	...
	mov	edx, DWORD PTR [ecx+72]
	sub	edx, 1
	and	edx, DWORD PTR _i$2[ebp]
	mov	eax, DWORD PTR _ch$[ebp]
	mov	ecx, DWORD PTR _ch$[ebp]
	mov	edx, DWORD PTR [eax+edx*8+76]
...
; 923  : 			pbuf[i-paintedtime].right = ( ch->rawsamples[i & ( ch->max_samples - 1 )].right * ch->rightvol ) >> 8;
	...
	mov	eax, DWORD PTR [edx+72]
	sub	eax, 1
	and	eax, DWORD PTR _i$2[ebp]
	mov	ecx, DWORD PTR _ch$[ebp]
	mov	edx, DWORD PTR _ch$[ebp]
	mov	eax, DWORD PTR [ecx+eax*8+80]
...
$LN11@MIX_MixPai:
	push	0
	push	847					; 0000034fH
	push	OFFSET $SG139359
	push	OFFSET $SG139360
...
$LN13@MIX_MixPai:
	push	0
	push	848					; 00000350H
	push	OFFSET $SG139361
	push	OFFSET $SG139362
...
; 850  : 	pbuf1 = paintbuffers[ibuf1].pbuf;
	...
	imul	edx, DWORD PTR _ibuf1$[ebp], 108
	mov	eax, DWORD PTR _paintbuffers[edx+4]
	mov	DWORD PTR _pbuf1$[ebp], eax

; 851  : 	pbuf2 = paintbuffers[ibuf2].pbuf;

	imul	ecx, DWORD PTR _ibuf2$[ebp], 108
	mov	edx, DWORD PTR _paintbuffers[ecx+4]
	mov	DWORD PTR _pbuf2$[ebp], edx
...
; 866  : 		pbuf3[i].left += (pbuf2[i].left * gain) >> 8;
	...
	mov	ecx, DWORD PTR _i$[ebp]
	mov	edx, DWORD PTR _pbuf2$[ebp]
	mov	eax, DWORD PTR [edx+ecx*8]
	imul	eax, DWORD PTR _gain$[ebp]
	sar	eax, 8
	mov	ecx, DWORD PTR _i$[ebp]
	mov	edx, DWORD PTR _pbuf3$[ebp]
	add	eax, DWORD PTR [edx+ecx*8]
...
; 789  : 	for( i = upCount - 1, j = count - 1; j >= 0; i-=2, j-- )
	...
	mov	ecx, DWORD PTR _upCount$[ebp]
	sub	ecx, 1
	mov	DWORD PTR _i$[ebp], ecx
...
; 801  : 		S_Interpolate2xLinear( pbuffer, pfiltermem, cfltmem, count );
	...
	mov	edx, DWORD PTR _count$[ebp]
	push	edx
	mov	eax, DWORD PTR _cfltmem$[ebp]
	push	eax
...
$LN4@S_Interpol:
	mov	edx, DWORD PTR _i$[ebp]
	cmp	edx, DWORD PTR _upCount$[ebp]
...
$LN10@S_Interpol:
	push	0
	push	691					; 000002b3H
	push	OFFSET $SG139265
	push	OFFSET $SG139266
	mov	ecx, DWORD PTR tv70[ebp]
	push	ecx
	call	_DBG_AssertFunction
	add	esp, 20					; 00000014H
...
; 704  : 		temppaintbuffer[outpos++] = *psamp1;
	...
	mov	ecx, DWORD PTR _psamp1$[ebp]
	mov	edx, DWORD PTR [ecx]
	mov	eax, DWORD PTR [ecx+4]
	mov	ecx, DWORD PTR _outpos$[ebp]
	mov	DWORD PTR _temppaintbuffer[ecx*8], edx
	mov	DWORD PTR _temppaintbuffer[ecx*8+4], eax
...
; 708  : 		x0 = psamp1->left;
	...
	mov	edx, DWORD PTR _psamp1$[ebp]
	mov	eax, DWORD PTR [edx]
	mov	DWORD PTR _x0$[ebp], eax

; 709  : 		x1 = psamp2->left;

	mov	ecx, DWORD PTR _psamp2$[ebp]
	mov	edx, DWORD PTR [ecx]
...
$LN12@S_Interpol:
	push	0
	push	734					; 000002deH
	push	OFFSET $SG139267
	push	OFFSET $SG139268
...
; 741  : 	pfiltermem[1] = pbuffer[upCount - 3];
	...
	mov	edx, DWORD PTR _upCount$[ebp]
	mov	eax, DWORD PTR _pbuffer$[ebp]
	mov	ecx, DWORD PTR [eax+edx*8-24]
...
$LN7@S_Interpol:
	mov	ecx, DWORD PTR _i$[ebp]
	cmp	ecx, DWORD PTR _upCount$[ebp]
	jge	SHORT $LN1@S_Interpol

; 746  : 		pbuffer[i] = temppaintbuffer[i];

	mov	edx, DWORD PTR _i$[ebp]
	mov	eax, DWORD PTR _temppaintbuffer[edx*8]
	mov	ecx, DWORD PTR _temppaintbuffer[edx*8+4]
	mov	edx, DWORD PTR _i$[ebp]
	mov	esi, DWORD PTR _pbuffer$[ebp]
...
_MIX_MixChannelsToPaintbuffer PROC
...
; 544  : 	Assert( outputRate <= SOUND_DMA_SPEED );
	...
	jg	SHORT $LN37@MIX_MixCha
	mov	DWORD PTR tv69[ebp], 1
	jmp	SHORT $LN38@MIX_MixCha
$LN37@MIX_MixCha:
...
$LN42@MIX_MixCha:
	...
	mov	DWORD PTR _bZeroVolume$[ebp], ecx
...
; 606  : 		switch( rate )
	...
	cmp	DWORD PTR tv155[ebp], 11025		; 00002b11H
	je	SHORT $LN25@MIX_MixCha
	cmp	DWORD PTR tv155[ebp], 22050		; 00005622H
	je	SHORT $LN25@MIX_MixCha
	cmp	DWORD PTR tv155[ebp], 44100		; 0000ac44H
	je	SHORT $LN25@MIX_MixCha
	jmp	SHORT $LN27@MIX_MixCha
$LN25@MIX_MixCha:
...
; 611  : 			if( rate != pSource->rate )
	...
	cmp	DWORD PTR _rate$[ebp], edx
	je	SHORT $LN26@MIX_MixCha
...
; 622  : 		if( CL_GetEntityByIndex( ch->entnum ) && ( ch->entchannel == CHAN_VOICE ))
	...
	add	esp, 4
	test	eax, eax
	je	SHORT $LN32@MIX_MixCha
	mov	edx, DWORD PTR _ch$[ebp]
	cmp	DWORD PTR [edx+32], 2
	jne	SHORT $LN32@MIX_MixCha
...
$LN10@S_MixChann:
	push	0
	push	402					; 00000192H
	push	OFFSET $SG139106
	push	OFFSET $SG139107
...
; 404  : 	pvol[0] = bound( 0, pChannel->leftvol, 255 );
	...
	cmp	DWORD PTR [edx+20], 255			; 000000ffH
...
$LN11@S_MixChann:
	mov	DWORD PTR tv81[ebp], 255		; 000000ffH
$LN12@S_MixChann:
...
$LN14@S_MixChann:
	...
	mov	DWORD PTR _pvol$[ebp+ecx], edx
...
; 387  : 		pbuf[i].left += (volume[0] * (int)( pData[sampleIndex+0] ))>>8;
	...
	mov	ecx, 4
	imul	edx, ecx, 0
	mov	eax, DWORD PTR _sampleIndex$[ebp]
	mov	ecx, DWORD PTR _pData$[ebp]
	movsx	eax, WORD PTR [ecx+eax*2]
	mov	ecx, DWORD PTR _volume$[ebp]
	imul	eax, DWORD PTR [ecx+edx]
	sar	eax, 8
	mov	edx, DWORD PTR _i$[ebp]
	mov	ecx, DWORD PTR _pbuf$[ebp]
...
; 389  : 		sampleFrac += rateScale;
	...
	add	edx, DWORD PTR _rateScale$[ebp]
...
; 343  : 		pbuf[i].left += lscale[pData[sampleIndex+0]];
	...
	mov	edx, DWORD PTR _pData$[ebp]
	add	edx, DWORD PTR _sampleIndex$[ebp]
	movzx	eax, BYTE PTR [edx]
	mov	ecx, DWORD PTR _i$[ebp]
	mov	edx, DWORD PTR _pbuf$[ebp]
	mov	ecx, DWORD PTR [edx+ecx*8]
	mov	edx, DWORD PTR _lscale$[ebp]
...
; 345  : 		sampleFrac += rateScale;
	...
	mov	ecx, DWORD PTR _sampleFrac$[ebp]
	add	ecx, DWORD PTR _rateScale$[ebp]
	mov	DWORD PTR _sampleFrac$[ebp], ecx
...
; 346  : 		sampleIndex += FIX_INTPART( sampleFrac )<<1;
	...
	mov	DWORD PTR _sampleIndex$[ebp], ecx
...
; 301  : 		S_Mix8MonoTimeCompress( pbuf, volume, pData, inputOffset, rateScale, outCount, timecompress );
	...
	mov	ecx, DWORD PTR _timecompress$[ebp]
	push	ecx
	mov	edx, DWORD PTR _outCount$[ebp]
	push	edx
	mov	eax, DWORD PTR _rateScale$[ebp]
	push	eax
	mov	ecx, DWORD PTR _inputOffset$[ebp]
	push	ecx
	mov	edx, DWORD PTR _pData$[ebp]
	push	edx
	mov	eax, DWORD PTR _volume$[ebp]
...
$LN4@S_Mix8Mono:
	mov	edx, DWORD PTR _i$[ebp]
	cmp	edx, DWORD PTR _outCount$[ebp]
...
; 318  : 		pbuf[i].right += rscale[pData[sampleIndex]];
	...
	mov	ecx, DWORD PTR _pData$[ebp]
	add	ecx, DWORD PTR _sampleIndex$[ebp]
...
$LN4@MIX_GetPPa:
	push	0
	push	187					; 000000bbH
	push	OFFSET ??_C@_0FC@NICCMIK@c?3?2users?2user?2documents?2github?2@
...
; 182  : 	return paintbuffers[ipaintbuffer].pbuf;
	...
	imul	ecx, DWORD PTR _ipaintbuffer$[ebp], 108
	mov	eax, DWORD PTR _paintbuffers[ecx+4]
...
; 169  : 		paintbuffers[i].ifilter = FILTERTYPE_NONE;
	...
	imul	ecx, DWORD PTR _i$[ebp], 108
	mov	DWORD PTR _paintbuffers[ecx+8], 0
...
; 160  : 		paintbuffers[i].factive = false;
	...
	imul	ecx, DWORD PTR _i$[ebp], 108
	mov	DWORD PTR _paintbuffers[ecx], 0
...
; 140  : 		if( g_curpaintbuffer == paintbuffers[i].pbuf )
	...
	imul	ecx, DWORD PTR _i$[ebp], 108
	mov	edx, DWORD PTR _g_curpaintbuffer
	cmp	edx, DWORD PTR _paintbuffers[ecx+4]
...
; 130  : 	g_curpaintbuffer = paintbuffers[ipaintbuffer].pbuf;
	...
	imul	ecx, DWORD PTR _ipaintbuffer$[ebp], 108
	mov	edx, DWORD PTR _paintbuffers[ecx+4]
	mov	DWORD PTR _g_curpaintbuffer, edx
...
; 117  : 	paintbuffers[ipaintbuffer].factive = true;
	...
	imul	ecx, DWORD PTR _ipaintbuffer$[ebp], 108
	mov	DWORD PTR _paintbuffers[ecx], 1
...
_TEXT	SEGMENT
_pbuf$ = -36						; size = 4
_sampleMask$ = -32					; size = 4
_lpos$ = -28						; size = 4
_snd_p$ = -24						; size = 4
_lpaintedtime$ = -20					; size = 4
_snd_out$ = -16						; size = 4
_snd_linear_count$ = -12				; size = 4
_val$ = -8						; size = 4
_i$ = -4						; size = 4
_endtime$ = 8						; size = 4
_S_TransferPaintBuffer PROC
...
; 70   : 	snd_p = (int *)PAINTBUFFER;
	...
	mov	DWORD PTR _snd_p$[ebp], ecx

; 71   : 	lpaintedtime = paintedtime;

	mov	edx, DWORD PTR _paintedtime
	mov	DWORD PTR _lpaintedtime$[ebp], edx
...
; 74   : 	while( lpaintedtime < endtime )
	...
	mov	ecx, DWORD PTR _lpaintedtime$[ebp]
...
; 77   : 		lpos = lpaintedtime & sampleMask;
	...
	mov	edx, DWORD PTR _lpaintedtime$[ebp]
	and	edx, DWORD PTR _sampleMask$[ebp]
	mov	DWORD PTR _lpos$[ebp], edx
...
; 82   : 		if( lpaintedtime + snd_linear_count > endtime )
	...
	mov	ecx, DWORD PTR _lpaintedtime$[ebp]
	add	ecx, DWORD PTR _snd_linear_count$[ebp]
	cmp	ecx, DWORD PTR _endtime$[ebp]
...
; 83   : 			snd_linear_count = endtime - lpaintedtime;
	...
	sub	edx, DWORD PTR _lpaintedtime$[ebp]
	mov	DWORD PTR _snd_linear_count$[ebp], edx
$LN7@S_Transfer:
...
$LN6@S_Transfer:
	mov	edx, DWORD PTR _i$[ebp]
	cmp	edx, DWORD PTR _snd_linear_count$[ebp]
	jge	$LN5@S_Transfer
...
; 204  : 	paintbuffers[IROOMBUFFER].pbuf = roombuffer;
	...
	shl	edx, 0
	mov	DWORD PTR _paintbuffers[edx+4], OFFSET _roombuffer
...
_MIX_ClearAllPaintBuffers PROC
...
; 825  : 			memset( paintbuffers[i].fltmem, 0, sizeof( paintbuffers[i].fltmem ));
	...
	add	edx, OFFSET _paintbuffers+12
	push	edx
	call	_memset
	add	esp, 12					; 0000000cH
$LN6@MIX_ClearA:
...
tv252 = -76						; size = 8
_end$1 = -68						; size = 8
_sampleFrac$2 = -60					; size = 8
_startingOffset$ = -52					; size = 4
_j$3 = -48						; size = 4
_pSource$4 = -44					; size = 4
_use_loop$5 = -40					; size = 4
_samplesRequired$6 = -36				; size = 4
_inputRate$ = -32					; size = 4
_pData$7 = -28						; size = 4
tv181 = -24						; size = 4
_inputSampleCount$8 = -20				; size = 4
_availableSamples$9 = -16				; size = 4
_i$10 = -12						; size = 4
_outSampleCount$11 = -8					; size = 4
_rate$ = -4						; size = 4
_pChannel$ = 8						; size = 4
_sampleCount$ = 12					; size = 4
_outRate$ = 16						; size = 4
...
; 451  : 		wavdata_t	*pSource = pChannel->sfx->cache;
	...
	mov	ecx, DWORD PTR [eax+16]
	mov	edx, DWORD PTR [ecx+64]
	mov	DWORD PTR _pSource$4[ebp], edx

; 452  : 		qboolean	use_loop = pChannel->use_loop;

	mov	eax, DWORD PTR _pChannel$[ebp]
	mov	ecx, DWORD PTR [eax+68]
	mov	DWORD PTR _use_loop$5[ebp], ecx

; 453  : 		char	*pData = NULL;

	mov	DWORD PTR _pData$7[ebp], 0
...
; 458  : 		double	end = pChannel->pMixer.sample + rate * sampleCount;
	...
	cvtss2sd xmm0, xmm0
	mov	edx, DWORD PTR _pChannel$[ebp]
	addsd	xmm0, QWORD PTR [edx+80]
	movsd	QWORD PTR _end$1[ebp], xmm0

; 459  : 		int	inputSampleCount = (int)(ceil( end ) - floor( pChannel->pMixer.sample ));

	sub	esp, 8
	movsd	xmm0, QWORD PTR _end$1[ebp]
	...
	subsd	xmm0, QWORD PTR tv259[ebp]
	cvttsd2si ecx, xmm0
	mov	DWORD PTR _inputSampleCount$8[ebp], ecx

; 460  : 
; 461  : 		availableSamples = S_GetOutputData( pSource, &pData, pChannel->pMixer.sample, inputSampleCount, use_loop );

	mov	edx, DWORD PTR _use_loop$5[ebp]
	push	edx
	mov	eax, DWORD PTR _inputSampleCount$8[ebp]
	push	eax
	mov	ecx, DWORD PTR _pChannel$[ebp]
	cvttsd2si edx, QWORD PTR [ecx+80]
	push	edx
	lea	eax, DWORD PTR _pData$7[ebp]
	push	eax
	mov	ecx, DWORD PTR _pSource$4[ebp]
	push	ecx
	call	_S_GetOutputData
	add	esp, 20					; 00000014H
	mov	DWORD PTR _availableSamples$9[ebp], eax

; 462  : 
; 463  : 		// none available, bail out
; 464  : 		if( !availableSamples ) break;

	cmp	DWORD PTR _availableSamples$9[ebp], 0
...
; 466  : 		sampleFrac = pChannel->pMixer.sample - floor( pChannel->pMixer.sample );
	...
	call	DWORD PTR __imp__floor
	add	esp, 8
	fstp	QWORD PTR tv272[ebp]
	mov	eax, DWORD PTR _pChannel$[ebp]
	movsd	xmm0, QWORD PTR [eax+80]
	subsd	xmm0, QWORD PTR tv272[ebp]
	movsd	QWORD PTR _sampleFrac$2[ebp], xmm0

; 467  : 
; 468  : 		if( availableSamples < inputSampleCount )

	mov	ecx, DWORD PTR _availableSamples$9[ebp]
	cmp	ecx, DWORD PTR _inputSampleCount$8[ebp]
...
; 471  : 			outSampleCount = (int)ceil(( availableSamples - sampleFrac ) / rate );
	...
	cvtsi2sd xmm0, DWORD PTR _availableSamples$9[ebp]
	subsd	xmm0, QWORD PTR _sampleFrac$2[ebp]
	cvtss2sd xmm1, DWORD PTR _rate$[ebp]
	divsd	xmm0, xmm1
	sub	esp, 8
	movsd	QWORD PTR [esp], xmm0
	...
	add	esp, 8
	call	__ftol2_sse
	mov	DWORD PTR _outSampleCount$11[ebp], eax
...
; 475  : 			outSampleCount = sampleCount;
	...
	mov	edx, DWORD PTR _sampleCount$[ebp]
	mov	DWORD PTR _outSampleCount$11[ebp], edx
$LN12@S_MixDataT:
...
; 479  : 		Assert( floor( sampleFrac + rate * ( outSampleCount - 1 )) <= availableSamples );
	...
	mov	eax, DWORD PTR _outSampleCount$11[ebp]
	sub	eax, 1
	cvtsi2ss xmm0, eax
	mulss	xmm0, DWORD PTR _rate$[ebp]
	cvtss2sd xmm0, xmm0
	addsd	xmm0, QWORD PTR _sampleFrac$2[ebp]
	sub	esp, 8
	movsd	QWORD PTR [esp], xmm0
	call	DWORD PTR __imp__floor
	add	esp, 8
	...
	cvtsi2sd xmm0, DWORD PTR _availableSamples$9[ebp]
	comisd	xmm0, QWORD PTR tv290[ebp]
...
; 486  : 			if( !paintbuffers[i].factive )
	...
	imul	eax, DWORD PTR _i$10[ebp], 108
...
; 492  : 			S_MixChannel( pChannel, pData, outOffset, FIX_FLOAT( sampleFrac ), FIX_FLOAT( rate ), outSampleCount, timeCompress );
	...
	mov	edx, DWORD PTR _timeCompress$[ebp]
	push	edx
	mov	eax, DWORD PTR _outSampleCount$11[ebp]
	push	eax
	...
	cvttss2si ecx, xmm0
	push	ecx
	movsd	xmm0, QWORD PTR _sampleFrac$2[ebp]
	mulsd	xmm0, QWORD PTR __real@41b0000000000000
	cvttsd2si edx, xmm0
	push	edx
	mov	eax, DWORD PTR _outOffset$[ebp]
	push	eax
	mov	ecx, DWORD PTR _pData$7[ebp]
	push	ecx
	mov	edx, DWORD PTR _pChannel$[ebp]
	push	edx
	call	_S_MixChannel
...
; 497  : 		pChannel->pMixer.sample += outSampleCount * rate;
	...
	cvtsi2ss xmm0, DWORD PTR _outSampleCount$11[ebp]
	mulss	xmm0, DWORD PTR _rate$[ebp]
	cvtss2sd xmm0, xmm0
	mov	ecx, DWORD PTR _pChannel$[ebp]
	addsd	xmm0, QWORD PTR [ecx+80]
	mov	edx, DWORD PTR _pChannel$[ebp]
...
; 498  : 		outOffset += outSampleCount;
	...
	mov	eax, DWORD PTR _outOffset$[ebp]
	add	eax, DWORD PTR _outSampleCount$11[ebp]
	mov	DWORD PTR _outOffset$[ebp], eax

; 499  : 		sampleCount -= outSampleCount;

	mov	ecx, DWORD PTR _sampleCount$[ebp]
	sub	ecx, DWORD PTR _outSampleCount$11[ebp]
	mov	DWORD PTR _sampleCount$[ebp], ecx
...
; 51   : 			snd_scaletable[i][j] = ((signed char)j) * i * (1<<SND_SCALE_SHIFT);
	...
	movsx	edx, BYTE PTR _j$[ebp]
	imul	edx, DWORD PTR _i$[ebp]
	shl	edx, 1
	mov	eax, DWORD PTR _i$[ebp]
	shl	eax, 10					; 0000000aH
	mov	ecx, DWORD PTR _j$[ebp]
	mov	DWORD PTR _snd_scaletable[eax+ecx*4], edx
