; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27045.0 
	...
	TITLE	C:\Users\USER\Downloads\xash_build4529_src\engine\client\s_mix.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	??_C@_0EB@KNACAKCG@c?3?2users?2user?2downloads?2xash_bu@ ; `string'
...
CONST	ENDS
_DATA	SEGMENT
$SG139106 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\s_mix.c', 00H
	ORG $+3
$SG139107 DB	'pSource != NULL', 00H
	ORG $+4
$SG139158 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\s_mix.c', 00H
	ORG $+7
$SG139159 DB	'floor( sampleFrac + rate * ( outSampleCount - 1 )) <= av'
	DB	'ailableSamples', 00H
	ORG $+1
$SG139188 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\s_mix.c', 00H
	ORG $+3
$SG139189 DB	'outputRate <= SOUND_DMA_SPEED', 00H
	ORG $+6
$SG139190 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\s_mix.c', 00H
	ORG $+7
$SG139191 DB	'!(( endtime - paintedtime ) & 0x3 ) || ( outputRate == S'
	DB	'OUND_DMA_SPEED )', 00H
	ORG $+7
$SG139265 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\s_mix.c', 00H
	ORG $+3
$SG139266 DB	'upCount <= PAINTBUFFER_SIZE', 00H
$SG139267 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\s_mix.c', 00H
	ORG $+7
$SG139268 DB	'outpos <= ( sizeof( temppaintbuffer ) / sizeof( temppain'
	DB	'tbuffer[0] ))', 00H
	ORG $+2
$SG139269 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\s_mix.c', 00H
	ORG $+3
$SG139270 DB	'cfltmem >= 3', 00H
	ORG $+7
$SG139288 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\s_mix.c', 00H
	ORG $+3
$SG139289 DB	'upCount <= PAINTBUFFER_SIZE', 00H
$SG139290 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\s_mix.c', 00H
	ORG $+3
$SG139291 DB	'cfltmem >= 1', 00H
	ORG $+7
$SG139355 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\s_mix.c', 00H
	ORG $+3
$SG139356 DB	'count <= PAINTBUFFER_SIZE', 00H
	ORG $+2
$SG139357 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\s_mix.c', 00H
	ORG $+3
$SG139358 DB	'ibuf1 < CPAINTBUFFERS', 00H
	ORG $+6
$SG139359 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\s_mix.c', 00H
	ORG $+3
$SG139360 DB	'ibuf2 < CPAINTBUFFERS', 00H
	ORG $+6
$SG139361 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\s_mix.c', 00H
	ORG $+3
$SG139362 DB	'ibuf3 < CPAINTBUFFERS', 00H
	ORG $+6
$SG139384 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\s_mix.c', 00H
	ORG $+3
...
_DATA	ENDS
;	COMDAT ??_C@_0EB@KNACAKCG@c?3?2users?2user?2downloads?2xash_bu@
_DATA	SEGMENT
??_C@_0EB@KNACAKCG@c?3?2users?2user?2downloads?2xash_bu@ DB 'c:\users\use'
	DB	'r\downloads\xash_build4529_src\engine\client\s_mix.c', 00H ; `string'
_DATA	ENDS
; Function compile flags: /Odtp
; File c:\users\user\downloads\xash_build4529_src\engine\client\s_mix.c
_TEXT	SEGMENT
_end$ = 8						; size = 4
_count$ = 12						; size = 4
...
$LN4@MIX_GetPPa:
	push	0
	push	187					; 000000bbH
	push	OFFSET ??_C@_0EB@KNACAKCG@c?3?2users?2user?2downloads?2xash_bu@
