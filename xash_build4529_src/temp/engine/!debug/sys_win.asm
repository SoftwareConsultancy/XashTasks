; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27045.0 
	...
	TITLE	C:\Users\USER\Documents\GitHub\XashTasks\xash_build4529_src\engine\common\sys_win.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	ENDS
_DATA	SEGMENT
$SG131426 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\sys_win.c', 00H
$SG131485 DB	'rpcrt4.dll', 00H
	ORG $+1
$SG131430 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\sys_win.c', 00H
$SG131443 DB	'^1Error:^7 unable to write screenshot', 0aH, 00H
	ORG $+1
$SG131461 DB	'advapi32.dll', 00H
	ORG $+3
$SG131463 DB	'GetUserNameA', 00H
	ORG $+3
$SG131467 DB	'player', 00H
	ORG $+1
$SG131487 DB	'UuidCreateSequential', 00H
	ORG $+3
$SG131490 DB	'%02X-%02X-%02X-%02X-%02X-%02X', 00H
	ORG $+2
$SG131517 DB	'shell32.dll', 00H
$SG131519 DB	'ShellExecuteA', 00H
	ORG $+2
$SG131521 DB	'open', 00H
	ORG $+3
$SG131549 DB	'censored', 00H
	ORG $+3
$SG131550 DB	'exe', 00H
$SG131558 DB	'-game', 00H
	ORG $+2
$SG131560 DB	'+game', 00H
	ORG $+2
$SG131562 DB	'+map', 00H
	ORG $+3
$SG131564 DB	'+load', 00H
	ORG $+2
$SG131566 DB	'+changelevel', 00H
	ORG $+3
$SG131631 DB	'Sys_LoadLibrary: Loading %s', 00H
$SG131635 DB	'Sys_LoadLibrary: couldn''t load %s', 0aH, 00H
	ORG $+1
$SG131637 DB	'Sys_LoadLibrary: %s missing or invalid function (%s)', 0aH
	DB	00H
	ORG $+2
$SG131638 DB	' - ok', 0aH, 00H
	ORG $+1
$SG131639 DB	' - failed', 0aH, 00H
	ORG $+1
$SG131642 DB	'^1Error:^7 ', 00H
$SG131643 DB	'%s%s', 00H
	ORG $+3
$SG131661 DB	'Sys_FreeLibrary: hold %s for debugging', 0aH, 00H
$SG131662 DB	'Sys_FreeLibrary: Unloading %s', 0aH, 00H
	ORG $+1
$SG131677 DB	'unhandled exception: %p at address %p', 0aH, 00H
	ORG $+1
$SG131699 DB	'Xash Error', 00H
_DATA	ENDS
; Function compile flags: /Odtp
; File c:\users\user\documents\github\xashtasks\xash_build4529_src\engine\common\sys_win.c
_TEXT	SEGMENT
_msg$ = -28						; size = 28
_Sys_WaitForQuit PROC
...
; 588  : 			b[1] = c[0] = '\n';
	...
	shl	edx, 0
	mov	eax, DWORD PTR _b$[ebp]
	mov	BYTE PTR [eax+edx], 10			; 0000000aH
...
; 612  : 		else
; 613  : 		{
; 614  : 			if( msg[i] == '\1' || msg[i] == '\2' || msg[i] == '\3' )
...
; File c:\users\user\documents\github\xashtasks\xash_build4529_src\engine\common\sys_win.c
_TEXT	SEGMENT
_pUuidCreateSequential$ = -40				; size = 4
_rpcrt4_dll$ = -36					; size = 4
_i$ = -32						; size = 4
_uuid$ = -28						; size = 16
_mac$ = -12						; size = 8
__$ArrayPad$ = -4					; size = 4
_nLength$ = 8						; size = 4
_Sys_GetMachineKey PROC
...
; 162  : 	if( rpcrt4_dll ) FreeLibrary( rpcrt4_dll ); // no need anymore...
	...
	mov	edx, DWORD PTR _rpcrt4_dll$[ebp]
	push	edx
...
; 165  : 		mac[i-2] = uuid.Data4[i];
	...
	mov	ecx, DWORD PTR _i$[ebp]
	mov	edx, DWORD PTR _i$[ebp]
	mov	al, BYTE PTR _uuid$[ebp+edx+8]
	mov	BYTE PTR _mac$[ebp+ecx-2], al
...
; 337  : 	if( !argc || !out || !host.argv[argc + 1] )
	...
	cmp	DWORD PTR _host[ecx*4+928], 0
...
; 94   : 		byte *bufferCopy = (byte *)GlobalLock( hResult ); 
	...
	mov	ecx, DWORD PTR _hResult$2[ebp]
	push	ecx
...
; 96   : 		memcpy( bufferCopy, buffer, size ); 
	...
	push	eax
	mov	ecx, DWORD PTR _bufferCopy$1[ebp]
	push	ecx
	call	_memcpy
	add	esp, 12					; 0000000cH
...
; 97   : 		GlobalUnlock( hResult ); 
	...
	mov	edx, DWORD PTR _hResult$2[ebp]
	push	edx
...
; 274  : 			lpCmdLine++;
	...
	mov	edx, DWORD PTR _lpCmdLine$[ebp]
	add	edx, 1
	mov	DWORD PTR _lpCmdLine$[ebp], edx
...
; 280  : 			lpCmdLine++;
	...
	mov	ecx, DWORD PTR _lpCmdLine$[ebp]
	add	ecx, 1
	mov	DWORD PTR _lpCmdLine$[ebp], ecx

; 281  : 			host.argv[host.argc] = lpCmdLine;

	mov	edx, DWORD PTR _host+920
	mov	eax, DWORD PTR _lpCmdLine$[ebp]
	mov	DWORD PTR _host[edx*4+924], eax

; 282  : 			host.argc++;

	mov	ecx, DWORD PTR _host+920
	add	ecx, 1
	mov	DWORD PTR _host+920, ecx
$LN6@Sys_MergeC:
...
; 289  : 			host.argv[host.argc] = lpCmdLine;
	...
	mov	ecx, DWORD PTR _host+920
	mov	edx, DWORD PTR _lpCmdLine$[ebp]
	mov	DWORD PTR _host[ecx*4+924], edx
...
; 197  : 	const char	*blank = "censored";
	...
	mov	DWORD PTR _blank$[ebp], OFFSET $SG131549
...
; 202  : 	host.argv[0] = "exe";
	...
	mov	eax, 4
	imul	ecx, eax, 0
	mov	DWORD PTR _host[ecx+924], OFFSET $SG131550
...
; 244  : 		if( !Q_stricmp( "-game", host.argv[i] )) host.argv[i] = (char *)blank;
	...
	push	eax
	push	OFFSET $SG131558
	call	_Q_strnicmp
	add	esp, 12					; 0000000cH
	test	eax, eax
	jne	SHORT $LN19@Sys_ParseC
	mov	ecx, DWORD PTR _i$[ebp]
	mov	edx, DWORD PTR _blank$[ebp]
	mov	DWORD PTR _host[ecx*4+924], edx
$LN19@Sys_ParseC:
...
; 246  : 		if( !Q_stricmp( "+game", host.argv[i] )) host.argv[i] = (char *)blank;
	...
	push	ecx
	push	OFFSET $SG131560
	call	_Q_strnicmp
	add	esp, 12					; 0000000cH
	test	eax, eax
	jne	SHORT $LN20@Sys_ParseC
	mov	edx, DWORD PTR _i$[ebp]
	mov	eax, DWORD PTR _blank$[ebp]
	mov	DWORD PTR _host[edx*4+924], eax
$LN20@Sys_ParseC:
...
; 408  : 	else Con_DPrintf( "%s%s", S_ERROR, errorstring );			
	...
	push	ecx
	push	OFFSET $SG131642
	push	OFFSET $SG131643
	call	_Con_DPrintf
	add	esp, 12					; 0000000cH
$LN17@Sys_LoadLi:
...
_TEXT	SEGMENT
_size$ = -12						; size = 4
_pGetUserNameA$1 = -8					; size = 4
_advapi32_dll$2 = -4					; size = 4
_Sys_GetCurrentUser PROC
...
; 139  : 		if( advapi32_dll ) FreeLibrary( advapi32_dll ); // no need anymore...
	...
	mov	edx, DWORD PTR _advapi32_dll$2[ebp]
	push	edx
	call	DWORD PTR __imp__FreeLibrary@4
$LN5@Sys_GetCur:
...
_TEXT	SEGMENT
_cliptext$ = -8						; size = 4
_hClipboardData$1 = -4					; size = 4
_Sys_GetClipboardData PROC
...
; 69   : 				data = Z_Malloc( GlobalSize( hClipboardData ) + 1 );
	...
	push	69					; 00000045H
	push	OFFSET $SG131430
	push	0
	mov	edx, DWORD PTR _hClipboardData$1[ebp]
	push	edx
...
; 70   : 				Q_strcpy( data, cliptext );
	...
	push	99999					; 0001869fH
	mov	ecx, DWORD PTR _cliptext$[ebp]
	push	ecx
	mov	edx, DWORD PTR ?data@?1??Sys_GetClipboardData@@9@9
	push	edx
	call	_Q_strncpy
	add	esp, 12					; 0000000cH
