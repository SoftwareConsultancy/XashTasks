; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27045.0 
	...
	TITLE	C:\Users\USER\Documents\GitHub\XashTasks\xash_build4529_src\engine\client\gl_refrag.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	ENDS
_DATA	SEGMENT
$SG143607 DB	'^1Error:^7 too many efrags!', 0aH, 00H
_DATA	ENDS
; Function compile flags: /Odtp
; File c:\users\user\documents\github\xashtasks\xash_build4529_src\engine\client\gl_refrag.c
_TEXT	SEGMENT
tv138 = -24						; size = 4
tv132 = -20						; size = 4
tv131 = -16						; size = 4
...
; 94   : 			r_pefragtopnode = node;
	...
	mov	DWORD PTR _r_pefragtopnode, edx
$LN4@R_SplitEnt:
...
; 99   : 		ef = clgame.free_efrags;
	...
	mov	ecx, DWORD PTR _clgame+149796
...
; 106  : 		clgame.free_efrags = clgame.free_efrags->entnext;
	...
	mov	DWORD PTR _clgame+149796, eax

; 107  : 		ef->entity = r_addent;

	mov	ecx, DWORD PTR _ef$[ebp]
	mov	edx, DWORD PTR _r_addent
...
; 111  : 		lastlink = &ef->entnext;
	...
	mov	edx, DWORD PTR _ef$[ebp]
	add	edx, 12					; 0000000cH
	mov	DWORD PTR _lastlink, edx
...
; 122  : 	sides = BOX_ON_PLANE_SIDE( r_emins, r_emaxs, node->plane );
	...
	movss	xmm0, DWORD PTR _r_emins[ecx*4]
...
$LN13@R_SplitEnt:
	...
	comiss	xmm0, DWORD PTR _r_emaxs[ecx*4]
...
; 128  : 		if( !r_pefragtopnode ) r_pefragtopnode = node;
	...
	jne	SHORT $LN7@R_SplitEnt
	mov	ecx, DWORD PTR _node$[ebp]
	mov	DWORD PTR _r_pefragtopnode, ecx
$LN7@R_SplitEnt:
...
; 150  : 	r_addent = ent;
	...
	mov	DWORD PTR _r_addent, ecx

; 151  : 	lastlink = &ent->efrag;

	mov	edx, DWORD PTR _ent$[ebp]
	add	edx, 2968				; 00000b98H
	mov	DWORD PTR _lastlink, edx
...
; 156  : 	Matrix3x4_TransformAABB( transform, ent->model->mins, ent->model->maxs, outmins, outmaxs );
	...
	lea	edx, DWORD PTR _outmaxs$[ebp]
	push	edx
	lea	eax, DWORD PTR _outmins$[ebp]
	push	eax
	mov	ecx, DWORD PTR _ent$[ebp]
...
; 160  : 		r_emins[i] = ent->origin[i] + outmins[i];
	...
	addss	xmm0, DWORD PTR _outmins$[ebp+eax*4]
	mov	ecx, DWORD PTR _i$[ebp]
	movss	DWORD PTR _r_emins[ecx*4], xmm0
...
; 161  : 		r_emaxs[i] = ent->origin[i] + outmaxs[i];
	...
	addss	xmm0, DWORD PTR _outmaxs$[ebp+ecx*4]
	mov	edx, DWORD PTR _i$[ebp]
	movss	DWORD PTR _r_emaxs[edx*4], xmm0
...
; 165  : 	ent->topnode = r_pefragtopnode;
	...
	mov	edx, DWORD PTR _ent$[ebp]
	mov	eax, DWORD PTR _r_pefragtopnode
...
; 71   : 		clgame.free_efrags = old;
	...
	mov	DWORD PTR _clgame+149796, edx
...
; 180  : 	while(( pefrag = *ppefrag ) != NULL )
	...
	je	SHORT $LN1@R_StoreEfr

; 181  : 	{
; 182  : 		pent = pefrag->entity;

	mov	edx, DWORD PTR _pefrag$[ebp]
...
; 185  : 		switch( clmodel->type )
	...
	jl	SHORT $LN4@R_StoreEfr
	cmp	DWORD PTR tv68[ebp], 3
	jle	SHORT $LN6@R_StoreEfr
	jmp	SHORT $LN4@R_StoreEfr
$LN6@R_StoreEfr:
...
; 193  : 			if( pent->visframe != framecount )
	...
	cmp	edx, DWORD PTR _framecount$[ebp]
	je	SHORT $LN7@R_StoreEfr
...
; 203  : 			ppefrag = &pefrag->leafnext;
	...
	mov	edx, DWORD PTR _pefrag$[ebp]
	add	edx, 4
	mov	DWORD PTR _ppefrag$[ebp], edx
$LN4@R_StoreEfr:
