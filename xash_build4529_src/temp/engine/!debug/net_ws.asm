...
$SG132409 DB	'localhost', 00H
	ORG $+2
$SG132458 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\net_ws.c', 00H
	ORG $+1
$SG132496 DB	'Server must enable dev-mode to activate fakelag', 0aH, 00H
	ORG $+3
$SG132459 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\net_ws.c', 00H
	ORG $+1
$SG132497 DB	'fakelag', 00H
$SG132529 DB	'fakeloss', 00H
	ORG $+3
$SG132481 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\net_ws.c', 00H
	ORG $+1
$SG132564 DB	'^1Error:^7 invalid split packet length %i', 0aH, 00H
	ORG $+1
$SG132530 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\net_ws.c', 00H
	ORG $+1
$SG132567 DB	'^1Error:^7 malformed packet number (%i/%i)', 0aH, 00H
$SG132534 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\net_ws.c', 00H
	ORG $+1
$SG132571 DB	'<-- Split packet restart %i count %i seq', 0aH, 00H
	ORG $+2
$SG132535 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\net_ws.c', 00H
	ORG $+1
