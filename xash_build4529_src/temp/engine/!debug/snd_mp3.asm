; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27045.0 
	...
	TITLE	C:\Users\USER\Downloads\xash_build4529_src\engine\common\soundlib\snd_mp3.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
$SG130003 DB	'c:\users\user\downloads\xash_build4529_src\engine\common'
	DB	'\soundlib\snd_mp3.c', 00H
$SG130027 DB	'^1Error:^7 Stream_OpenMPG: couldn''t create decoder', 0aH
	DB	00H
$SG130025 DB	'c:\users\user\downloads\xash_build4529_src\engine\common'
	DB	'\soundlib\snd_mp3.c', 00H
$SG130032 DB	'^1Error:^7 Stream_OpenMPG: failed to load (%s): %s', 0aH
	DB	00H
$SG130028 DB	'c:\users\user\downloads\xash_build4529_src\engine\common'
	DB	'\soundlib\snd_mp3.c', 00H
$SG130030 DB	'^1Error:^7 %s', 0aH, 00H
	ORG $+5
$SG130033 DB	'c:\users\user\downloads\xash_build4529_src\engine\common'
	DB	'\soundlib\snd_mp3.c', 00H
	ORG $+4
$SG130069 DB	'c:\users\user\downloads\xash_build4529_src\engine\common'
	DB	'\soundlib\snd_mp3.c', 00H
_DATA	ENDS
; Function compile flags: /Odtp
; File c:\users\user\downloads\xash_build4529_src\engine\common\soundlib\snd_mp3.c
_TEXT	SEGMENT
_stream$ = 8						; size = 4
