; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27045.0 
	...
	TITLE	C:\Users\USER\Documents\GitHub\XashTasks\xash_build4529_src\engine\common\mod_dbghulls.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	ENDS
_DATA	SEGMENT
$SG143346 DB	'free_winding: freed a freed winding', 0aH, 00H
	ORG $+3
$SG143402 DB	'BaseWindingForPlane: no axis found', 0aH, 00H
$SG143561 DB	'node stack overflow', 0aH, 00H
	ORG $+3
$SG143566 DB	'node stack underflow', 0aH, 00H
	ORG $+2
$SG143651 DB	'bad contents: %i', 0aH, 00H
	ORG $+2
$SG143694 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\mod_dbghulls.c', 00H
	ORG $+3
$SG143695 DB	'assert failed at %s:%i', 0aH, 00H
$SG143706 DB	'^3Warning:^7 new winding was clipped away!', 0aH, 00H
$SG143704 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\mod_dbghulls.c', 00H
	ORG $+3
$SG143705 DB	'assert failed at %s:%i', 0aH, 00H
$SG143737 DB	'%i clipnodes...', 0aH, 00H
	ORG $+3
$SG143739 DB	'%i hull polys', 0aH, 00H
	ORG $+1
$SG143748 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\mod_dbghulls.c', 00H
	ORG $+3
$SG143763 DB	'generating polygons for hull %u...', 0aH, 00H
$SG143764 DB	'*%i', 00H
$SG143765 DB	'build time %.3f secs', 0aH, 00H
_DATA	ENDS
; Function compile flags: /Odtp
; File c:\users\user\documents\github\xashtasks\xash_build4529_src\engine\common\mod_dbghulls.c
_TEXT	SEGMENT
_head$ = -8						; size = 8
_hull$ = 8						; size = 4
_model$ = 12						; size = 4
_make_hull_windings PROC
...
; 518  : 		switch( node->children[side] )
	...
	jmp	DWORD PTR $LN17@do_hull_re[ecx*4]
$LN12@do_hull_re:
...
; 552  : 	hullnode_t	frontlist = LIST_HEAD_INIT( frontlist );
	...
	mov	DWORD PTR _frontlist$[ebp+4], ecx

; 553  : 	hullnode_t	backlist = LIST_HEAD_INIT( backlist );

	lea	edx, DWORD PTR _backlist$[ebp]
	mov	DWORD PTR _backlist$[ebp], edx
...
; 574  : 				winding_split( w->pair, plane, &front2, &back2 );
	...
	lea	edx, DWORD PTR _back2$2[ebp]
	push	edx
	lea	eax, DWORD PTR _front2$3[ebp]
	push	eax
	mov	ecx, DWORD PTR _plane$[ebp]
	push	ecx
	mov	edx, DWORD PTR _w$[ebp]
...
; 576  : 				front2->pair = front;
	...
	mov	ecx, DWORD PTR _front2$3[ebp]
...
; 578  : 				back2->pair = back;
	...
	mov	edx, DWORD PTR _back2$2[ebp]
	mov	eax, DWORD PTR _back$[ebp]
...
; 581  : 				list_add( &front2->chain, &w->pair->chain );
	...
	add	ecx, 8
	push	ecx
	mov	edx, DWORD PTR _front2$3[ebp]
	add	edx, 8
	push	edx
	call	_list_add
	add	esp, 8
...
; 602  : 		mplane_t *p = hull->planes + node_stack[i]->planenum;
	...
	mov	edx, DWORD PTR _node_stack[ecx*4]
...
; 603  : 		w = winding_clip( w, p, false, side_stack[i], 0.00001 );
	...
	mov	edx, DWORD PTR _i$[ebp]
	mov	eax, DWORD PTR _side_stack[edx*4]
	push	eax
	push	0
...
$LN4@free_hull_:
	mov	ecx, DWORD PTR _w$[ebp]
	add	ecx, 8
	cmp	ecx, DWORD PTR _hull_polys$[ebp]
...
; 481  : 	side_stack[node_stack_depth] = side;
	...
	mov	edx, DWORD PTR _node_stack_depth
	mov	eax, DWORD PTR _side$[ebp]
	mov	DWORD PTR _side_stack[edx*4], eax

; 482  : 	node_stack_depth++;

	mov	ecx, DWORD PTR _node_stack_depth
	add	ecx, 1
	mov	DWORD PTR _node_stack_depth, ecx
...
; 398  : 	maxpts = in->numpoints + 4;
	...
	add	eax, 4
	mov	DWORD PTR _maxpts$[ebp], eax

; 399  : 	front = winding_alloc( maxpts );

	mov	ecx, DWORD PTR _maxpts$[ebp]
	push	ecx
	call	_winding_alloc
	add	esp, 4
...
; 285  : 	if( !counts[side ^ 1] )
	...
	mov	edx, DWORD PTR _side$[ebp]
	xor	edx, 1
	cmp	DWORD PTR _counts$[ebp+edx*4], 0
...
; 147  : 	switch( axis )
	...
	jl	SHORT $LN10@winding_fo
	cmp	DWORD PTR tv80[ebp], 1
	jle	SHORT $LN8@winding_fo
	cmp	DWORD PTR tv80[ebp], 2
	je	SHORT $LN9@winding_fo
	jmp	SHORT $LN10@winding_fo
$LN8@winding_fo:
...
; 163  : 	VectorNormalize( vup );
	...
	mulss	xmm1, DWORD PTR _vup$[ebp+eax]
	addss	xmm0, xmm1
	mov	ecx, 4
	shl	ecx, 1
	mov	edx, 4
...
; 175  : 	VectorSubtract( org, vright, w->p[0] );
	...
	subss	xmm0, DWORD PTR _vright$[ebp+ecx]
...
; 177  : 	VectorAdd( org, vright, w->p[1] );
	...
	addss	xmm0, DWORD PTR _vright$[ebp+edx]
	mov	eax, 12					; 0000000cH
	shl	eax, 0
	mov	ecx, DWORD PTR _w$[ebp]
	lea	edx, DWORD PTR [ecx+eax+20]
...
; 180  : 	VectorSubtract( w->p[2], vup, w->p[2] );
	...
	shl	edx, 0
	movss	xmm0, DWORD PTR [eax+ecx]
	subss	xmm0, DWORD PTR _vup$[ebp+edx]
	mov	eax, 12					; 0000000cH
	shl	eax, 1
	mov	ecx, DWORD PTR _w$[ebp]
	lea	edx, DWORD PTR [ecx+eax+20]
...
; 78   : 	*(unsigned *)w = 0xDEADC0DE;
	...
	mov	ecx, DWORD PTR _w$[ebp]
	mov	DWORD PTR [ecx], -559038242		; deadc0deH
...
; 711  : 		hull_model_t *model = &world.hull_models[i];
	...
	imul	edx, DWORD PTR _i$[ebp], 12
	add	edx, DWORD PTR _world+2576
	mov	DWORD PTR _model$1[ebp], edx
...
__$ArrayPad$ = -4					; size = 4
_hullnum$ = 8						; size = 4
_Mod_CreatePolygonsForHull PROC
...
; 688  : 	Con_Printf( "generating polygons for hull %u...\n", hullnum );
	...
	mov	ecx, DWORD PTR _hullnum$[ebp]
	push	ecx
	push	OFFSET $SG143763
	call	_Con_Printf
	add	esp, 8
...
; 694  : 		hull_model_t *model = &world.hull_models[i];
	...
	imul	ecx, DWORD PTR _i$[ebp], 12
	add	ecx, DWORD PTR _world+2576
	mov	DWORD PTR _model$1[ebp], ecx
...
; 666  : 	world.hull_models = Mem_Calloc( loadmodel->mempool, sizeof( hull_model_t ) * loadmodel->numsubmodels );
	...
	push	666					; 0000029aH
	push	OFFSET $SG143748
	push	1
	mov	eax, DWORD PTR _loadmodel
	imul	ecx, DWORD PTR [eax+120], 12
	push	ecx
