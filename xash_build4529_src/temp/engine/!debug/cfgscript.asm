; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27045.0 
	...
	TITLE	C:\Users\USER\Documents\GitHub\XashTasks\xash_build4529_src\engine\common\cfgscript.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_cvartypes DD	00H
	...
	DD	FLAT:$SG129759
	DD	FLAT:$SG129760
$SG129757 DB	'BOOL', 00H
	ORG $+3
$SG129758 DB	'NUMBER', 00H
	ORG $+1
$SG129759 DB	'LIST', 00H
	ORG $+3
$SG129760 DB	'STRING', 00H
_DATA	ENDS
...
_DATA	SEGMENT
	ORG $+1
$SG129790 DB	'^1Error:^7 Syntax error in %s: got "%s" instead of "%s"', 0aH
	DB	00H
	ORG $+3
$SG129800 DB	'^1Error:^7 Cannot parse %s: Bad type %s', 0aH, 00H
	ORG $+3
$SG129812 DB	'{', 00H
	ORG $+2
$SG129814 DB	'{', 00H
...
$SG129830 DB	'}', 00H
	ORG $+2
$SG129832 DB	'SetInfo', 00H
$SG129834 DB	'}', 00H
	ORG $+2
$SG129840 DB	'VERSION', 00H
$SG129842 DB	'^1Error:^7 File %s has wrong version %s!', 0aH, 00H
	ORG $+2
$SG129844 DB	'DESCRIPTION', 00H
$SG129846 DB	'INFO_OPTIONS', 00H
	ORG $+3
$SG129847 DB	'SERVER_OPTIONS', 00H
	ORG $+1
$SG129848 DB	'^1Error:^7 DESCRIPTION must be INFO_OPTIONS or SERVER_OP'
	DB	'TIONS', 0aH, 00H
	ORG $+1
$SG129850 DB	'{', 00H
	ORG $+2
$SG129870 DB	'Reading config script file %s', 0aH, 00H
	ORG $+1
$SG129872 DB	'}', 00H
	ORG $+2
$SG129878 DB	'%s "%s"', 0aH, 00H
	ORG $+3
$SG129879 DB	'%s "%s"', 0aH, 00H
	ORG $+3
$SG129883 DB	'^1Error:^7 Got extra tokens!', 0aH, 00H
	ORG $+2
$SG129887 DB	'^1Error:^7 Parse error in %s, byte %d, token %s', 0aH, 00H
	ORG $+3
$SG129888 DB	'^1Error:^7 Parse error in %s, token %s', 0aH, 00H
$SG129909 DB	'}', 00H
	ORG $+2
$SG129890 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\cfgscript.c', 00H
	ORG $+2
$SG129907 DB	'Reading config script file %s', 0aH, 00H
	ORG $+1
$SG129915 DB	'^1Error:^7 Got extra tokens!', 0aH, 00H
	ORG $+2
$SG129919 DB	'^1Error:^7 Parse error in %s, byte %d, token %s', 0aH, 00H
	ORG $+3
$SG129920 DB	'^1Error:^7 Parse error in %s, token %s', 0aH, 00H
	ORG $+4
$SG129922 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\cfgscript.c', 00H
_DATA	ENDS
; Function compile flags: /Odtp
; File c:\users\user\documents\github\xashtasks\xash_build4529_src\engine\common\cfgscript.c
_TEXT	SEGMENT
tv160 = -4						; size = 4
_ps$ = 8						; size = 4
_CSCR_ParseHeader PROC
...
; 115  : 	switch( result->type )
	...
	jmp	DWORD PTR $LN21@CSCR_Parse[edx*4]
$LN8@CSCR_Parse:
...
; 84   : 		if( CSCR_ExpectString( ps, cvartypes[i], false, false ))
	...
	mov	edx, DWORD PTR _cvartypes[ecx*4]
	push	edx
	mov	eax, DWORD PTR _ps$[ebp]
	push	eax
	call	_CSCR_ExpectString
...
; File c:\users\user\documents\github\xashtasks\xash_build4529_src\engine\common\cfgscript.c
_TEXT	SEGMENT
_success$ = -1076					; size = 4
_length$ = -1072					; size = 4
_count$ = -1068						; size = 4
_cvar$1 = -1064						; size = 4
_start$ = -1060						; size = 4
_state$ = -1056						; size = 264
_var$2 = -792						; size = 788
__$ArrayPad$ = -4					; size = 4
_cfg$ = 8						; size = 4
_scriptfilename$ = 12					; size = 4
_CSCR_WriteGameCVars PROC
...
; 220  : 	state.filename = scriptfilename;
	...
	mov	DWORD PTR _state$[ebp+260], ecx
...
; 242  : 				if( var.flags & FCVAR_USERINFO )
	...
	mov	edx, DWORD PTR _var$2[ebp+780]
	and	edx, 2
...
; 244  : 				else FS_Printf( cfg, "%s \"%s\"\n", var.name, cvar->string );
	...
	mov	ecx, DWORD PTR _cvar$1[ebp]
	mov	edx, DWORD PTR [ecx+4]
	push	edx
	lea	eax, DWORD PTR _var$2[ebp]
	push	eax
	push	OFFSET $SG129879
...
; 263  : 		state.token[sizeof( state.token ) - 1] = 0;
	...
	mov	edx, 1
	imul	eax, edx, 255
	mov	BYTE PTR _state$[ebp+eax+4], 0
...
; 266  : 			Con_DPrintf( S_ERROR "Parse error in %s, byte %d, token %s\n", scriptfilename, (int)( state.buf - start ), state.token );
	...
	lea	ecx, DWORD PTR _state$[ebp+4]
	push	ecx
...
; 308  : 			Cvar_Get( var.name, var.value, var.flags|FCVAR_TEMPORARY, var.desc );
	...
	lea	edx, DWORD PTR _var$1[ebp+512]
	push	edx
	mov	eax, DWORD PTR _var$1[ebp+780]
	or	eax, 2097152				; 00200000H
	push	eax
	lea	ecx, DWORD PTR _var$1[ebp+256]
	push	ecx
	lea	edx, DWORD PTR _var$1[ebp]
	push	edx
	call	_Cvar_Get
...
; 326  : 			Con_DPrintf( S_ERROR "Parse error in %s, byte %d, token %s\n", scriptfilename, (int)( state.buf - start ), state.token );
	...
	lea	edx, DWORD PTR _state$[ebp+4]
	push	edx
