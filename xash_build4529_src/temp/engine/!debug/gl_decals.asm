; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27045.0 
	...
	TITLE	C:\Users\USER\Documents\GitHub\XashTasks\xash_build4529_src\engine\client\gl_decals.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	ENDS
_DATA	SEGMENT
$SG144140 DB	'R_DecalUnlink: bad decal list', 0aH, 00H
	ORG $+1
$SG144143 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\client\gl_decals.c', 00H
	ORG $+2
$SG144381 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\client\gl_decals.c', 00H
	ORG $+2
$SG144464 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\client\gl_decals.c', 00H
	ORG $+2
$SG144465 DB	'node != NULL', 00H
	ORG $+3
$SG144498 DB	'^1Error:^7 Decal has invalid texture!', 0aH, 00H
	ORG $+1
$SG144509 DB	'^1Error:^7 Decals must hit mod_brush!', 0aH, 00H
	ORG $+1
$SG144587 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\client\gl_decals.c', 00H
	ORG $+2
$SG144588 DB	'e != NULL', 00H
	ORG $+6
$SG144624 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\client\gl_decals.c', 00H
	ORG $+2
$SG144625 DB	'e != NULL', 00H
_DATA	ENDS
; Function compile flags: /Odtp
; File c:\users\user\documents\github\xashtasks\xash_build4529_src\engine\client\gl_decals.c
_TEXT	SEGMENT
_elem2$ = -8						; size = 4
_elem1$ = -4						; size = 4
_a$ = 8							; size = 4
_b$ = 12						; size = 4
_DecalDepthCompare PROC
...
; 1145 : 	elem2 = (const decallist_t *)b;
	...
	mov	DWORD PTR _elem2$[ebp], ecx

; 1146 : 
; 1147 : 	if( elem1->depth > elem2->depth )

	mov	edx, DWORD PTR _elem1$[ebp]
	movzx	eax, BYTE PTR [edx+78]
	mov	ecx, DWORD PTR _elem2$[ebp]
...
; 722  : 	splitplane = node->plane;
	...
	mov	DWORD PTR _splitplane$[ebp], eax
...
; 723  : 	dist = DotProduct( decalinfo->m_Position, splitplane->normal ) - splitplane->dist;
	...
	mulss	xmm1, DWORD PTR [esi+edx]
	addss	xmm0, xmm1
	mov	ecx, DWORD PTR _splitplane$[ebp]
...
_decal$ = -44						; size = 4
_tex$ = -40						; size = 4
_textureV$ = -36					; size = 16
_textureU$ = -20					; size = 16
__$ArrayPad$ = -4					; size = 4
_surf$ = 8						; size = 4
_decalinfo$ = 12					; size = 4
_R_DecalSurface PROC
...
; 639  : 	s = DotProduct( decalinfo->m_Position, textureU ) + textureU[3] - surf->texturemins[0];
	...
	mov	ecx, DWORD PTR _decalinfo$[ebp]
	movss	xmm0, DWORD PTR [ecx+eax]
	mulss	xmm0, DWORD PTR _textureU$[ebp+edx]
	mov	edx, 4
	shl	edx, 0
	mov	eax, 4
	shl	eax, 0
	...
	mulss	xmm1, DWORD PTR _textureU$[ebp+eax]
	addss	xmm0, xmm1
	mov	edx, 4
	shl	edx, 1
	mov	eax, 4
	...
	mov	edx, 4
	imul	eax, edx, 3
	addss	xmm0, DWORD PTR _textureU$[ebp+eax]
	mov	ecx, 2
	imul	edx, ecx, 0
	mov	eax, DWORD PTR _surf$[ebp]
...
; 640  : 	t = DotProduct( decalinfo->m_Position, textureV ) + textureV[3] - surf->texturemins[1];
	...
	mov	ecx, DWORD PTR _decalinfo$[ebp]
	movss	xmm0, DWORD PTR [ecx+eax]
	mulss	xmm0, DWORD PTR _textureV$[ebp+edx]
	mov	edx, 4
	shl	edx, 0
	mov	eax, 4
	shl	eax, 0
	mov	ecx, DWORD PTR _decalinfo$[ebp]
	movss	xmm1, DWORD PTR [ecx+edx]
	mulss	xmm1, DWORD PTR _textureV$[ebp+eax]
	addss	xmm0, xmm1
	mov	edx, 4
	shl	edx, 1
	mov	eax, 4
	...
	mov	edx, 4
	imul	eax, edx, 3
	addss	xmm0, DWORD PTR _textureV$[ebp+eax]
	mov	ecx, 2
	shl	ecx, 0
	mov	edx, DWORD PTR _surf$[ebp]
...
; 660  : 	w = fabs( decalinfo->m_decalWidth  * DotProduct( textureU, decalinfo->m_Basis[0] )) +
	...
	mov	edx, 4
	imul	edx, edx, 0
	movss	xmm1, DWORD PTR _textureU$[ebp+ecx]
	...
	mov	eax, 4
	shl	eax, 1
	movss	xmm2, DWORD PTR _textureU$[ebp+edx]
	mulss	xmm2, DWORD PTR [ecx+eax]
	addss	xmm1, xmm2
	mulss	xmm0, xmm1
	cvtss2sd xmm0, xmm0
	sub	esp, 8
	...
	mov	edx, 4
	shl	edx, 0
	movss	xmm3, DWORD PTR _textureU$[ebp+eax]
	mulss	xmm3, DWORD PTR [ecx+edx]
	addss	xmm2, xmm3
	mov	eax, 4
	shl	eax, 1
	mov	ecx, 12					; 0000000cH
...
; 602  : 	R_DecalVertsClip( pdecal, surf, decalinfo->m_iTexture, &vertCount );
	...
	lea	ecx, DWORD PTR _vertCount$[ebp]
	push	ecx
	mov	edx, DWORD PTR _decalinfo$[ebp]
...
; 523  : 	v = R_DecalSetupVerts( pdecal, surf, pdecal->texture, &lnumverts );
	...
	lea	edx, DWORD PTR _lnumverts$[ebp]
	push	edx
	mov	eax, DWORD PTR _pdecal$[ebp]
...
$LN4@R_DecalCre:
	mov	edx, DWORD PTR _i$[ebp]
	cmp	edx, DWORD PTR _lnumverts$[ebp]
	jge	$LN3@R_DecalCre
...
tv217 = -172						; size = 4
tv160 = -168						; size = 4
_vUnionMin$2 = -164					; size = 8
_vUnionMax$3 = -156					; size = 8
_vDecalMax$4 = -148					; size = 8
_vDecalMin$5 = -140					; size = 8
_lastArea$ = -132					; size = 4
tv558 = -128						; size = 4
tv548 = -124						; size = 4
tv538 = -120						; size = 4
tv528 = -116						; size = 4
_mapSize$ = -112					; size = 8
_plast$ = -104						; size = 4
_flArea$6 = -100					; size = 4
_texture$ = -96						; size = 4
_pDecal$ = -92						; size = 4
_testBasis$7 = -88					; size = 36
_decalExtents$ = -52					; size = 24
_testPosition$8 = -28					; size = 24
__$ArrayPad$ = -4					; size = 4
_decalinfo$ = 8						; size = 4
_surf$ = 12						; size = 4
_pcount$ = 16						; size = 4
_R_DecalIntersect PROC
...
; 460  : 			R_SetupDecalTextureSpaceBasis( pDecal, surf, texture, testBasis, testWorldScale );
	...
	lea	eax, DWORD PTR _testWorldScale$1[ebp]
	push	eax
	lea	ecx, DWORD PTR _testBasis$7[ebp]
	push	ecx
	mov	edx, DWORD PTR _texture$[ebp]
	push	edx
	mov	eax, DWORD PTR _surf$[ebp]
...
; 462  : 			VectorSubtract( decalinfo->m_Position, decalExtents[0], testPosition[0] );
	...
	mov	eax, 12					; 0000000cH
	imul	ecx, eax, 0
	lea	edx, DWORD PTR _testPosition$8[ebp+ecx]
	mov	eax, 4
	imul	ecx, eax, 0
	movss	DWORD PTR [edx+ecx], xmm0
	mov	edx, 4
	...
	mov	eax, 12					; 0000000cH
	imul	ecx, eax, 0
	lea	eax, DWORD PTR _decalExtents$[ebp+ecx]
	mov	ecx, 4
	shl	ecx, 0
	mov	esi, DWORD PTR _decalinfo$[ebp]
	movss	xmm0, DWORD PTR [esi+edx]
	...
	mov	edx, 12					; 0000000cH
	imul	eax, edx, 0
	lea	ecx, DWORD PTR _testPosition$8[ebp+eax]
	mov	edx, 4
	shl	edx, 0
	movss	DWORD PTR [ecx+edx], xmm0
	mov	eax, 4
...
; 468  : 			Vector2Set( vDecalMin,
	...
	mov	eax, 12					; 0000000cH
	imul	eax, eax, 0
	lea	eax, DWORD PTR _testBasis$7[ebp+eax]
	mov	esi, 4
	imul	esi, esi, 0
	...
	mov	ecx, 12					; 0000000cH
	imul	edx, ecx, 0
	lea	eax, DWORD PTR _testPosition$8[ebp+edx]
	mov	ecx, 4
	shl	ecx, 0
	mov	edx, 12					; 0000000cH
	imul	edx, edx, 0
	lea	edx, DWORD PTR _testBasis$7[ebp+edx]
	mov	esi, 4
	shl	esi, 0
	movss	xmm1, DWORD PTR [eax+ecx]
	...
	mov	ecx, 12					; 0000000cH
	imul	ecx, ecx, 0
	lea	ecx, DWORD PTR _testBasis$7[ebp+ecx]
	mov	esi, 4
	shl	esi, 1
	movss	xmm1, DWORD PTR [edx+eax]
...
; 475  : 			Vector2Set( vDecalMax,
	...
	movss	DWORD PTR _vDecalMax$4[ebp+eax], xmm0
...
; 481  : 			Vector2Set( vUnionMin, max( vDecalMin[0], 0 ), max( vDecalMin[1], 0 ));
	...
	mov	ecx, 4
	imul	edx, ecx, 0
	movss	xmm0, DWORD PTR _vDecalMin$5[ebp+edx]
...
$LN11@R_DecalInt:
	...
	movss	DWORD PTR _vUnionMin$2[ebp+eax], xmm0
	mov	ecx, 4
	shl	ecx, 0
	movss	xmm0, DWORD PTR _vDecalMin$5[ebp+ecx]
	comiss	xmm0, DWORD PTR __real@00000000
...
; 482  : 			Vector2Set( vUnionMax, min( vDecalMax[0], 1 ), min( vDecalMax[1], 1 ));
	...
	comiss	xmm0, DWORD PTR _vDecalMax$4[ebp+edx]
...
$LN15@R_DecalInt:
	...
	movss	DWORD PTR _vUnionMax$3[ebp+eax], xmm0
	mov	ecx, 4
	shl	ecx, 0
	movss	xmm0, DWORD PTR __real@3f800000
	...
	mov	edx, 4
	shl	edx, 0
	movss	xmm0, DWORD PTR _vDecalMax$4[ebp+edx]
...
; 484  : 			if( vUnionMin[0] < 1 && vUnionMin[1] < 1 && vUnionMax[0] > 0 && vUnionMax[1] > 0 )
	...
	imul	edx, ecx, 0
	movss	xmm0, DWORD PTR __real@3f800000
	comiss	xmm0, DWORD PTR _vUnionMin$2[ebp+edx]
	jbe	$LN7@R_DecalInt
	mov	eax, 4
	shl	eax, 0
	movss	xmm0, DWORD PTR __real@3f800000
	comiss	xmm0, DWORD PTR _vUnionMin$2[ebp+eax]
	jbe	$LN7@R_DecalInt
	mov	ecx, 4
	imul	edx, ecx, 0
	movss	xmm0, DWORD PTR _vUnionMax$3[ebp+edx]
	comiss	xmm0, DWORD PTR __real@00000000
	jbe	$LN7@R_DecalInt
	mov	eax, 4
	shl	eax, 0
	movss	xmm0, DWORD PTR _vUnionMax$3[ebp+eax]
	comiss	xmm0, DWORD PTR __real@00000000
	jbe	$LN7@R_DecalInt
...
; 487  : 				float	flArea = (vUnionMax[0] - vUnionMin[1]) * (vUnionMax[1] - vUnionMin[1]);
	...
	shl	eax, 0
	movss	xmm0, DWORD PTR _vUnionMax$3[ebp+edx]
	subss	xmm0, DWORD PTR _vUnionMin$2[ebp+eax]
	mov	ecx, 4
	shl	ecx, 0
	mov	edx, 4
	shl	edx, 0
	movss	xmm1, DWORD PTR _vUnionMax$3[ebp+ecx]
	subss	xmm1, DWORD PTR _vUnionMin$2[ebp+edx]
	mulss	xmm0, xmm1
	movss	DWORD PTR _flArea$6[ebp], xmm0

; 488  : 
; 489  : 				if( flArea > 0.6f )

	movss	xmm0, DWORD PTR _flArea$6[ebp]
...
; 493  : 					if( !plast || flArea <= lastArea ) 
	...
	comiss	xmm0, DWORD PTR _flArea$6[ebp]
...
$LN4@R_DecalVer:
	...
	cmp	ecx, DWORD PTR _vertCount$[ebp]
	jge	$LN3@R_DecalVer
...
; File c:\users\user\documents\github\xashtasks\xash_build4529_src\engine\client\gl_decals.c
_TEXT	SEGMENT
_decalWorldScale$ = -48					; size = 8
_textureSpaceBasis$ = -40				; size = 36
__$ArrayPad$ = -4					; size = 4
_pDecal$ = 8						; size = 4
_surf$ = 12						; size = 4
_texture$ = 16						; size = 4
_pVertCount$ = 20					; size = 4
_R_DecalVertsClip PROC
...
; 391  : 	return R_DoDecalSHClip( g_DecalClipVerts[0], pDecal, surf->polys->numverts, pVertCount );
	...
	mov	ecx, DWORD PTR _pVertCount$[ebp]
	push	ecx
	mov	edx, DWORD PTR _surf$[ebp]
	mov	eax, DWORD PTR [edx+36]
	mov	ecx, DWORD PTR [eax+8]
...
; 366  : 	outCount = SHClip( pInVerts, nStartVerts, g_DecalClipVerts2[0], LEFT_EDGE );
	...
	push	eax
	mov	ecx, DWORD PTR _nStartVerts$[ebp]
	push	ecx
	mov	edx, DWORD PTR _pInVerts$[ebp]
	push	edx
	call	_SHClip
	add	esp, 16					; 00000010H
...
; 369  : 	outCount = SHClip( g_DecalClipVerts2[0], outCount, pOutVerts, BOTTOM_EDGE );
	...
	push	3
	mov	ecx, DWORD PTR _pOutVerts$[ebp]
	push	ecx
	mov	edx, DWORD PTR _outCount$[ebp]
	push	edx
	mov	eax, 28					; 0000001cH
...
; 372  : 		*pVertCount = outCount;
	...
	mov	edx, DWORD PTR _pVertCount$[ebp]
...
$LN4@SHClip:
	mov	edx, DWORD PTR _j$[ebp]
	cmp	edx, DWORD PTR _vertCount$[ebp]
	jge	$LN3@SHClip
...
; 227  : 	pDecal->dx = DotProduct( pDecal->position, textureSpaceBasis[0] );
	...
	imul	ecx, ecx, 0
	mov	esi, DWORD PTR _pDecal$[ebp]
	movss	xmm0, DWORD PTR [esi+eax+28]
	mulss	xmm0, DWORD PTR [edx+ecx]
	mov	edx, 4
	shl	edx, 0
	mov	eax, 12					; 0000000cH
...
; 228  : 	pDecal->dy = DotProduct( pDecal->position, textureSpaceBasis[1] );
	...
	imul	ecx, ecx, 0
	mov	esi, DWORD PTR _pDecal$[ebp]
	movss	xmm0, DWORD PTR [esi+edx+28]
...
_verts$ = 20						; size = 4
_R_SetupDecalVertsForMSurface PROC
...
_textureSpaceBasis$ = 20				; size = 4
_decalWorldScale$ = 24					; size = 4
_R_SetupDecalTextureSpaceBasis PROC
...
; 197  : 	decalWorldScale[0] = (float)pDecal->scale / width;
	...
	mov	edx, 4
	imul	eax, edx, 0
	mov	ecx, DWORD PTR _decalWorldScale$[ebp]
...
; 123  : 			pdecal = &gDecalPool[gDecalCount]; // reuse next decal
	...
	imul	ecx, DWORD PTR _gDecalCount, 60
	add	ecx, OFFSET _gDecalPool
	mov	DWORD PTR _pdecal$[ebp], ecx

; 124  : 			gDecalCount++;

	mov	edx, DWORD PTR _gDecalCount
	add	edx, 1
	mov	DWORD PTR _gDecalCount, edx
...
; 80   : 			if( !tmp ) Host_Error( "R_DecalUnlink: bad decal list\n" );
...
; 786  : 	decalInfo.m_pModel = model;
	...
	mov	DWORD PTR _decalInfo$[ebp+12], ecx
...
; 801  : 			Matrix4x4_VectorITransform( matrix, pos, pos_l );
	...
	lea	edx, DWORD PTR _pos_l$2[ebp]
	push	edx
...
; 805  : 			VectorSubtract( pos, ent->origin, pos_l );
	...
	movss	xmm0, DWORD PTR [ecx+eax]
	subss	xmm0, DWORD PTR [esi+edx+2888]
	mov	edx, 4
	imul	eax, edx, 0
...
; 824  : 	decalInfo.m_iTexture = textureIndex;
	...
	mov	DWORD PTR _decalInfo$[ebp+16], ecx

; 825  : 	decalInfo.m_Entity = entityIndex;

	mov	edx, DWORD PTR _entityIndex$[ebp]
	mov	DWORD PTR _decalInfo$[ebp+28], edx
...
; 829  : 	decalInfo.m_Size = width >> 1;
	...
	mov	ecx, DWORD PTR _width$[ebp]
	sar	ecx, 1
	mov	DWORD PTR _decalInfo$[ebp+20], ecx

; 830  : 	if(( height >> 1 ) > decalInfo.m_Size )

	mov	edx, DWORD PTR _height$[ebp]
	sar	edx, 1
	cmp	edx, DWORD PTR _decalInfo$[ebp+20]
...
; 836  : 	decalInfo.m_decalWidth = width / decalInfo.m_scale;
	...
	cvttss2si ecx, xmm0
	mov	DWORD PTR _decalInfo$[ebp+36], ecx
...
; 837  : 	decalInfo.m_decalHeight = height / decalInfo.m_scale;
	...
	divss	xmm0, DWORD PTR _decalInfo$[ebp+32]
	cvttss2si edx, xmm0
	mov	DWORD PTR _decalInfo$[ebp+40], edx
...
; 1061 : 	if( gl_polyoffset->value )
	...
	mov	edx, DWORD PTR _gl_polyoffset
...
; 1069 : 		DrawSurfaceDecals( tr.draw_decals[i], false, false );
	...
	push	0
	mov	eax, DWORD PTR _i$[ebp]
	mov	ecx, DWORD PTR _tr[eax*4+50276]
	push	ecx
...
; 868  : 		v = g_DecalClipVerts[0];
	...
	imul	edx, ecx, 0
	add	edx, OFFSET _g_DecalClipVerts
	mov	DWORD PTR _v$[ebp], edx
...
tv430 = -4164						; size = 8
tv401 = -4156						; size = 8
_numVerts$1 = -4148					; size = 4
_o$2 = -4144						; size = 4
tv426 = -4140						; size = 4
tv397 = -4136						; size = 4
tv71 = -4132						; size = 4
_i$3 = -4128						; size = 4
_count$4 = -4124					; size = 4
_i$5 = -4120						; size = 4
_tex$6 = -4116						; size = 4
_e$ = -4112						; size = 4
_p$ = -4108						; size = 4
_v$7 = -4104						; size = 4
_list$8 = -4100						; size = 4096
__$ArrayPad$ = -4					; size = 4
_fa$ = 8						; size = 4
_single$ = 12						; size = 4
_reverse$ = 16						; size = 4
_DrawSurfaceDecals PROC
...
; 933  : 			pglPolygonOffset( -1.0f, -gl_polyoffset->value );
	...
	mov	ecx, DWORD PTR _gl_polyoffset
...
; 947  : 				o = R_DecalSetupVerts( p, fa, p->texture, &numVerts );
	...
	lea	eax, DWORD PTR _numVerts$1[ebp]
	push	eax
	mov	ecx, DWORD PTR _p$[ebp]
	movsx	edx, WORD PTR [ecx+20]
	push	edx
...
$LN7@DrawSurfac:
	...
	cmp	edx, DWORD PTR _numVerts$1[ebp]
	jge	$LN6@DrawSurfac
...
; 958  : 					v[5] = ( DotProduct( v, tex->vecs[0] ) + tex->vecs[0][3] ) / tex->texture->width;
	...
	mov	edx, 16					; 00000010H
	imul	eax, edx, 0
	add	eax, DWORD PTR _tex$6[ebp]
	mov	edx, 4
	imul	edx, edx, 0
	mov	esi, DWORD PTR _v$7[ebp]
	movss	xmm0, DWORD PTR [esi+ecx]
	mulss	xmm0, DWORD PTR [eax+edx]
	mov	eax, 4
	shl	eax, 0
	...
	cvtsi2sd xmm1, DWORD PTR tv397[ebp]
	mov	edx, DWORD PTR tv397[ebp]
	shr	edx, 31					; 0000001fH
	addsd	xmm1, QWORD PTR __xmm@41f00000000000000000000000000000[edx*8]
	movsd	QWORD PTR tv401[ebp], xmm1
	cvtsd2ss xmm1, QWORD PTR tv401[ebp]
	divss	xmm0, xmm1
	mov	eax, 4
	imul	ecx, eax, 5
...
; 959  : 					v[6] = ( DotProduct( v, tex->vecs[1] ) + tex->vecs[1][3] ) / tex->texture->height;
	...
	cvtsi2sd xmm1, DWORD PTR tv426[ebp]
	mov	ecx, DWORD PTR tv426[ebp]
	shr	ecx, 31					; 0000001fH
	addsd	xmm1, QWORD PTR __xmm@41f00000000000000000000000000000[ecx*8]
	movsd	QWORD PTR tv430[ebp], xmm1
	cvtsd2ss xmm1, QWORD PTR tv430[ebp]
	divss	xmm0, xmm1
	mov	edx, 4
	imul	eax, edx, 6
	mov	ecx, DWORD PTR _v$7[ebp]
...
$LN10@DrawSurfac:
	mov	eax, DWORD PTR _i$5[ebp]
	cmp	eax, DWORD PTR _numVerts$1[ebp]
...
$LN13@DrawSurfac:
	...
	cmp	DWORD PTR _count$4[ebp], 1024		; 00000400H
...
; 995  : 			if( p->texture ) list[count++] = p;
	...
	mov	ecx, DWORD PTR _p$[ebp]
	mov	DWORD PTR _list$8[ebp+eax*4], ecx
...
; 998  : 			DrawSingleDecal( list[i], fa );
	...
	mov	ecx, DWORD PTR _list$8[ebp+eax*4]
	push	ecx
...
$LN4@R_DecalRem:
	mov	ecx, DWORD PTR _i$[ebp]
	cmp	ecx, DWORD PTR _gDecalCount
...
; 1232 : 		if( !textureIndex || ( pdecal->texture == textureIndex ))
	...
	mov	edx, DWORD PTR _pdecal$[ebp]
	movsx	eax, WORD PTR [edx+20]
	cmp	eax, DWORD PTR _textureIndex$[ebp]
...
_TEXT	SEGMENT
_depth$ = -20						; size = 4
_pdecals$1 = -16					; size = 4
_i$ = -12						; size = 4
_decal$2 = -8						; size = 4
_total$ = -4						; size = 4
_pList$ = 8						; size = 4
_R_CreateDecalList PROC
...
; 1169 : 			decal_t	*decal = &gDecalPool[i];
	...
	imul	ecx, DWORD PTR _i$[ebp], 60
	add	ecx, OFFSET _gDecalPool
	mov	DWORD PTR _decal$2[ebp], ecx
...
; 1180 : 			while( pdecals && pdecals != decal )
	...
	mov	edx, DWORD PTR _pdecals$1[ebp]
	cmp	edx, DWORD PTR _decal$2[ebp]
	je	SHORT $LN6@R_CreateDe
...
; 1183 : 				pdecals = pdecals->pnext;
	...
	mov	ecx, DWORD PTR _pdecals$1[ebp]
	mov	edx, DWORD PTR [ecx]
