; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27045.0 
	...
	TITLE	C:\Users\USER\Documents\GitHub\XashTasks\xash_build4529_src\engine\client\cl_remap.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	ENDS
_DATA	SEGMENT
$SG143607 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\client\cl_remap.c', 00H
	ORG $+3
$SG143608 DB	'size != NULL', 00H
	ORG $+3
$SG143610 DB	'#raw_remap_image.mdl', 00H
	ORG $+3
$SG143635 DB	'#%i_%s', 00H
	ORG $+1
$SG143637 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\client\cl_remap.c', 00H
	ORG $+3
$SG143638 DB	'tx != NULL', 00H
	ORG $+1
$SG143667 DB	'#%s/%s.mdl', 00H
	ORG $+1
$SG143670 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\client\cl_remap.c', 00H
	ORG $+3
$SG143671 DB	'tx != NULL', 00H
	ORG $+1
$SG143673 DB	'^1Error:^7 Couldn''t update texture %s', 0aH, 00H
	ORG $+5
$SG143674 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\client\cl_remap.c', 00H
	ORG $+3
$SG143675 DB	'index == ptexture->index', 00H
	ORG $+3
$SG143695 DB	'%s:remap%i_%i', 00H
	ORG $+6
$SG143738 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\client\cl_remap.c', 00H
	ORG $+3
$SG143747 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\client\cl_remap.c', 00H
	ORG $+3
$SG143774 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\client\cl_remap.c', 00H
	ORG $+3
$SG143775 DB	'info != NULL', 00H
	ORG $+3
$SG143779 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\client\cl_remap.c', 00H
	ORG $+3
$SG143789 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\client\cl_remap.c', 00H
_DATA	ENDS
; Function compile flags: /Odtp
; File c:\users\user\documents\github\xashtasks\xash_build4529_src\engine\client\cl_remap.c
_TEXT	SEGMENT
_pic$ = -112						; size = 4
_tx$ = -108						; size = 4
_skin$ = -104						; size = 36
...
; 218  : 		skin.height = tx->height;
	...
	mov	WORD PTR _skin$[ebp+2], ax

; 219  : 		skin.depth = skin.numMips = 1;

	mov	BYTE PTR _skin$[ebp+18], 1
	movzx	cx, BYTE PTR _skin$[ebp+18]
	mov	WORD PTR _skin$[ebp+4], cx
...
; 220  : 		skin.size = tx->width * tx->height;
	...
	mov	DWORD PTR _skin$[ebp+32], ecx
...
; 225  : 		skin.palette = skin.buffer + skin.size;
	...
	mov	ecx, DWORD PTR _skin$[ebp+24]
	add	ecx, DWORD PTR _skin$[ebp+32]
	mov	DWORD PTR _skin$[ebp+20], ecx

; 226  : 		pic = FS_CopyImage( &skin ); // because GL_LoadTextureInternal will freed a rgbdata_t at end

	lea	edx, DWORD PTR _skin$[ebp]
	push	edx
	call	_FS_CopyImage
	add	esp, 4
...
_i$ = -1164						; size = 4
_tx$ = -1160						; size = 4
_paletteBackup$ = -1156					; size = 768
_texname$ = -388					; size = 128
_name$ = -260						; size = 128
_mdlname$ = -132					; size = 128
__$ArrayPad$ = -4					; size = 4
_ptexture$ = 8						; size = 4
_topcolor$ = 12						; size = 4
_bottomcolor$ = 16					; size = 4
_CL_UpdateStudioTexture PROC
...
$LN12@CL_UpdateS:
	push	0
	push	192					; 000000c0H
	push	OFFSET $SG143674
	push	OFFSET $SG143675
...
_i$ = -908						; size = 4
_tx$ = -904						; size = 4
_paletteBackup$ = -900					; size = 768
_texname$ = -132					; size = 128
__$ArrayPad$ = -4					; size = 4
_ptexture$ = 8						; size = 4
_topcolor$ = 12						; size = 4
_bottomcolor$ = 16					; size = 4
_CL_DuplicateTexture PROC
...
; 126  : 	memcpy( paletteBackup, pal, 768 );
	...
	mov	ecx, DWORD PTR _pal$[ebp]
	push	ecx
	lea	edx, DWORD PTR _paletteBackup$[ebp]
	push	edx
	call	_memcpy
	add	esp, 12					; 0000000cH
...
_topcolor$ = 16						; size = 4
_bottomcolor$ = 20					; size = 4
_CL_CreateRawTextureFromPixels PROC
...
; 79   : 	if( !pin.name[0] ) Q_strncpy( pin.name, "#raw_remap_image.mdl", sizeof( pin.name ));
	...
	mov	edx, 1
	imul	eax, edx, 0
	movsx	ecx, BYTE PTR ?pin@?1??CL_CreateRawTextureFromPixels@@9@9[eax]
	test	ecx, ecx
...
; 81   : 	pin.index = (int)(tx + 1); // pointer to pixels
	...
	mov	DWORD PTR ?pin@?1??CL_CreateRawTextureFromPixels@@9@9+76, edx
...
; 83   : 	pin.height = tx->height;
	...
	mov	DWORD PTR ?pin@?1??CL_CreateRawTextureFromPixels@@9@9+72, eax
...
$LN4@CL_ClearAl:
	mov	ecx, DWORD PTR _i$[ebp]
	cmp	ecx, DWORD PTR _clgame+1016
...
; 366  : 	if( info->topcolor == topcolor && info->bottomcolor == bottomcolor )
	...
	cmp	edx, DWORD PTR _topcolor$[ebp]
...
; 376  : 		else CL_UpdateAliasTexture( &info->textures[i], i, topcolor, bottomcolor );
	...
	mov	edx, DWORD PTR _bottomcolor$[ebp]
	push	edx
...
; 379  : 	info->topcolor = topcolor;
	...
	mov	edx, DWORD PTR _info$[ebp]
	mov	ax, WORD PTR _topcolor$[ebp]
	mov	WORD PTR [edx+70], ax

; 380  : 	info->bottomcolor = bottomcolor;

	mov	ecx, DWORD PTR _info$[ebp]
	mov	dx, WORD PTR _bottomcolor$[ebp]
...
; 300  : 		info->numtextures = phdr->numtextures;
	...
	mov	ecx, DWORD PTR _info$[ebp]
	mov	edx, DWORD PTR _phdr$[ebp]
	mov	ax, WORD PTR [edx+180]
	mov	WORD PTR [ecx+68], ax

; 301  : 		info->topcolor = topcolor;

	mov	ecx, DWORD PTR _info$[ebp]
	mov	dx, WORD PTR _topcolor$[ebp]
	mov	WORD PTR [ecx+70], dx
...
_TEXT	SEGMENT
_e$ = 8							; size = 4
_CL_GetRemapInfoForEntity PROC
