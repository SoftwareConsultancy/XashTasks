; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27045.0 
	...
	TITLE	C:\Users\USER\Downloads\xash_build4529_src\engine\client\cl_remap.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	ENDS
_DATA	SEGMENT
$SG143607 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\cl_remap.c', 00H
...
$SG143635 DB	'#%i_%s', 00H
	ORG $+5
$SG143637 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\cl_remap.c', 00H
$SG143638 DB	'tx != NULL', 00H
	ORG $+1
$SG143667 DB	'#%s/%s.mdl', 00H
	ORG $+5
$SG143670 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\cl_remap.c', 00H
$SG143671 DB	'tx != NULL', 00H
	ORG $+1
$SG143673 DB	'^1Error:^7 Couldn''t update texture %s', 0aH, 00H
	ORG $+1
$SG143674 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\cl_remap.c', 00H
$SG143675 DB	'index == ptexture->index', 00H
	ORG $+3
$SG143695 DB	'%s:remap%i_%i', 00H
	ORG $+2
$SG143738 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\cl_remap.c', 00H
	ORG $+4
$SG143747 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\cl_remap.c', 00H
	ORG $+4
$SG143774 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\cl_remap.c', 00H
$SG143775 DB	'info != NULL', 00H
	ORG $+7
$SG143779 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\cl_remap.c', 00H
	ORG $+4
$SG143789 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\cl_remap.c', 00H
_DATA	ENDS
; Function compile flags: /Odtp
; File c:\users\user\downloads\xash_build4529_src\engine\client\cl_remap.c
_TEXT	SEGMENT
_pic$ = -112						; size = 4
_tx$ = -108						; size = 4
_skin$ = -104						; size = 36
