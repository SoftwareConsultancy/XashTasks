; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27045.0 
	...
	TITLE	C:\Users\USER\Downloads\xash_build4529_src\engine\common\imagelib\img_quant.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
$SG130349 DB	'c:\users\user\downloads\xash_build4529_src\engine\common'
	DB	'\imagelib\img_quant.c', 00H
	ORG $+2
$SG130350 DB	'c:\users\user\downloads\xash_build4529_src\engine\common'
	DB	'\imagelib\img_quant.c', 00H
	ORG $+2
$SG130351 DB	'c:\users\user\downloads\xash_build4529_src\engine\common'
	DB	'\imagelib\img_quant.c', 00H
_DATA	ENDS
; Function compile flags: /Odtp
; File c:\users\user\downloads\xash_build4529_src\engine\common\imagelib\img_quant.c
_TEXT	SEGMENT
_lim$ = -52						; size = 4
_delta$ = -48						; size = 4
_samplepixels$ = -44					; size = 4
_r$ = -40						; size = 4
_g$ = -36						; size = 4
_b$ = -32						; size = 4
_step$ = -28						; size = 4
...
; 383  : 		step = prime1 * image.bpp;
	...
	imul	edx, DWORD PTR _image+36, 499
...
; 387  : 		step = prime2 * image.bpp;
	...
	imul	edx, DWORD PTR _image+36, 491
	mov	DWORD PTR _step$[ebp], edx
...
; 391  : 		step = prime3 * image.bpp;
	...
	imul	edx, DWORD PTR _image+36, 487
	mov	DWORD PTR _step$[ebp], edx
...
; 400  : 	while( i < samplepixels )
	...
	mov	ecx, DWORD PTR _i$[ebp]
	cmp	ecx, DWORD PTR _samplepixels$[ebp]
	jge	$LN1@learn
...
; File c:\users\user\downloads\xash_build4529_src\engine\common\imagelib\img_quant.c
_TEXT	SEGMENT
_bestbiaspos$ = -48					; size = 4
_betafreq$ = -44					; size = 4
_bestbiasd$ = -40					; size = 4
_biasdist$ = -36					; size = 4
_bestd$ = -32						; size = 4
_n$ = -28						; size = 4
_p$ = -24						; size = 4
...
; 259  : 	bestbiaspos = bestpos;
	...
	mov	ecx, DWORD PTR _bestpos$[ebp]
	mov	DWORD PTR _bestbiaspos$[ebp], ecx
...
; 281  : 		biasdist = dist - ((*p) >> (intbiasshift - netbiasshift));
	...
	mov	eax, DWORD PTR _dist$[ebp]
	sub	eax, edx
	mov	DWORD PTR _biasdist$[ebp], eax

; 282  : 
; 283  : 		if( biasdist < bestbiasd )

	mov	ecx, DWORD PTR _biasdist$[ebp]
	cmp	ecx, DWORD PTR _bestbiasd$[ebp]
	jge	SHORT $LN9@contest

; 284  : 		{
; 285  : 			bestbiasd = biasdist;

	mov	edx, DWORD PTR _biasdist$[ebp]
	mov	DWORD PTR _bestbiasd$[ebp], edx
...
; 289  : 		betafreq = (*f >> betashift);
	...
	mov	DWORD PTR _betafreq$[ebp], edx
...
; 291  : 		*p++ += (betafreq << gammashift);
	...
	mov	ecx, DWORD PTR _betafreq$[ebp]
...
; 294  : 	freq[bestpos] += beta;
	...
	mov	ecx, DWORD PTR _bestpos$[ebp]
	mov	DWORD PTR _freq[ecx*4], eax

; 295  : 	bias[bestpos] -= betagamma;

	mov	edx, DWORD PTR _bestpos$[ebp]
	mov	eax, DWORD PTR _bias[edx*4]
	sub	eax, 65536				; 00010000H
	mov	ecx, DWORD PTR _bestpos$[ebp]
	mov	DWORD PTR _bias[ecx*4], eax
...
; 118  : 		smallpos = i;
	...
	mov	edx, DWORD PTR _i$[ebp]
	mov	DWORD PTR _smallpos$[ebp], edx
...
; 129  : 				smallval = q[1];	// index on g
	...
	mov	eax, DWORD PTR [edx+ecx]
	mov	DWORD PTR _smallval$[ebp], eax
$LN14@inxbuild:
...
; 133  : 		q = network[smallpos];
	...
	mov	ecx, DWORD PTR _smallpos$[ebp]
	shl	ecx, 4
	add	ecx, OFFSET _network
...
; 136  : 		if( i != smallpos )
	...
	mov	edx, DWORD PTR _i$[ebp]
	cmp	edx, DWORD PTR _smallpos$[ebp]
	je	$LN15@inxbuild
...
; 145  : 		if( smallval != previouscol )
	...
	mov	ecx, DWORD PTR _smallval$[ebp]
	cmp	ecx, DWORD PTR _previouscol$[ebp]
...
; 147  : 			netindex[previouscol] = (startpos+i) >> 1;
	...
	mov	DWORD PTR _netindex[eax*4], edx
...
; 150  : 				netindex[j] = i;
	...
	mov	ecx, DWORD PTR _j$[ebp]
	mov	edx, DWORD PTR _i$[ebp]
	mov	DWORD PTR _netindex[ecx*4], edx
...
; 96   : 			temp = (network[i][j] + (1 << (netbiasshift - 1))) >> netbiasshift;
	...
	shl	edx, 4
	mov	eax, DWORD PTR _j$[ebp]
	mov	ecx, DWORD PTR _network[edx+eax*4]
	add	ecx, 8
	sar	ecx, 4
...
; 98   : 			network[i][j] = temp;
	...
	mov	DWORD PTR _network[edx+eax*4], ecx
...
; 101  : 		network[i][3] = i; // record colour num
	...
	imul	ecx, eax, 3
	mov	eax, DWORD PTR _i$[ebp]
	mov	DWORD PTR _network[edx+ecx], eax
...
; 73   : 	lengthcount = len;
	...
	mov	DWORD PTR _lengthcount, ecx

; 74   : 	samplefac = sample;

	mov	edx, DWORD PTR _sample$[ebp]
	mov	DWORD PTR _samplefac, edx
...
; 455  : 		pic->palette[i*3+2] = network[i][2];	// blue 
	...
	mov	esi, DWORD PTR _pic$[ebp]
	mov	esi, DWORD PTR [esi+20]
	mov	cl, BYTE PTR _network[ecx+edx]
