; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27045.0 
	...
	TITLE	C:\Users\USER\Documents\GitHub\XashTasks\xash_build4529_src\engine\common\filesystem.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	ENDS
_DATA	SEGMENT
$SG132780 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\filesystem.c', 00H
	ORG $+1
$SG132782 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\filesystem.c', 00H
	ORG $+1
$SG132792 DB	'.', 00H
	ORG $+2
$SG132793 DB	'..', 00H
	ORG $+1
$SG132795 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\filesystem.c', 00H
	ORG $+1
$SG132796 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\filesystem.c', 00H
	ORG $+1
$SG132836 DB	'*', 00H
	ORG $+2
$SG132856 DB	'^3Warning:^7 package %s contains the file %s several tim'
	DB	'es', 0aH, 00H
$SG132877 DB	'Current search path:', 0aH, 00H
	ORG $+2
$SG132880 DB	'%s (%i files)', 00H
	ORG $+2
$SG132883 DB	'%s (%i files)', 00H
	ORG $+2
$SG132884 DB	'%s', 00H
	ORG $+1
$SG132887 DB	' ^2gamedir^7', 0aH, 00H
	ORG $+2
$SG132888 DB	0aH, 00H
	ORG $+2
$SG132923 DB	'%s couldn''t open', 0aH, 00H
	ORG $+2
$SG132926 DB	'%s is not a packfile. Ignored.', 0aH, 00H
$SG132929 DB	'%s has an invalid directory size. Ignored.', 0aH, 00H
$SG132932 DB	'^1Error:^7 %s has too many files ( %i ). Ignored.', 0aH, 00H
	ORG $+1
$SG132935 DB	'%s has no files. Ignored.', 0aH, 00H
	ORG $+1
$SG132937 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\filesystem.c', 00H
	ORG $+1
$SG132939 DB	'%s is an incomplete PAK, not loading', 0aH, 00H
	ORG $+2
$SG132941 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\filesystem.c', 00H
	ORG $+1
$SG132942 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\filesystem.c', 00H
	ORG $+1
$SG132943 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\filesystem.c', 00H
	ORG $+1
$SG132945 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\filesystem.c', 00H
	ORG $+1
$SG132968 DB	'wad', 00H
$SG133003 DB	'pak', 00H
$SG132971 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\filesystem.c', 00H
	ORG $+1
$SG132972 DB	'Adding wadfile: %s (%i files)', 0aH, 00H
	ORG $+1
$SG132974 DB	'^1Error:^7 FS_AddWad_Fullpath: unable to load wad "%s"', 0aH
	DB	00H
$SG133006 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\filesystem.c', 00H
	ORG $+1
$SG133007 DB	'Adding pakfile: %s (%i files)', 0aH, 00H
	ORG $+1
$SG133009 DB	'wad', 00H
$SG133010 DB	'%s/%s', 00H
	ORG $+2
$SG133012 DB	'^1Error:^7 FS_AddPak_Fullpath: unable to load pak "%s"', 0aH
	DB	00H
$SG133034 DB	'pak', 00H
$SG133035 DB	'%s%s', 00H
	ORG $+3
...
$SG133038 DB	'%s%s', 00H
	ORG $+3
$SG133046 DB	'%s/', 00H
$SG133039 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\filesystem.c', 00H
	ORG $+1
$SG133059 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\filesystem.c', 00H
	ORG $+1
$SG133060 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\filesystem.c', 00H
	ORG $+1
$SG133062 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\filesystem.c', 00H
	ORG $+1
$SG133072 DB	':', 00H
	ORG $+2
...
$SG133080 DB	'/.', 00H
	ORG $+1
$SG133083 DB	'FS_Rescan( %s )', 0aH, 00H
	ORG $+3
$SG133088 DB	'%s.rc', 00H
	ORG $+2
$SG133106 DB	'w', 00H
	ORG $+2
$SG133108 DB	'FS_WriteGameInfo: can''t write %s', 0aH, 00H
	ORG $+2
$SG133109 DB	'// generated by Xash3D', 0aH, 0aH, 0aH, 00H
	ORG $+2
$SG133111 DB	'basedir', 09H, 09H, '"%s"', 0aH, 00H
	ORG $+1
$SG133113 DB	'gamedir', 09H, 09H, '"%s"', 0aH, 00H
	ORG $+1
$SG133115 DB	'fallback_dir', 09H, '"%s"', 0aH, 00H
	ORG $+1
$SG133117 DB	'title', 09H, 09H, '"%s"', 0aH, 00H
	ORG $+3
$SG133119 DB	'startmap', 09H, 09H, '"%s"', 0aH, 00H
$SG133121 DB	'trainmap', 09H, 09H, '"%s"', 0aH, 00H
$SG133123 DB	'version', 09H, 09H, '%g', 0aH, 00H
	ORG $+3
$SG133125 DB	'size', 09H, 09H, '%i', 0aH, 00H
	ORG $+2
$SG133127 DB	'url_info', 09H, 09H, '"%s"', 0aH, 00H
$SG133129 DB	'url_update', 09H, 09H, '"%s"', 0aH, 00H
	ORG $+2
$SG133131 DB	'type', 09H, 09H, '"%s"', 0aH, 00H
$SG133133 DB	'date', 09H, 09H, '"%s"', 0aH, 00H
$SG133135 DB	'dllpath', 09H, 09H, '"%s"', 0aH, 00H
	ORG $+1
$SG133137 DB	'gamedll', 09H, 09H, '"%s"', 0aH, 00H
	ORG $+1
$SG133139 DB	'icon', 09H, 09H, '"%s"', 0aH, 00H
$SG133141 DB	'gamemode', 09H, 09H, '"singleplayer_only"', 0aH, 00H
	ORG $+1
$SG133143 DB	'gamemode', 09H, 09H, '"multiplayer_only"', 0aH, 00H
	ORG $+2
$SG133145 DB	'sp_entity', 09H, 09H, '"%s"', 0aH, 00H
	ORG $+3
$SG133147 DB	'mp_entity', 09H, 09H, '"%s"', 0aH, 00H
	ORG $+3
$SG133149 DB	'mp_filter', 09H, 09H, '"%s"', 0aH, 00H
	ORG $+3
$SG133151 DB	'secure', 09H, 09H, '"%i"', 0aH, 00H
	ORG $+2
$SG133153 DB	'nomodels', 09H, 09H, '"%i"', 0aH, 00H
$SG133155 DB	'max_edicts', 09H, '%i', 0aH, 00H
	ORG $+1
$SG133157 DB	'max_tempents', 09H, '%i', 0aH, 00H
	ORG $+3
$SG133159 DB	'max_beams', 09H, 09H, '%i', 0aH, 00H
	ORG $+1
$SG133161 DB	'max_particles', 09H, '%i', 0aH, 00H
	ORG $+2
$SG133164 DB	0aH, 00H
	ORG $+2
$SG133165 DB	'ambient%i', 09H, 09H, '%s', 0aH, 00H
	ORG $+1
$SG133166 DB	0aH, 0aH, 0aH, 00H
$SG133172 DB	'New Game', 00H
	ORG $+3
$SG133173 DB	'info_player_start', 00H
	ORG $+2
$SG133174 DB	'info_player_deathmatch', 00H
	ORG $+1
$SG133175 DB	'cl_dlls', 00H
$SG133176 DB	'dlls/hl.dll', 00H
$SG133177 DB	'newmap', 00H
	ORG $+1
$SG133178 DB	'game.ico', 00H
	ORG $+3
$SG133196 DB	'New Game', 00H
	ORG $+3
$SG133197 DB	'info_player_start', 00H
	ORG $+2
$SG133198 DB	'info_player_deathmatch', 00H
	ORG $+1
$SG133199 DB	'dlls/hl.dll', 00H
$SG133200 DB	'newmap', 00H
	ORG $+1
$SG133201 DB	'cl_dlls', 00H
$SG133202 DB	'game.ico', 00H
	ORG $+3
$SG133204 DB	'game', 00H
	ORG $+3
$SG133206 DB	'gamedir', 00H
$SG133209 DB	'fallback_dir', 00H
	ORG $+3
$SG133212 DB	'startmap', 00H
	ORG $+3
$SG133216 DB	'trainmap', 00H
	ORG $+3
$SG133217 DB	'trainingmap', 00H
$SG133220 DB	'url_info', 00H
	ORG $+3
$SG133223 DB	'url_dl', 00H
	ORG $+1
$SG133226 DB	'gamedll', 00H
$SG133229 DB	'icon', 00H
	ORG $+3
$SG133230 DB	'.ico', 00H
	ORG $+3
$SG133233 DB	'type', 00H
	ORG $+3
$SG133236 DB	'singleplayer_only', 00H
	ORG $+2
$SG133237 DB	'Single', 00H
	ORG $+1
$SG133240 DB	'multiplayer_only', 00H
	ORG $+3
$SG133241 DB	'Multiplayer', 00H
$SG133244 DB	'version', 00H
$SG133247 DB	'size', 00H
	ORG $+3
$SG133250 DB	'edicts', 00H
	ORG $+1
$SG133253 DB	'mpentity', 00H
	ORG $+3
$SG133256 DB	'mpfilter', 00H
	ORG $+3
$SG133259 DB	'secure', 00H
	ORG $+1
$SG133261 DB	'nomodels', 00H
	ORG $+3
$SG133263 DB	'%s\%s', 00H
	ORG $+2
$SG133265 DB	'%s\%s', 00H
	ORG $+2
$SG133277 DB	'Convert %s to %s', 0aH, 00H
	ORG $+2
$SG133266 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\filesystem.c', 00H
	ORG $+1
$SG133297 DB	'New Game', 00H
	ORG $+3
$SG133298 DB	'info_player_start', 00H
	ORG $+2
$SG133299 DB	'info_player_deathmatch', 00H
	ORG $+1
$SG133300 DB	'cl_dlls', 00H
$SG133301 DB	'dlls/hl.dll', 00H
$SG133303 DB	'game.ico', 00H
	ORG $+3
$SG133306 DB	'basedir', 00H
$SG133311 DB	'fallback_dir', 00H
	ORG $+3
$SG133316 DB	'gamedir', 00H
$SG133321 DB	'title', 00H
	ORG $+2
$SG133324 DB	'sp_entity', 00H
	ORG $+2
$SG133327 DB	'mp_entity', 00H
	ORG $+2
$SG133330 DB	'mp_filter', 00H
	ORG $+2
$SG133333 DB	'gamedll', 00H
$SG133336 DB	'dllpath', 00H
$SG133339 DB	'startmap', 00H
	ORG $+3
$SG133342 DB	'trainmap', 00H
	ORG $+3
$SG133345 DB	'icon', 00H
	ORG $+3
$SG133346 DB	'.ico', 00H
	ORG $+3
$SG133349 DB	'url_info', 00H
	ORG $+3
$SG133352 DB	'url_update', 00H
	ORG $+1
$SG133355 DB	'date', 00H
	ORG $+3
$SG133358 DB	'type', 00H
	ORG $+3
$SG133361 DB	'version', 00H
$SG133364 DB	'size', 00H
	ORG $+3
$SG133367 DB	'max_edicts', 00H
	ORG $+1
$SG133370 DB	'max_tempents', 00H
	ORG $+3
$SG133373 DB	'max_beams', 00H
	ORG $+2
$SG133376 DB	'max_particles', 00H
	ORG $+2
$SG133379 DB	'gamemode', 00H
	ORG $+3
$SG133382 DB	'singleplayer_only', 00H
	ORG $+2
$SG133384 DB	'multiplayer_only', 00H
	ORG $+3
$SG133387 DB	'secure', 00H
	ORG $+1
$SG133390 DB	'nomodels', 00H
	ORG $+3
$SG133393 DB	'noskills', 00H
	ORG $+3
$SG133395 DB	'ambient', 00H
$SG133399 DB	'%s\%s', 00H
	ORG $+2
$SG133401 DB	'%s\%s', 00H
	ORG $+2
$SG133403 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\filesystem.c', 00H
	ORG $+1
$SG133409 DB	'%s/config.cfg', 00H
	ORG $+2
$SG133411 DB	'%s/progs.dat', 00H
	ORG $+3
$SG133413 DB	'%s/pak0.pak', 00H
$SG133424 DB	'%s/gameinfo.txt', 00H
$SG133425 DB	'%s/gameinfo.txt', 00H
$SG133426 DB	'%s/liblist.gam', 00H
	ORG $+1
$SG133432 DB	'Convert %s to %s', 0aH, 00H
	ORG $+2
$SG133444 DB	'FS_LoadGameInfo( %s )', 0aH, 00H
	ORG $+1
$SG133447 DB	'Couldn''t find game directory ''%s''', 0aH, 00H
	ORG $+1
$SG133463 DB	'rescan filesystem search pathes', 00H
$SG133464 DB	'fs_rescan', 00H
	ORG $+2
$SG133465 DB	'show filesystem search pathes', 00H
	ORG $+2
$SG133466 DB	'fs_path', 00H
$SG133467 DB	'clear filesystem search pathes', 00H
	ORG $+1
$SG133468 DB	'fs_clearpaths', 00H
	ORG $+2
$SG133469 DB	'./', 00H
	ORG $+1
$SG133471 DB	'-game', 00H
	ORG $+2
$SG133473 DB	'invalid base directory "%s"', 0aH, 00H
	ORG $+3
$SG133475 DB	'^1Error:^7 invalid game directory "%s"', 0aH, 00H
$SG133479 DB	'^1Error:^7 game directory "%s" not exist', 0aH, 00H
	ORG $+2
$SG133481 DB	'./', 00H
	ORG $+1
$SG133484 DB	'..', 00H
	ORG $+1
$SG133486 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\filesystem.c', 00H
	ORG $+1
$SG133488 DB	'FS_Init: done', 0aH, 00H
	ORG $+1
$SG133500 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\filesystem.c', 00H
	ORG $+1
$SG133501 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\filesystem.c', 00H
	ORG $+1
$SG133535 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\filesystem.c', 00H
	ORG $+1
$SG133537 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\filesystem.c', 00H
	ORG $+1
$SG133554 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\filesystem.c', 00H
	ORG $+1
$SG133612 DB	'.wad', 00H
	ORG $+3
...
$SG133670 DB	'%s/%s', 00H
	ORG $+2
$SG133676 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\filesystem.c', 00H
	ORG $+1
$SG133755 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\filesystem.c', 00H
	ORG $+1
$SG133757 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\filesystem.c', 00H
	ORG $+1
$SG133758 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\filesystem.c', 00H
	ORG $+1
$SG133827 DB	'rb', 00H
	ORG $+1
$SG133840 DB	'wb', 00H
	ORG $+1
$SG133830 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\filesystem.c', 00H
	ORG $+1
$SG133842 DB	'^1Error:^7 FS_WriteFile: failed on %s', 0aH, 00H
	ORG $+1
$SG133861 DB	'%s%s', 00H
	ORG $+3
$SG133868 DB	'rb', 00H
	ORG $+1
$SG133891 DB	'..\valve\', 00H
	ORG $+2
$SG133892 DB	'../valve/', 00H
	ORG $+2
$SG133895 DB	'.dll', 00H
	ORG $+3
$SG133909 DB	'rb', 00H
	ORG $+1
$SG133898 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\filesystem.c', 00H
	ORG $+1
$SG133901 DB	'%s%s', 00H
	ORG $+3
...
$SG133949 DB	'%s%s', 00H
	ORG $+3
$SG133963 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\filesystem.c', 00H
	ORG $+1
$SG133967 DB	'^1Error:^7 FS_FileCopy: unexpected end of input file (%d'
	DB	' < %d)', 0aH, 00H
$SG133968 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\filesystem.c', 00H
	ORG $+1
$SG134054 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\filesystem.c', 00H
	ORG $+1
$SG134069 DB	'.wad', 00H
	ORG $+3
...
$SG134082 DB	'%s%s', 00H
	ORG $+3
$SG134093 DB	'FileSystem Pool', 00H
$SG134112 DB	'*', 00H
	ORG $+2
$SG134087 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\filesystem.c', 00H
	ORG $+1
$SG134088 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\filesystem.c', 00H
	ORG $+1
$SG134092 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\filesystem.c', 00H
	ORG $+1
$SG134174 DB	'^3Warning:^7 Wad %s contains the file %s several times', 0aH
	DB	00H
$SG134196 DB	'^1Error:^7 W_ReadLump: %s is corrupted', 0aH, 00H
$SG134197 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\filesystem.c', 00H
	ORG $+1
$SG134199 DB	'^3Warning:^7 W_ReadLump: %s is probably corrupted', 0aH, 00H
	ORG $+1
$SG134235 DB	'rb', 00H
	ORG $+1
$SG134200 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\filesystem.c', 00H
	ORG $+1
$SG134232 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\filesystem.c', 00H
	ORG $+1
$SG134236 DB	'rb', 00H
	ORG $+1
$SG134238 DB	'^1Error:^7 W_Open: couldn''t open %s', 0aH, 00H
	ORG $+3
$SG134242 DB	'^1Error:^7 W_Open: %s can''t read header', 0aH, 00H
	ORG $+3
$SG134240 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\filesystem.c', 00H
	ORG $+1
$SG134245 DB	'^1Error:^7 W_Open: %s is not a WAD2 or WAD3 file', 0aH, 00H
	ORG $+2
$SG134249 DB	'^3Warning:^7 W_Open: %s is full (%i lumps)', 0aH, 00H
$SG134253 DB	'^1Error:^7 W_Open: %s has no lumps', 0aH, 00H
$SG134257 DB	'^1Error:^7 W_Open: %s can''t find lump allocation table', 0aH
	DB	00H
$SG134267 DB	'conchars', 00H
	ORG $+3
$SG134259 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\filesystem.c', 00H
	ORG $+1
$SG134261 DB	'^1Error:^7 W_ReadLumpTable: %s has corrupted lump alloca'
	DB	'tion table', 0aH, 00H
	ORG $+4
$SG134263 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\filesystem.c', 00H
	ORG $+1
$SG134264 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\filesystem.c', 00H
	ORG $+1
$SG134268 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\filesystem.c', 00H
	ORG $+1
$SG134274 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\filesystem.c', 00H
	ORG $+1
$SG134276 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\filesystem.c', 00H
_DATA	ENDS
; Function compile flags: /Odtp
; File c:\users\user\documents\github\xashtasks\xash_build4529_src\engine\common\filesystem.c
_TEXT	SEGMENT
_size$ = -12						; size = 4
_buf$ = -8						; size = 4
_oldpos$ = -4						; size = 4
...
; 2911 : 			if( wad->lumps[middle].type < newlump->type )
	...
	movsx	edx, BYTE PTR [ecx+edx+12]
	mov	eax, DWORD PTR _newlump$[ebp]
...
; File c:\users\user\documents\github\xashtasks\xash_build4529_src\engine\common\filesystem.c
_TEXT	SEGMENT
_pack_ind$ = -1036					; size = 4
_search$ = -1032					; size = 4
_path$1 = -1028						; size = 1024
__$ArrayPad$ = -4					; size = 4
_filename$ = 8						; size = 4
_mode$ = 12						; size = 4
_gamedironly$ = 16					; size = 4
_FS_OpenReadFile PROC
...
; 1796 : 		return FS_OpenPackedFile( search->pack, pack_ind );
	...
	mov	ecx, DWORD PTR _pack_ind$[ebp]
	push	ecx
...
; File c:\users\user\documents\github\xashtasks\xash_build4529_src\engine\common\filesystem.c
_TEXT	SEGMENT
_dup_handle$ = -12					; size = 4
_pfile$ = -8						; size = 4
_file$ = -4						; size = 4
_pack$ = 8						; size = 4
_pack_ind$ = 12						; size = 4
_FS_OpenPackedFile PROC
...
$LN4@FS_SysOpen:
	...
	add	ecx, 1
	mov	DWORD PTR _ind$[ebp], ecx
$LN6@FS_SysOpen:
	mov	edx, DWORD PTR _mode$[ebp]
	add	edx, DWORD PTR _ind$[ebp]
...
_liblist_path$ = -516					; size = 256
_gameinfo_path$ = -260					; size = 256
__$ArrayPad$ = -4					; size = 4
_gamedir$ = 8						; size = 4
_GameInfo$ = 12						; size = 4
_FS_ParseGameInfo PROC
...
; 1306 : 	if( FS_FileTime( liblist_path, false ) > FS_FileTime( gameinfo_path, false ))
	...
	push	0
	lea	edx, DWORD PTR _liblist_path$[ebp]
	push	edx
	call	_FS_FileTime
	add	esp, 8
	mov	esi, eax
...
; 1312 : 		memset( &tmpGameInfo, 0, sizeof( tmpGameInfo ));
	...
	push	1672					; 00000688H
	push	0
	lea	ecx, DWORD PTR _tmpGameInfo$[ebp]
	push	ecx
	call	_memset
	add	esp, 12					; 0000000cH
...
; 1314 : 		if( FS_ReadGameInfo( default_gameinfo_path, gamedir, &tmpGameInfo ))
	...
	lea	edx, DWORD PTR _tmpGameInfo$[ebp]
	push	edx
	mov	eax, DWORD PTR _gamedir$[ebp]
	push	eax
...
; 1318 : 			Q_strncpy( tmpGameInfo.gamedir, gamedir, sizeof( tmpGameInfo.gamedir ));
	...
	mov	ecx, DWORD PTR _gamedir$[ebp]
	push	ecx
	lea	edx, DWORD PTR _tmpGameInfo$[ebp+128]
	push	edx
	call	_Q_strncpy
	add	esp, 12					; 0000000cH
...
tv380 = -1480						; size = 4
_afile$ = -1476						; size = 4
_ambientNum$1 = -1472					; size = 4
_pfile$ = -1468						; size = 4
_fs_path$ = -1464					; size = 256
_token$ = -1208						; size = 1204
__$ArrayPad$ = -4					; size = 4
_filepath$ = 8						; size = 4
_gamedir$ = 12						; size = 4
_GameInfo$ = 16						; size = 4
_FS_ReadGameInfo PROC
...
; 1098 : 	GameInfo->max_tents = 500;
	...
	mov	ecx, DWORD PTR _GameInfo$[ebp]
	mov	DWORD PTR [ecx+1660], 500		; 000001f4H

; 1099 : 	GameInfo->max_beams = 128;

	mov	edx, DWORD PTR _GameInfo$[ebp]
	mov	DWORD PTR [edx+1664], 128		; 00000080H
...
; 1248 : 			pfile = COM_ParseFile( pfile, GameInfo->ambientsound[ambientNum] );
	...
	mov	ecx, DWORD PTR _ambientNum$1[ebp]
	shl	ecx, 6
	mov	edx, DWORD PTR _GameInfo$[ebp]
	lea	eax, DWORD PTR [edx+ecx+1400]
	push	eax
	mov	ecx, DWORD PTR _pfile$[ebp]
	push	ecx
	call	_COM_ParseFile
...
; 1074 : 	if( FS_ParseLiblistGam( liblist_path, gamedir, &GameInfo ))
	...
	lea	ecx, DWORD PTR _GameInfo$[ebp]
	push	ecx
	mov	edx, DWORD PTR _gamedir$[ebp]
	push	edx
	mov	eax, DWORD PTR _liblist_path$[ebp]
	push	eax
...
; 934  : 	GameInfo->max_edicts = 900;	// default value if not specified
	...
	mov	ecx, DWORD PTR _GameInfo$[ebp]
	mov	DWORD PTR [ecx+1656], 900		; 00000384H

; 935  : 	GameInfo->max_tents = 500;

	mov	edx, DWORD PTR _GameInfo$[ebp]
	mov	DWORD PTR [edx+1660], 500		; 000001f4H
...
; 937  : 	GameInfo->max_particles = 4096;
	...
	mov	ecx, DWORD PTR _GameInfo$[ebp]
	mov	DWORD PTR [ecx+1668], 4096		; 00001000H
...
__$ArrayPad$ = -4					; size = 4
_filename$ = 8						; size = 4
_FS_CreateDefaultGameInfo PROC
...
; 903  : 	defGI.falldir[0] = '\0';
	...
	mov	ecx, 1
	imul	edx, ecx, 0
	mov	BYTE PTR _defGI$[ebp+edx+192], 0

; 904  : 
; 905  : 	Q_strncpy( defGI.title, "New Game", sizeof( defGI.title ));

	push	64					; 00000040H
	push	OFFSET $SG133172
...
; 906  : 	Q_strncpy( defGI.gamedir, fs_gamedir, sizeof( defGI.gamedir ));
	...
	push	64					; 00000040H
	push	OFFSET _fs_gamedir
	lea	ecx, DWORD PTR _defGI$[ebp+128]
	push	ecx
	call	_Q_strncpy
	add	esp, 12					; 0000000cH
...
; 907  : 	Q_strncpy( defGI.basedir, fs_basedir, sizeof( defGI.basedir ));
	...
	push	64					; 00000040H
	push	OFFSET _fs_basedir
	lea	edx, DWORD PTR _defGI$[ebp+64]
	push	edx
	call	_Q_strncpy
	add	esp, 12					; 0000000cH
...
; 909  : 	Q_strncpy( defGI.mp_entity, "info_player_deathmatch", sizeof( defGI.mp_entity ));
	...
	push	32					; 00000020H
	push	OFFSET $SG133174
	lea	ecx, DWORD PTR _defGI$[ebp+1336]
	push	ecx
	call	_Q_strncpy
	add	esp, 12					; 0000000cH
...
; 910  : 	Q_strncpy( defGI.dll_path, "cl_dlls", sizeof( defGI.dll_path ));
	...
	push	64					; 00000040H
	push	OFFSET $SG133175
	lea	edx, DWORD PTR _defGI$[ebp+452]
	push	edx
	call	_Q_strncpy
	add	esp, 12					; 0000000cH
...
; 912  : 	Q_strncpy( defGI.startmap, "newmap", sizeof( defGI.startmap ));
	...
	push	64					; 00000040H
	push	OFFSET $SG133177
	lea	ecx, DWORD PTR _defGI$[ebp+256]
	push	ecx
	call	_Q_strncpy
	add	esp, 12					; 0000000cH
...
; 913  : 	Q_strncpy( defGI.iconpath, "game.ico", sizeof( defGI.iconpath ));
	...
	push	64					; 00000040H
	push	OFFSET $SG133178
	lea	edx, DWORD PTR _defGI$[ebp+580]
	push	edx
	call	_Q_strncpy
	add	esp, 12					; 0000000cH
...
; File c:\users\user\documents\github\xashtasks\xash_build4529_src\engine\common\filesystem.c
_TEXT	SEGMENT
_write_ambients$ = -16					; size = 4
tv223 = -12						; size = 4
_i$ = -8						; size = 4
_f$ = -4						; size = 4
_filepath$ = 8						; size = 4
_GameInfo$ = 12						; size = 4
_FS_WriteGameInfo PROC
...
; 816  : 		FS_Printf( f, "version\t\t%g\n", GameInfo->version );
	...
	mov	ecx, DWORD PTR _GameInfo$[ebp]
	cvtss2sd xmm0, DWORD PTR [ecx+448]
	sub	esp, 8
	movsd	QWORD PTR [esp], xmm0
	push	OFFSET $SG133123
	mov	edx, DWORD PTR _f$[ebp]
	push	edx
	call	_FS_Printf
	add	esp, 16					; 00000010H
...
; 828  : 		FS_Printf( f, "type\t\t\"%s\"\n", GameInfo->type );
	...
	mov	edx, DWORD PTR _GameInfo$[ebp]
	add	edx, 1156				; 00000484H
	push	edx
	push	OFFSET $SG133131
	mov	eax, DWORD PTR _f$[ebp]
	push	eax
	call	_FS_Printf
	add	esp, 12					; 0000000cH
...
_TEXT	SEGMENT
_ext$ = -280						; size = 4
_errorcode$ = -276					; size = 4
_i$ = -272						; size = 4
_pak$ = -268						; size = 4
_search$ = -264						; size = 4
_fullpath$1 = -260					; size = 256
__$ArrayPad$ = -4					; size = 4
_pakfile$ = 8						; size = 4
_already_loaded$ = 12					; size = 4
_flags$ = 16						; size = 4
_FS_AddPak_Fullpath PROC
...
; 557  : 			if( already_loaded ) *already_loaded = true;
	...
	mov	edx, DWORD PTR _already_loaded$[ebp]
	mov	DWORD PTR [edx], 1
$LN9@FS_AddPak_:
...
; 574  : 		search->next = fs_searchpaths;
	...
	mov	ecx, DWORD PTR _search$[ebp]
	mov	edx, DWORD PTR _fs_searchpaths
...
; 585  : 				Q_sprintf( fullpath, "%s/%s", pakfile, pak->files[i].name );
	...
	push	ecx
	push	OFFSET $SG133010
	lea	edx, DWORD PTR _fullpath$1[ebp]
	push	edx
	call	_Q_sprintf
	add	esp, 16					; 00000010H
...
; 425  : 		Con_Reportf( "%s is not a packfile. Ignored.\n", packfile );
	...
	mov	edx, DWORD PTR _packfile$[ebp]
	push	edx
	push	OFFSET $SG132926
	call	_Con_Reportf
	add	esp, 8
...
; 439  : 	numpackfiles = header.dirlen / sizeof( dpackfile_t );
	...
	shr	edx, 6
	mov	DWORD PTR _numpackfiles$[ebp], edx
...
; 469  : 	pack = (pack_t *)Mem_Calloc( fs_mempool, sizeof( pack_t ));
	...
	push	469					; 000001d5H
	push	OFFSET $SG132942
	push	1
	push	280					; 00000118H
	mov	eax, DWORD PTR _fs_mempool
	push	eax
	call	__Mem_Alloc
	add	esp, 20					; 00000014H
...
; 272  : 	stringlistappend( list, n_file.name );
	...
	lea	edx, DWORD PTR _n_file$[ebp+36]
	push	edx
...
; 156  : 				if( matchpattern( str, cmp, caseinsensitive ))
	...
	mov	ecx, DWORD PTR _caseinsensitive$[ebp]
	push	ecx
	mov	edx, DWORD PTR _cmp$[ebp]
	push	edx
	mov	eax, DWORD PTR _str$[ebp]
...
; 2834 : 	if( lumptype == TYP_NONE || lumptype == TYP_ANY )
	...
	movsx	ecx, BYTE PTR _lumptype$[ebp]
	cmp	ecx, -1
...
; 3033 : 	lumpcount = header.numlumps;
	...
	mov	DWORD PTR _lumpcount$[ebp], edx
...
; 3059 : 	lat_size = lumpcount * sizeof( dlumpinfo_t );
	...
	mov	ecx, DWORD PTR _lumpcount$[ebp]
	shl	ecx, 5
	mov	DWORD PTR _lat_size$[ebp], ecx
...
; 3062 : 	srclumps = (dlumpinfo_t *)Mem_Malloc( wad->mempool, lat_size );
	...
	push	3062					; 00000bf6H
	push	OFFSET $SG134259
	push	0
	mov	edx, DWORD PTR _lat_size$[ebp]
	push	edx
	mov	eax, DWORD PTR _wad$[ebp]
	mov	ecx, DWORD PTR [eax+260]
	push	ecx
...
; 3064 : 	if( FS_Read( wad->handle, srclumps, lat_size ) != lat_size )
	...
	mov	edx, DWORD PTR _lat_size$[ebp]
	push	edx
	mov	eax, DWORD PTR _srclumps$[ebp]
	push	eax
	mov	ecx, DWORD PTR _wad$[ebp]
	mov	edx, DWORD PTR [ecx+268]
	push	edx
...
$LN4@W_Open:
	mov	ecx, DWORD PTR _i$[ebp]
	cmp	ecx, DWORD PTR _lumpcount$[ebp]
	jge	$LN3@W_Open
...
; 3092 : 			srclumps[i].type = TYP_GFXPIC; 
	...
	shl	edx, 5
	mov	eax, DWORD PTR _srclumps$[ebp]
	mov	BYTE PTR [eax+edx+12], 66		; 00000042H
$LN25@W_Open:
...
; 3094 : 		W_AddFileToWad( name, wad, &srclumps[i] );
	...
	mov	ecx, DWORD PTR _i$[ebp]
	shl	ecx, 5
	add	ecx, DWORD PTR _srclumps$[ebp]
	push	ecx
	mov	edx, DWORD PTR _wad$[ebp]
	push	edx
	lea	eax, DWORD PTR _name$2[ebp]
...
; 3142 : 		return W_ReadLump( search->wad, &search->wad->lumps[index], lumpsizeptr ); 
	...
	mov	ecx, DWORD PTR _lumpsizeptr$[ebp]
	push	ecx
	mov	edx, DWORD PTR _search$[ebp]
	mov	eax, DWORD PTR [edx+260]
	mov	ecx, DWORD PTR _index$[ebp]
	shl	ecx, 5
	add	ecx, DWORD PTR [eax+272]
	push	ecx
	mov	edx, DWORD PTR _search$[ebp]
	mov	eax, DWORD PTR [edx+260]
	push	eax
...
; 2870 : 			if(( matchtype == TYP_ANY ) || ( matchtype == wad->lumps[middle].type ))
	...
	movsx	edx, BYTE PTR _matchtype$[ebp]
	mov	eax, DWORD PTR _middle$2[ebp]
	shl	eax, 5
	mov	ecx, DWORD PTR _wad$[ebp]
	mov	ecx, DWORD PTR [ecx+272]
	movsx	eax, BYTE PTR [ecx+eax+12]
	cmp	edx, eax
...
_end$6 = -2848						; size = 4
_left$7 = -2844						; size = 4
_right$8 = -2840					; size = 4
_middle$9 = -2836					; size = 4
_pEnvPath$ = -2832					; size = 4
_type$10 = -2825					; size = 1
_search$ = -2824					; size = 4
_netpath$11 = -2820					; size = 1024
_netpath$12 = -1796					; size = 1024
_wadfolder$13 = -772					; size = 256
_shortname$14 = -516					; size = 256
_wadname$15 = -260					; size = 256
__$ArrayPad$ = -4					; size = 4
_name$ = 8						; size = 4
_index$ = 12						; size = 4
_gamedironly$ = 16					; size = 4
...
; 1650 : 			pak = search->pack;
	...
	mov	ecx, DWORD PTR _search$[ebp]
	mov	edx, DWORD PTR [ecx+256]
	mov	DWORD PTR _pak$5[ebp], edx

; 1651 : 
; 1652 : 			// look for the file (binary search)
; 1653 : 			left = 0;

	mov	DWORD PTR _left$7[ebp], 0

; 1654 : 			right = pak->numfiles - 1;

	mov	eax, DWORD PTR _pak$5[ebp]
	mov	ecx, DWORD PTR [eax+260]
	sub	ecx, 1
	mov	DWORD PTR _right$8[ebp], ecx
$LN5@FS_FindFil:

; 1655 : 			while( left <= right )

	mov	edx, DWORD PTR _left$7[ebp]
	cmp	edx, DWORD PTR _right$8[ebp]
	jg	$LN6@FS_FindFil
...
; 1659 : 				middle = (left + right) / 2;
	...
	mov	eax, DWORD PTR _left$7[ebp]
	add	eax, DWORD PTR _right$8[ebp]
	cdq
	sub	eax, edx
	sar	eax, 1
	mov	DWORD PTR _middle$9[ebp], eax
...
; 1660 : 				diff = Q_stricmp( pak->files[middle].name, name );
	...
	mov	eax, DWORD PTR _name$[ebp]
	push	eax
	mov	ecx, DWORD PTR _middle$9[ebp]
	shl	ecx, 6
	mov	edx, DWORD PTR _pak$5[ebp]
	mov	eax, DWORD PTR [edx+272]
	add	eax, ecx
	push	eax
	call	_Q_strnicmp
...
; 1665 : 					if( index ) *index = middle;
	...
	mov	ecx, DWORD PTR _index$[ebp]
	mov	edx, DWORD PTR _middle$9[ebp]
...
; 1671 : 					right = middle - 1;
	...
	mov	eax, DWORD PTR _middle$9[ebp]
	sub	eax, 1
	mov	DWORD PTR _right$8[ebp], eax
...
; 1678 : 			char		type = W_TypeFromExt( name );
	...
	call	_W_TypeFromExt
	add	esp, 4
	mov	BYTE PTR _type$10[ebp], al

; 1679 : 			qboolean		anywadname = true;

	mov	DWORD PTR _anywadname$2[ebp], 1
...
; 1684 : 			if( type == TYP_NONE ) continue;
	...
	movsx	ecx, BYTE PTR _type$10[ebp]
	test	ecx, ecx
...
; 1685 : 			COM_ExtractFilePath( name, wadname );
	...
	lea	edx, DWORD PTR _wadname$15[ebp]
	push	edx
	mov	eax, DWORD PTR _name$[ebp]
	push	eax
...
$LN36@FS_FindFil:
	...
	mov	BYTE PTR _wadfolder$13[ebp+eax], 0

; 1687 : 
; 1688 : 			if( Q_strlen( wadname ))

	lea	ecx, DWORD PTR _wadname$15[ebp]
	push	ecx
	call	_Q_strlen
	add	esp, 4
	test	eax, eax
...
; 1690 : 				COM_FileBase( wadname, wadname );
	...
	lea	edx, DWORD PTR _wadname$15[ebp]
	push	edx
	lea	eax, DWORD PTR _wadname$15[ebp]
	push	eax
	call	_COM_FileBase
	add	esp, 8
...
; 1691 : 				Q_strncpy( wadfolder, wadname, sizeof( wadfolder ));
	...
	lea	ecx, DWORD PTR _wadname$15[ebp]
	push	ecx
	lea	edx, DWORD PTR _wadfolder$13[ebp]
	push	edx
	call	_Q_strncpy
	add	esp, 12					; 0000000cH
...
; 1693 : 				anywadname = false;
	...
	mov	DWORD PTR _anywadname$2[ebp], 0
$LN19@FS_FindFil:
...
; 1697 : 			COM_FileBase( search->wad->filename, shortname );
	...
	lea	ecx, DWORD PTR _shortname$14[ebp]
	push	ecx
	mov	edx, DWORD PTR _search$[ebp]
	mov	eax, DWORD PTR [edx+260]
	push	eax
...
; 1701 : 			if( !anywadname && Q_stricmp( wadname, shortname ))
	...
	cmp	DWORD PTR _anywadname$2[ebp], 0
	jne	SHORT $LN20@FS_FindFil
	push	99999					; 0001869fH
	lea	edx, DWORD PTR _shortname$14[ebp]
	push	edx
	lea	eax, DWORD PTR _wadname$15[ebp]
	push	eax
	call	_Q_strnicmp
...
; 1708 : 			lump = W_FindLump( search->wad, shortname, type );
	...
	movzx	eax, BYTE PTR _type$10[ebp]
	push	eax
	lea	ecx, DWORD PTR _shortname$14[ebp]
	push	ecx
	mov	edx, DWORD PTR _search$[ebp]
	...
	call	_W_FindLump
	add	esp, 12					; 0000000cH
	mov	DWORD PTR _lump$1[ebp], eax

; 1709 : 
; 1710 : 			if( lump )

	cmp	DWORD PTR _lump$1[ebp], 0
...
; 1721 : 			Q_sprintf( netpath, "%s%s", search->filename, name );
	...
	mov	eax, DWORD PTR _search$[ebp]
	push	eax
	push	OFFSET $SG133617
	lea	ecx, DWORD PTR _netpath$11[ebp]
	push	ecx
	call	_Q_sprintf
	add	esp, 16					; 00000010H
...
; 1723 : 			if( FS_SysFileExists( netpath ))
	...
	lea	edx, DWORD PTR _netpath$11[ebp]
	push	edx
...
; 1742 : 		Q_snprintf( netpath, MAX_SYSPATH, "%s%s", search->filename, name );
	...
	mov	edx, DWORD PTR _search$[ebp]
	push	edx
	push	OFFSET $SG133623
	push	1024					; 00000400H
	lea	eax, DWORD PTR _netpath$12[ebp]
	push	eax
	call	_Q_snprintf
	add	esp, 20					; 00000014H
...
; 1744 : 		if( FS_SysFileExists( netpath ))
	...
	lea	ecx, DWORD PTR _netpath$12[ebp]
	push	ecx
	call	_FS_SysFileExists
	add	esp, 4
	test	eax, eax
...
; 1756 : 			Q_strncpy( search->filename, pEnvPath, (end - pEnvPath) + 1 );
	...
	sub	ecx, DWORD PTR _pEnvPath$[ebp]
	add	ecx, 1
	push	ecx
	mov	edx, DWORD PTR _pEnvPath$[ebp]
	push	edx
	mov	eax, DWORD PTR _search$[ebp]
	push	eax
	call	_Q_strncpy
...
; 1760 : 			if( FS_SysFileExists( netpath ))
	...
	lea	edx, DWORD PTR _netpath$12[ebp]
	push	edx
	call	_FS_SysFileExists
	add	esp, 4
	test	eax, eax
...
; 2775 : 	fs_mempool = Mem_AllocPool( "FileSystem Pool" );	
	...
	push	2775					; 00000ad7H
	push	OFFSET $SG134092
	push	OFFSET $SG134093
	call	__Mem_AllocPool
	add	esp, 12					; 0000000cH
...
; 2350 : 	fs_ext_path = directpath;
	...
	mov	ecx, DWORD PTR _directpath$[ebp]
	mov	DWORD PTR _fs_ext_path, ecx
...
; 2359 : 		if( dllname[i+start] == '\\' ) dllpath[i] = '/';
	...
	mov	ecx, DWORD PTR _i$[ebp]
	mov	BYTE PTR _dllpath$[ebp+ecx], 47		; 0000002fH
...
; 2360 : 		else dllpath[i] = Q_tolower( dllname[i+start] );
	...
	add	esp, 4
	mov	edx, DWORD PTR _i$[ebp]
	mov	BYTE PTR _dllpath$[ebp+edx], al
$LN9@FS_FindLib:
...
; 2517 : 	iRet = remove( real_path );
	...
	lea	edx, DWORD PTR _real_path$[ebp]
	push	edx
...
; 2540 : 		if(( readSize = FS_Read( pInput, buf, size )) < size )
	...
	mov	edx, DWORD PTR _readSize$[ebp]
...
_iRet$ = -2060						; size = 4
tv86 = -2056						; size = 4
_oldpath$ = -2052					; size = 1024
_newpath$ = -1028					; size = 1024
__$ArrayPad$ = -4					; size = 4
_oldname$ = 8						; size = 4
_newname$ = 12						; size = 4
_FS_Rename PROC
...
; 2489 : 	Q_snprintf( oldpath, sizeof( oldpath ), "%s%s", fs_writedir, oldname );
	...
	push	ecx
	push	OFFSET _fs_writedir
	push	OFFSET $SG133940
	push	1024					; 00000400H
	lea	edx, DWORD PTR _oldpath$[ebp]
	push	edx
	call	_Q_snprintf
	add	esp, 20					; 00000014H
...
; 2040 : 		buff_size *= 2;
	...
	mov	edx, DWORD PTR _buff_size$[ebp]
	shl	edx, 1
	mov	DWORD PTR _buff_size$[ebp], edx
...
$LN15@FS_Read:
	mov	ecx, DWORD PTR _done$[ebp]
	add	ecx, DWORD PTR tv79[ebp]
	mov	DWORD PTR _done$[ebp], ecx
...
; 1829 : 		filepath++;
	...
	mov	edx, DWORD PTR _filepath$[ebp]
	add	edx, 1
	mov	DWORD PTR _filepath$[ebp], edx
$LN2@FS_Open:
...
; File c:\users\user\documents\github\xashtasks\xash_build4529_src\engine\common\filesystem.c
_TEXT	SEGMENT
_dirlist$ = -1652					; size = 12
_textlen$1 = -1640					; size = 4
_anywadname$2 = -1636					; size = 4
$T3 = -1632						; size = 4
_pak$ = -1628						; size = 4
tv130 = -1624						; size = 4
tv94 = -1620						; size = 4
tv92 = -1616						; size = 4
_dirlistindex$ = -1612					; size = 4
_wad$ = -1608						; size = 4
_basepathlength$ = -1604				; size = 4
_basepath$ = -1600					; size = 4
_resultlist$ = -1596					; size = 12
_numchars$ = -1584					; size = 4
_numfiles$ = -1580					; size = 4
_colon$ = -1576						; size = 4
_backslash$ = -1572					; size = 4
_slash$ = -1568						; size = 4
_search$ = -1564					; size = 4
_searchpath$ = -1560					; size = 4
_i$ = -1556						; size = 4
_type$4 = -1549						; size = 1
_separator$ = -1548					; size = 4
_resultlistindex$ = -1544				; size = 4
_netpath$ = -1540					; size = 256
_wadpattern$5 = -1284					; size = 256
_wadfolder$6 = -1028					; size = 256
_temp2$7 = -772						; size = 256
_wadname$8 = -516					; size = 256
_temp$ = -260						; size = 256
__$ArrayPad$ = -4					; size = 4
_pattern$ = 8						; size = 4
...
; 2581 : 	stringlistinit( &dirlist );
	...
	lea	edx, DWORD PTR _dirlist$[ebp]
	push	edx
	call	_stringlistinit
	add	esp, 4
...
$LN65@FS_Search:
	...
	mov	DWORD PTR _separator$[ebp], ecx
...
; 2587 : 	basepathlength = separator ? (separator + 1 - pattern) : 0;
	...
	mov	edx, DWORD PTR _separator$[ebp]
	add	edx, 1
	sub	edx, DWORD PTR _pattern$[ebp]
...
$LN67@FS_Search:
	...
	mov	DWORD PTR _basepathlength$[ebp], eax

; 2588 : 	basepath = Mem_Calloc( fs_mempool, basepathlength + 1 );

	push	2588					; 00000a1cH
	push	OFFSET $SG134054
	push	1
...
$LN2@FS_Search:
	mov	edx, DWORD PTR _searchpath$[ebp]
	mov	eax, DWORD PTR [edx+268]
...
; 2606 : 				while( temp[0] )
	...
	mov	ecx, 1
	imul	edx, ecx, 0
	movsx	eax, BYTE PTR _temp$[ebp+edx]
	test	eax, eax
	je	$LN9@FS_Search
...
$LN12@FS_Search:
	...
	cmp	ecx, DWORD PTR _resultlist$[ebp+4]
...
; 2617 : 							stringlistappend( &resultlist, temp );
	...
	push	ecx
	lea	edx, DWORD PTR _resultlist$[ebp]
	push	edx
	call	_stringlistappend
	add	esp, 8
$LN39@FS_Search:
...
; 2626 : 					if( separator < slash )
	...
	mov	ecx, DWORD PTR _separator$[ebp]
	cmp	ecx, DWORD PTR _slash$[ebp]
	jae	SHORT $LN42@FS_Search

; 2627 : 						separator = slash;

	mov	edx, DWORD PTR _slash$[ebp]
...
; 2629 : 						separator = backslash;
	...
	mov	ecx, DWORD PTR _backslash$[ebp]
	mov	DWORD PTR _separator$[ebp], ecx
$LN43@FS_Search:
...
; 2644 : 			if( type == TYP_NONE ) continue;
	...
	movsx	ecx, BYTE PTR _type$4[ebp]
	test	ecx, ecx
...
; 2645 : 			COM_ExtractFilePath( pattern, wadname );
	...
	lea	edx, DWORD PTR _wadname$8[ebp]
	push	edx
	mov	eax, DWORD PTR _pattern$[ebp]
	push	eax
	call	_COM_ExtractFilePath
...
; 2646 : 			COM_FileBase( pattern, wadpattern );
	...
	lea	ecx, DWORD PTR _wadpattern$5[ebp]
	push	ecx
	mov	edx, DWORD PTR _pattern$[ebp]
	push	edx
	call	_COM_FileBase
...
; 2649 : 			if( Q_strlen( wadname ))
	...
	lea	eax, DWORD PTR _wadname$8[ebp]
	push	eax
	call	_Q_strlen
	add	esp, 4
	test	eax, eax
...
; 2651 : 				COM_FileBase( wadname, wadname );
	...
	lea	ecx, DWORD PTR _wadname$8[ebp]
	push	ecx
	lea	edx, DWORD PTR _wadname$8[ebp]
	push	edx
	call	_COM_FileBase
...
; 2658 : 			COM_FileBase( searchpath->wad->filename, temp2 );
	...
	lea	eax, DWORD PTR _temp2$7[ebp]
	push	eax
	mov	ecx, DWORD PTR _searchpath$[ebp]
	mov	edx, DWORD PTR [ecx+260]
	push	edx
...
; 2662 : 			if( !anywadname && Q_stricmp( wadname, temp2 ))
	...
	push	99999					; 0001869fH
	lea	ecx, DWORD PTR _temp2$7[ebp]
	push	ecx
	lea	edx, DWORD PTR _wadname$8[ebp]
	push	edx
	call	_Q_strnicmp
...
; 2671 : 				if( type != TYP_ANY && wad->lumps[i].type != type )
	...
	movsx	edx, BYTE PTR _type$4[ebp]
	cmp	edx, -1
...
; 2690 : 							Q_snprintf( temp2, sizeof(temp2), "%s/%s", wadfolder, temp );
	...
	lea	ecx, DWORD PTR _temp$[ebp]
	push	ecx
	lea	edx, DWORD PTR _wadfolder$6[ebp]
	push	edx
	push	OFFSET $SG134076
	push	256					; 00000100H
	lea	eax, DWORD PTR _temp2$7[ebp]
	push	eax
	call	_Q_snprintf
...
; 2691 : 							COM_DefaultExtension( temp2, va(".%s", W_ExtFromType( wad->lumps[i].type )));
	...
	add	esp, 8
	push	eax
	lea	edx, DWORD PTR _temp2$7[ebp]
	push	edx
	call	_COM_DefaultExtension
	add	esp, 8
...
$LN21@FS_Search:
	mov	ecx, DWORD PTR _dirlistindex$[ebp]
	add	ecx, 1
	mov	DWORD PTR _dirlistindex$[ebp], ecx
$LN23@FS_Search:
	mov	edx, DWORD PTR _dirlistindex$[ebp]
	cmp	edx, DWORD PTR _dirlist$[ebp+4]
	jge	$LN22@FS_Search
...
$LN24@FS_Search:
	mov	ecx, DWORD PTR _resultlistindex$[ebp]
	add	ecx, 1
	mov	DWORD PTR _resultlistindex$[ebp], ecx
$LN26@FS_Search:
	mov	edx, DWORD PTR _resultlistindex$[ebp]
	cmp	edx, DWORD PTR _resultlist$[ebp+4]
...
; 2761 : 			numfiles++;
	...
	mov	edx, DWORD PTR _numfiles$[ebp]
	add	edx, 1
	mov	DWORD PTR _numfiles$[ebp], edx

; 2762 : 			numchars += (int)textlen;

	mov	eax, DWORD PTR _numchars$[ebp]
	add	eax, DWORD PTR _textlen$1[ebp]
...
; 2232 : 		*filesizeptr = filesize;
	...
	mov	edx, DWORD PTR _filesizeptr$[ebp]
...
_search$ = -268						; size = 4
_i$ = -264						; size = 4
_fullpath$ = -260					; size = 256
__$ArrayPad$ = -4					; size = 4
_dir$ = 8						; size = 4
_flags$ = 12						; size = 4
_FS_AddGameDirectory PROC
...
; 625  : 		if( !Q_stricmp( COM_FileExtension( list.strings[i] ), "pak" ))
	...
	push	99999					; 0001869fH
	push	OFFSET $SG133034
	mov	edx, DWORD PTR _i$[ebp]
	mov	eax, DWORD PTR _list$[ebp+8]
...
; 697  : 		if( search->wad )
	...
	mov	edx, DWORD PTR _search$1[ebp]
	cmp	DWORD PTR [edx+260], 0
...
; 1461 : 		if( SI.games[i] ) Mem_Free( SI.games[i] );
	...
	mov	edx, DWORD PTR _i$[ebp]
	cmp	DWORD PTR _SI[edx*4+772], 0
	je	SHORT $LN5@FS_Shutdow
	push	1461					; 000005b5H
	push	OFFSET $SG133500
	mov	eax, DWORD PTR _i$[ebp]
	mov	ecx, DWORD PTR _SI[eax*4+772]
	push	ecx
	call	__Mem_Free
...
_TEXT	SEGMENT
_dirs$ = -24						; size = 12
_hasBaseDir$ = -12					; size = 4
_hasGameDir$ = -8					; size = 4
_i$ = -4						; size = 4
_FS_Init PROC
...
; 1383 : 	Cmd_AddCommand( "fs_rescan", FS_Rescan_f, "rescan filesystem search pathes" );
	...
	push	OFFSET $SG133463
	push	OFFSET _FS_Rescan_f
	push	OFFSET $SG133464
...
; 1435 : 			SI.games[SI.numgames] = (gameinfo_t *)Mem_Calloc( fs_mempool, sizeof( gameinfo_t ));
	...
	add	esp, 20					; 00000014H
	mov	ecx, DWORD PTR _SI+2820
	mov	DWORD PTR _SI[ecx*4+772], eax
$LN17@FS_Init:
