; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27045.0 
	...
	TITLE	C:\Users\USER\Documents\GitHub\XashTasks\xash_build4529_src\engine\common\imagelib\img_utils.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_img_emboss DD	0bf333333r			; -0.7
	...
	DD	03f333333r			; 0.7
	ORG $+4
$SG137338 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\imagelib\img_utils.c', 00H
	ORG $+1
$SG137339 DB	'ImageLib Pool', 00H
	ORG $+2
$SG137345 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\imagelib\img_utils.c', 00H
	ORG $+1
$SG137346 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\imagelib\img_utils.c', 00H
	ORG $+1
$SG137351 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\imagelib\img_utils.c', 00H
	ORG $+1
$SG137378 DB	'^1Error:^7 Image: (%s) dims out of range [%dx%d]', 0aH, 00H
	ORG $+6
$SG137430 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\imagelib\img_utils.c', 00H
	ORG $+1
$SG137431 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\imagelib\img_utils.c', 00H
	ORG $+1
$SG137435 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\imagelib\img_utils.c', 00H
	ORG $+1
$SG137440 DB	'gfx/palette.lmp', 00H
$SG137443 DB	'custom quake palette detected', 0aH, 00H
	ORG $+1
$SG137689 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\imagelib\img_utils.c', 00H
	ORG $+1
$SG137700 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\imagelib\img_utils.c', 00H
	ORG $+1
$SG137791 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\imagelib\img_utils.c', 00H
	ORG $+1
$SG137802 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\imagelib\img_utils.c', 00H
	ORG $+1
$SG137888 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\imagelib\img_utils.c', 00H
	ORG $+1
$SG137890 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\imagelib\img_utils.c', 00H
	ORG $+1
...
$SG137949 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\imagelib\img_utils.c', 00H
	ORG $+1
$SG137978 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\imagelib\img_utils.c', 00H
	ORG $+1
$SG137980 DB	'^1Error:^7 Image_MakeLuma: unsupported format %s', 0aH, 00H
	ORG $+6
$SG137995 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\imagelib\img_utils.c', 00H
	ORG $+1
$SG138021 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\imagelib\img_utils.c', 00H
	ORG $+1
$SG138041 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\imagelib\img_utils.c', 00H
	ORG $+1
$SG138043 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\imagelib\img_utils.c', 00H
	ORG $+1
$SG138122 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\imagelib\img_utils.c', 00H
	ORG $+1
$SG138155 DB	'Image_Resample: from[%d x %d] to [%d x %d]', 0aH, 00H
	ORG $+4
$SG138156 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\imagelib\img_utils.c', 00H
_DATA	ENDS
; Function compile flags: /Odtp
; File c:\users\user\documents\github\xashtasks\xash_build4529_src\engine\common\imagelib\img_utils.c
_TEXT	SEGMENT
_src$1 = -92						; size = 4
_size$ = -88						; size = 4
tv277 = -84						; size = 4
