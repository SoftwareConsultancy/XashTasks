; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27045.0 
	...
	TITLE	C:\Users\USER\Downloads\xash_build4529_src\engine\client\cl_custom.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
$SG138585 DB	'Null resource passed to CL_MoveToOnHandList', 0aH, 00H
	ORG $+7
$SG138595 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\cl_custom.c', 00H
_DATA	ENDS
; Function compile flags: /Odtp
; File c:\users\user\downloads\xash_build4529_src\engine\client\cl_custom.c
_TEXT	SEGMENT
_n$ = -8						; size = 4
_p$ = -4						; size = 4
_pList$ = 8						; size = 4
