; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27045.0 
	...
	TITLE	C:\Users\USER\Documents\GitHub\XashTasks\xash_build4529_src\engine\common\world.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
PUBLIC	_et_name
_DATA	SEGMENT
$SG134091 DB	'normal', 00H
	ORG $+1
$SG134092 DB	'player', 00H
	ORG $+1
$SG134093 DB	'tempentity', 00H
	ORG $+1
$SG134094 DB	'beam', 00H
	ORG $+3
$SG134095 DB	'fragmented', 00H
	ORG $+1
_et_name DD	FLAT:$SG134091
	DD	FLAT:$SG134092
	DD	FLAT:$SG134093
	DD	FLAT:$SG134094
	DD	FLAT:$SG134095
...
; File c:\users\user\documents\github\xashtasks\xash_build4529_src\engine\common\world.c
_TEXT	SEGMENT
tv64 = -4						; size = 4
_contents$ = 8						; size = 4
_RankForContents PROC
...
; 144  : 		p2[0] = DotProduct( p1, itransform[0] );
	...
	imul	edx, ecx, 0
	lea	ecx, DWORD PTR _itransform$[ebp+edx]
	mov	edx, 4
	imul	edx, edx, 0
...
; 145  : 		p2[1] = DotProduct( p1, itransform[1] );
	...
	mov	eax, 4
	shl	eax, 0
	movss	DWORD PTR _p2$[ebp+eax], xmm0
...
; 146  : 		p2[2] = DotProduct( p1, itransform[2] );
	...
	mov	eax, 4
	imul	eax, eax, 0
	movss	xmm0, DWORD PTR _p1$[ebp+edx]
...
; 151  : 		if( p2[1] > outmaxs[1] ) outmaxs[1] = p2[1];
	...
	shl	eax, 0
	mov	ecx, DWORD PTR _outmaxs$[ebp]
	movss	xmm0, DWORD PTR _p2$[ebp+edx]
...
; 93   : 			boxmins[i] = start[i] + mins[i] - 1.0f;
	...
	mov	ecx, DWORD PTR _i$[ebp]
	mov	edx, DWORD PTR _boxmins$[ebp]
...
; 98   : 			boxmins[i] = end[i] + mins[i] - 1.0f;
	...
	subss	xmm0, DWORD PTR __real@3f800000
	mov	edx, DWORD PTR _i$[ebp]
	mov	eax, DWORD PTR _boxmins$[ebp]
...
; 99   : 			boxmaxs[i] = start[i] + maxs[i] + 1.0f;
	...
	addss	xmm0, DWORD PTR __real@3f800000
	mov	ecx, DWORD PTR _i$[ebp]
	mov	edx, DWORD PTR _boxmaxs$[ebp]
	movss	DWORD PTR [edx+ecx*4], xmm0
$LN6@World_Move:
