; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27045.0 
	...
	TITLE	C:\Users\USER\Documents\GitHub\XashTasks\xash_build4529_src\engine\client\cl_netgraph.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_extrap_base_color DB 0ffH
	...
	DB	0ffH
	DB	0ffH
$SG143501 DB	'%.1f fps', 00H
	ORG $+3
$SG143503 DB	'%i ms', 00H
	ORG $+2
$SG143506 DB	'in :  %i %.2f k/s', 00H
	ORG $+2
$SG143507 DB	'out:  %i %.2f k/s', 00H
	ORG $+2
$SG143509 DB	'loss: %i choke: %i', 00H
	ORG $+1
$SG143511 DB	'%i/s', 00H
	ORG $+3
$SG143512 DB	'%i/s', 00H
	ORG $+3
$SG143626 DB	'net_scale', 00H
	ORG $+2
$SG143630 DB	'draw network usage graph', 00H
	ORG $+3
$SG143631 DB	'0', 00H
	ORG $+2
$SG143632 DB	'net_graph', 00H
	ORG $+2
$SG143633 DB	'network usage graph position', 00H
	ORG $+3
$SG143634 DB	'1', 00H
	ORG $+2
$SG143635 DB	'net_graphpos', 00H
	ORG $+3
$SG143636 DB	'network usage graph scale level', 00H
$SG143637 DB	'5', 00H
	ORG $+2
$SG143638 DB	'net_scale', 00H
	ORG $+2
$SG143639 DB	'network usage graph width', 00H
	ORG $+2
$SG143640 DB	'192', 00H
$SG143641 DB	'net_graphwidth', 00H
	ORG $+1
$SG143642 DB	'network usage graph height', 00H
	ORG $+1
$SG143643 DB	'64', 00H
	ORG $+1
$SG143644 DB	'net_graphheight', 00H
$SG143645 DB	'fill segments in network usage graph', 00H
	ORG $+3
$SG143646 DB	'1', 00H
	ORG $+2
$SG143647 DB	'net_graphsolid', 00H
_DATA	ENDS
; Function compile flags: /Odtp
; File c:\users\user\documents\github\xashtasks\xash_build4529_src\engine\client\cl_netgraph.c
_TEXT	SEGMENT
tv82 = -8						; size = 4
tv73 = -4						; size = 4
_rect$ = 8						; size = 4
...
; 606  : 	switch( (int)net_graphpos->value )
	...
	mov	ecx, DWORD PTR _net_graphpos
...
$T2 = -56						; size = 4
tv90 = -52						; size = 4
_pingheight$ = -48					; size = 4
_lastvalidh$ = -44					; size = 4
_ping$ = -40						; size = 4
_h$ = -36						; size = 4
_a$ = -32						; size = 4
_i$ = -28						; size = 4
...
; 487  : 	wrect_t	fill = { 0 };
	...
	mov	DWORD PTR _fill$[ebp+12], edx
...
; 495  : 		NetGraph_ColorForHeight( &netstat_packet_latency[i], color, &ping );
	...
	lea	edx, DWORD PTR _ping$[ebp]
	push	edx
	lea	eax, DWORD PTR _color$[ebp]
	push	eax
	mov	ecx, DWORD PTR _i$[ebp]
	lea	edx, DWORD PTR _netstat_packet_latency[ecx*8]
	push	edx
...
; 498  : 		else lastvalidh = h;
	...
	mov	DWORD PTR _lastvalidh$[ebp], ecx
$LN6@NetGraph_D:
...
; 500  : 		if( h > pingheight )
	...
	cmp	edx, DWORD PTR _pingheight$[ebp]
...
; 514  : 				fill.top += fill.bottom - 2;
	...
	mov	ecx, DWORD PTR _fill$[ebp+12]
	mov	edx, DWORD PTR _fill$[ebp+8]
...
; 533  : 		color[3] = 160;
	...
	mov	edx, 1
	imul	eax, edx, 3
	mov	BYTE PTR _color$[ebp+eax], 160		; 000000a0H
...
; 550  : 		if( netstat_packet_latency[i].latency > 9995 )
	...
	mov	ecx, DWORD PTR _i$[ebp]
	cmp	DWORD PTR _netstat_packet_latency[ecx*8], 9995 ; 0000270bH
...
; 553  : 		if( !NetGraph_DrawDataSegment( &fill, netstat_graph[i].client, 255, 0, 0, 128 ))
	...
	push	0
	push	255					; 000000ffH
	imul	edx, DWORD PTR _i$[ebp], 18
	movzx	eax, WORD PTR _netstat_graph[edx]
	push	eax
	lea	ecx, DWORD PTR _fill$[ebp]
	push	ecx
...
; 556  : 		if( !NetGraph_DrawDataSegment( &fill, netstat_graph[i].players, 255, 255, 0, 128 ))
	...
	push	255					; 000000ffH
	imul	edx, DWORD PTR _i$[ebp], 18
	movzx	eax, WORD PTR _netstat_graph[edx+2]
	push	eax
	lea	ecx, DWORD PTR _fill$[ebp]
	push	ecx
	call	_NetGraph_DrawDataSegment
...
; 559  : 		if( !NetGraph_DrawDataSegment( &fill, netstat_graph[i].entities, 255, 0, 255, 128 ))
	...
	push	255					; 000000ffH
	imul	edx, DWORD PTR _i$[ebp], 18
	movzx	eax, WORD PTR _netstat_graph[edx+4]
	push	eax
	lea	ecx, DWORD PTR _fill$[ebp]
	push	ecx
	call	_NetGraph_DrawDataSegment
...
; 562  : 		if( !NetGraph_DrawDataSegment( &fill, netstat_graph[i].tentities, 0, 0, 255, 128 ))
	...
	push	0
	imul	edx, DWORD PTR _i$[ebp], 18
	movzx	eax, WORD PTR _netstat_graph[edx+6]
	push	eax
	lea	ecx, DWORD PTR _fill$[ebp]
	push	ecx
	call	_NetGraph_DrawDataSegment
...
; 565  : 		if( !NetGraph_DrawDataSegment( &fill, netstat_graph[i].sound, 0, 255, 0, 128 ))
	...
	push	0
	imul	edx, DWORD PTR _i$[ebp], 18
	movzx	eax, WORD PTR _netstat_graph[edx+8]
	push	eax
	lea	ecx, DWORD PTR _fill$[ebp]
	push	ecx
	call	_NetGraph_DrawDataSegment
...
; 568  : 		if( !NetGraph_DrawDataSegment( &fill, netstat_graph[i].event, 0, 255, 255, 128 ))
	...
	push	0
	imul	edx, DWORD PTR _i$[ebp], 18
	movzx	eax, WORD PTR _netstat_graph[edx+10]
	push	eax
	lea	ecx, DWORD PTR _fill$[ebp]
	push	ecx
	call	_NetGraph_DrawDataSegment
...
; 571  : 		if( !NetGraph_DrawDataSegment( &fill, netstat_graph[i].usr, 200, 200, 200, 128 ))
	...
	push	200					; 000000c8H
	imul	edx, DWORD PTR _i$[ebp], 18
	movzx	eax, WORD PTR _netstat_graph[edx+12]
	push	eax
	lea	ecx, DWORD PTR _fill$[ebp]
	push	ecx
	call	_NetGraph_DrawDataSegment
...
; 574  : 		if( !NetGraph_DrawDataSegment( &fill, netstat_graph[i].voicebytes, 255, 255, 255, 255 ))
	...
	push	255					; 000000ffH
	imul	edx, DWORD PTR _i$[ebp], 18
	movzx	eax, WORD PTR _netstat_graph[edx+16]
	push	eax
	lea	ecx, DWORD PTR _fill$[ebp]
	push	ecx
	call	_NetGraph_DrawDataSegment
...
; 577  : 		fill.top = y - net_graphheight->value - 1;
	...
	cvtsi2ss xmm0, DWORD PTR _y$[ebp]
	mov	edx, DWORD PTR _net_graphheight
...
_b$ = 24						; size = 1
_a$ = 28						; size = 1
_NetGraph_DrawDataSegment PROC
...
; 426  : 	fill->top -= (int)h;
	...
	cvttss2si edx, DWORD PTR _h$[ebp]
...
; 429  : 		fill->bottom = (int)h;
	...
	cvttss2si ecx, DWORD PTR _h$[ebp]
	mov	edx, DWORD PTR _fill$[ebp]
...
; 359  : 	int		last_y = y - net_graphheight->value;
	...
	cvtsi2ss xmm0, DWORD PTR _y$[ebp]
	mov	ecx, DWORD PTR _net_graphheight
	subss	xmm0, DWORD PTR [ecx+12]
	cvttss2si edx, xmm0
	mov	DWORD PTR _last_y$[ebp], edx
...
; 384  : 			Con_DrawString( x + 75, y, va( "%i ms" , (int)avg ), colors );
	...
	lea	ecx, DWORD PTR _colors$[ebp]
	push	ecx
	cvttss2si edx, DWORD PTR _avg$[ebp]
	push	edx
...
; 389  : 		if( !out ) out = lastout;
	...
	mov	edx, DWORD PTR ?lastout@?1??NetGraph_DrawTextFields@@9@9
...
; 392  : 		Con_DrawString( x, y, va( "in :  %i %.2f k/s", netstat_graph[j].msgbytes, cls.netchan.flow[FLOW_INCOMING].avgkbytespersec ), colors );
	...
	shl	edx, 0
	cvtss2sd xmm0, DWORD PTR _cls[edx+286756]
	sub	esp, 8
	movsd	QWORD PTR [esp], xmm0
	imul	eax, DWORD PTR _j$[ebp], 18
...
; 395  : 		Con_DrawString( x, y, va( "out:  %i %.2f k/s", out, cls.netchan.flow[FLOW_OUTGOING].avgkbytespersec ), colors );
	...
	imul	ecx, eax, 0
	cvtss2sd xmm0, DWORD PTR _cls[ecx+286756]
	sub	esp, 8
	movsd	QWORD PTR [esp], xmm0
...
; 401  : 			int	choke = (int)(( packet_choke + PACKETCHOKE_AVG_FRAC ) - 0.01 );
	...
	subsd	xmm0, QWORD PTR __real@3f847ae147ae147b
	cvttsd2si edx, xmm0
	mov	DWORD PTR _choke$2[ebp], edx
...
; 403  : 			Con_DrawString( x, y, va( "loss: %i choke: %i", loss, choke ), colors );
	...
	push	eax
	mov	ecx, DWORD PTR _choke$2[ebp]
	push	ecx
	mov	edx, DWORD PTR _loss$1[ebp]
	push	edx
	push	OFFSET $SG143509
	call	_va
	add	esp, 12					; 0000000cH
	push	eax
	mov	eax, DWORD PTR _y$[ebp]
...
; 410  : 	Con_DrawString( ptx, last_y, va( "%i/s" , (int)cl_updaterate->value ), colors );
	...
	add	esp, 8
	push	eax
	mov	edx, DWORD PTR _last_y$[ebp]
	push	edx
	mov	eax, DWORD PTR _ptx$[ebp]
	push	eax
	call	_Con_DrawString
	add	esp, 16					; 00000010H
...
; 332  : 	for( starty = hatch.top; hatch.top > 0 && ((starty - hatch.top) * net_scale->value < (maxmsgbytes + 50)); hatch.top -= ystep )
	...
	jmp	SHORT $LN4@NetGraph_D
$LN2@NetGraph_D:
	mov	ecx, DWORD PTR _hatch$[ebp+8]
	sub	ecx, DWORD PTR _ystep$[ebp]
	mov	DWORD PTR _hatch$[ebp+8], ecx
$LN4@NetGraph_D:
	cmp	DWORD PTR _hatch$[ebp+8], 0
	jle	SHORT $LN3@NetGraph_D
	mov	edx, DWORD PTR _starty$[ebp]
	sub	edx, DWORD PTR _hatch$[ebp+8]
	cvtsi2ss xmm0, edx
	mov	eax, DWORD PTR _net_scale
...
; 340  : 			NetGraph_DrawRect( &hatch, colorminor );
	...
	lea	ecx, DWORD PTR _colorminor$[ebp]
	push	ecx
	lea	edx, DWORD PTR _hatch$[ebp]
	push	edx
	call	_NetGraph_DrawRect
	add	esp, 8
$LN7@NetGraph_D:
...
; 262  : 		if( h >= extrap_point )
	...
	mov	ecx, DWORD PTR _h$[ebp]
	cmp	ecx, DWORD PTR _extrap_point$[ebp]
	jl	$LN11@NetGraph_D
...
; 269  : 			if( !net_graphsolid->value )
	...
	mov	ecx, DWORD PTR _net_graphsolid
	movss	xmm0, DWORD PTR [ecx+12]
	ucomiss	xmm0, DWORD PTR __real@00000000
	lahf
	test	ah, 68					; 00000044H
...
; 272  : 				start = (h - 1);
	...
	mov	ecx, DWORD PTR _h$[ebp]
	sub	ecx, 1
	mov	DWORD PTR _start$2[ebp], ecx
$LN13@NetGraph_D:
...
; 277  : 				NetGraph_DrawRect( &fill, netcolors[NETGRAPH_NET_COLORS + j + extrap_point] );
	...
	mov	edx, DWORD PTR _extrap_point$[ebp]
	mov	eax, DWORD PTR _j$[ebp]
	lea	ecx, DWORD PTR [eax+edx+5]
	lea	edx, DWORD PTR _netcolors[ecx*4]
	push	edx
	lea	eax, DWORD PTR _fill$[ebp]
	push	eax
	call	_NetGraph_DrawRect
...
; 286  : 			h = extrap_point - h;
	...
	mov	ecx, DWORD PTR _extrap_point$[ebp]
...
; 288  : 			if( !net_graphsolid->value )
	...
	mov	edx, DWORD PTR _net_graphsolid
	movss	xmm0, DWORD PTR [edx+12]
	ucomiss	xmm0, DWORD PTR __real@00000000
	lahf
	test	ah, 68					; 00000044H
...
; 298  : 		fill.top = rect.top + rect.bottom - 4 - extrap_point;
	...
	sub	ecx, DWORD PTR _extrap_point$[ebp]
	mov	DWORD PTR _fill$[ebp+8], ecx
...
; 305  : 		if( netstat_cmdinfo[i].sent )
	...
	cmp	DWORD PTR _netstat_cmdinfo[edx+8], 0
...
_choke$ = -44						; size = 4
_loss$ = -40						; size = 4
_frame_latency$1 = -36					; size = 4
tv193 = -32						; size = 4
tv69 = -28						; size = 4
_choke_count$ = -24					; size = 4
_loss_count$ = -20					; size = 4
_g$2 = -16						; size = 4
_p$3 = -12						; size = 4
_f$4 = -8						; size = 4
_i$ = -4						; size = 4
...
; 182  : 	for( i = cls.netchan.incoming_sequence - CL_UPDATE_BACKUP + 1; i <= cls.netchan.incoming_sequence; i++ )
	...
	mov	edx, DWORD PTR _cls+23584
	sub	edx, DWORD PTR _CL_UPDATE_BACKUP
	add	edx, 1
	mov	DWORD PTR _i$[ebp], edx
...
; 193  : 			p->latency = 9998; // broken delta
	...
	mov	edx, DWORD PTR _p$3[ebp]
	mov	DWORD PTR [edx], 9998			; 0000270eH
...
; 197  : 			p->latency = 9999; // dropped
	...
	mov	DWORD PTR [ecx], 9999			; 0000270fH

; 198  : 			loss_count++;

	mov	edx, DWORD PTR _loss_count$[ebp]
	add	edx, 1
	mov	DWORD PTR _loss_count$[ebp], edx
...
; 202  : 			p->latency = 9997; // skipped
	...
	mov	ecx, DWORD PTR _p$3[ebp]
	mov	DWORD PTR [ecx], 9997			; 0000270dH
...
$LN22@NetGraph_G:
	...
	movsd	QWORD PTR tv137[ebp], xmm0
$LN23@NetGraph_G:
	cvttsd2si ecx, QWORD PTR tv137[ebp]
	mov	DWORD PTR _frame_latency$1[ebp], ecx
...
; 218  : 		if( g->msgbytes > maxmsgbytes )
	...
	mov	edx, DWORD PTR _g$2[ebp]
	movzx	eax, WORD PTR [edx+14]
	cmp	eax, DWORD PTR _maxmsgbytes
...
; 227  : 		netstat_cmdinfo[i & NET_TIMINGS_MASK].cmd_lerp = cl.commands[i & CL_UPDATE_MASK].frame_lerp;
	...
	and	edx, 1023				; 000003ffH
	imul	eax, edx, 12
	mov	ecx, DWORD PTR _cl[ecx+1107560]
...
; 228  : 		netstat_cmdinfo[i & NET_TIMINGS_MASK].sent = cl.commands[i & CL_UPDATE_MASK].heldback ? false : true;
	...
	and	edx, DWORD PTR _i$[ebp]
	imul	eax, edx, 88
	cmp	DWORD PTR _cl[eax+1107620], 0
...
$LN25@NetGraph_G:
	...
	mov	DWORD PTR _netstat_cmdinfo[edx+8], eax
...
; 229  : 		netstat_cmdinfo[i & NET_TIMINGS_MASK].size = cl.commands[i & CL_UPDATE_MASK].sendsize;
	...
	and	eax, 1023				; 000003ffH
	imul	ecx, eax, 12
	mov	edx, DWORD PTR _cl[edx+1107624]
	mov	DWORD PTR _netstat_cmdinfo[ecx+4], edx
...
; 123  : 	maxcolor[0][0] = 0;
	...
	mov	ecx, 3
	imul	edx, ecx, 0
	lea	eax, DWORD PTR _maxcolor$[ebp+edx]
	mov	ecx, 1
	imul	edx, ecx, 0
...
; 137  : 		dc[0][i] = (float)(maxcolor[0][i] - mincolor[0][i]);
	...
	mov	ecx, 3
	imul	edx, ecx, 0
	lea	ecx, DWORD PTR _mincolor$[ebp+edx]
	mov	edx, DWORD PTR _i$[ebp]
...
; 651  : 	NetGraph_DrawTextFields( x, y, w, rect, ping_count, avg_ping, packet_loss, packet_choke );
	...
	cvttss2si edx, DWORD PTR _packet_choke
	push	edx
	cvttss2si eax, DWORD PTR _packet_loss
	push	eax
	push	ecx
	movss	xmm0, DWORD PTR _avg_ping$[ebp]
	movss	DWORD PTR [esp], xmm0
	mov	ecx, DWORD PTR _ping_count$[ebp]
	push	ecx
