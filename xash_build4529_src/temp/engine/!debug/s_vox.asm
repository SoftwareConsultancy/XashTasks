; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27045.0 
	...
	TITLE	C:\Users\USER\Documents\GitHub\XashTasks\xash_build4529_src\engine\client\s_vox.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
$SG131925 DB	'vox/', 00H
	ORG $+3
$SG132100 DB	'^1Error:^7 VOX_LoadSound: no such sentence %s', 0aH, 00H
	ORG $+1
$SG132102 DB	'^1Error:^7 VOX_LoadSound: sentence is too long %s', 0aH, 00H
	ORG $+1
$SG132104 DB	'.wav', 00H
	ORG $+3
$SG132127 DB	'^1Error:^7 sentence too long!', 0aH, 00H
	ORG $+1
$SG132131 DB	'len', 00H
$SG132159 DB	'^1Error:^7 VOX_Init: too many sentences specified', 0aH, 00H
	ORG $+1
$SG132166 DB	'sound/sentences.txt', 00H
_DATA	ENDS
; Function compile flags: /Odtp
; File c:\users\user\documents\github\xashtasks\xash_build4529_src\engine\client\s_vox.c
_TEXT	SEGMENT
_index$1 = -32						; size = 4
_fileSize$ = -28					; size = 4
_pSentence$2 = -24					; size = 4
_pFileData$ = -20					; size = 4
_pSentenceData$ = -16					; size = 4
_pchlast$ = -12						; size = 4
_pch$ = -8						; size = 4
_c$ = -1						; size = 1
_psentenceFileName$ = 8					; size = 4
_VOX_ReadSentenceFile PROC
...
; 618  : 	while( pch < pchlast )
	...
	cmp	ecx, DWORD PTR _pchlast$[ebp]
	jae	$LN3@VOX_ReadSe
...
; 638  : 			sentence_t *pSentence = &g_Sentences[g_numSentences++];
	...
	lea	eax, DWORD PTR _g_Sentences[edx*8]
	mov	DWORD PTR _pSentence$2[ebp], eax
	mov	ecx, DWORD PTR _g_numSentences
	add	ecx, 1
	mov	DWORD PTR _g_numSentences, ecx

; 639  : 
; 640  : 			pSentence->pName = pch;

	mov	edx, DWORD PTR _pSentence$2[ebp]
	mov	eax, DWORD PTR _pch$[ebp]
	mov	DWORD PTR [edx], eax

; 641  : 			pSentence->length = 0;

	mov	ecx, DWORD PTR _pSentence$2[ebp]
	xorps	xmm0, xmm0
...
; 662  : 		if( pch < pchlast ) *pch++ = 0;
	...
	mov	edx, DWORD PTR _pch$[ebp]
	cmp	edx, DWORD PTR _pchlast$[ebp]
...
; 665  : 		if( pSentenceData && pSentenceData < pchlast )
	...
	mov	edx, DWORD PTR _pSentenceData$[ebp]
	cmp	edx, DWORD PTR _pchlast$[ebp]
...
; 545  : 		length = pNext - pSentenceData;
	...
	sub	ecx, DWORD PTR _pSentenceData$[ebp]
...
; 556  : 		tempBufferPos += length;
	...
	mov	ecx, DWORD PTR _tempBufferPos$[ebp]
	add	ecx, DWORD PTR _length$[ebp]
	mov	DWORD PTR _tempBufferPos$[ebp], ecx

; 557  : 
; 558  : 		pSentenceData = pNext;

	mov	edx, DWORD PTR _pNext$[ebp]
	mov	DWORD PTR _pSentenceData$[ebp], edx
...
; 565  : 			pSentenceData++;
	...
	mov	ecx, DWORD PTR _pSentenceData$[ebp]
	add	ecx, 1
	mov	DWORD PTR _pSentenceData$[ebp], ecx
...
; 574  : 				g_Sentences[sentenceIndex].length = Q_atof( pSentenceData + 3 );
	...
	call	_Q_atof
	add	esp, 4
	mov	eax, DWORD PTR _sentenceIndex$[ebp]
	fstp	DWORD PTR _g_Sentences[eax*8+4]
$LN14@VOX_ParseL:
$LN15@VOX_ParseL:
...
; 595  : 		tempBuffer[tempBufferPos] = 0;
	...
	jae	SHORT $LN19@VOX_ParseL
	jmp	SHORT $LN20@VOX_ParseL
$LN19@VOX_ParseL:
	call	___report_rangecheckfailure
$LN20@VOX_ParseL:
	mov	edx, DWORD PTR $T1[ebp]
	mov	BYTE PTR _tempBuffer$[ebp+edx], 0
...
; 314  : 			sznum[i++] = c;
	...
	mov	BYTE PTR _sznum$[ebp+edx], al
	mov	ecx, DWORD PTR _i$[ebp]
	add	ecx, 1
	mov	DWORD PTR _i$[ebp], ecx
...
; 323  : 		case 'v': pvoxword->volume = i; break;
	...
	mov	ecx, DWORD PTR _pvoxword$[ebp]
	mov	edx, DWORD PTR _i$[ebp]
...
; 325  : 		case 's': pvoxword->start = i; break;
	...
	mov	edx, DWORD PTR _pvoxword$[ebp]
...
; 196  : 		if ( pchan->words[pchan->wordIndex].volume )
	...
	mov	ecx, DWORD PTR _pchan$[ebp]
	imul	edx, DWORD PTR [ecx+164], 36
	mov	eax, DWORD PTR _pchan$[ebp]
	cmp	DWORD PTR [eax+edx+172], 0
	je	SHORT $LN4@VOX_GetVol
...
; 198  : 			float	volume = pchan->words[pchan->wordIndex].volume * 0.01f;
	...
	imul	edx, DWORD PTR [ecx+164], 36
	mov	eax, DWORD PTR _pchan$[ebp]
	cvtsi2ss xmm0, DWORD PTR [eax+edx+172]
...
; 142  : 	rgpparseword[i++] = psz;
	...
	mov	ecx, DWORD PTR _i$[ebp]
	mov	edx, DWORD PTR _psz$[ebp]
	mov	DWORD PTR _rgpparseword[ecx*4], edx
	mov	eax, DWORD PTR _i$[ebp]
	add	eax, 1
	mov	DWORD PTR _i$[ebp], eax
$LN2@VOX_ParseS:
...
; 170  : 				else rgpparseword[i++] = voxcomma;
	...
	mov	edx, DWORD PTR _i$[ebp]
	mov	DWORD PTR _rgpparseword[edx*4], OFFSET _voxcomma
	mov	eax, DWORD PTR _i$[ebp]
	add	eax, 1
	mov	DWORD PTR _i$[ebp], eax
$LN17@VOX_ParseS:
...
; 185  : 			else rgpparseword[i++] = p;
	...
	mov	edx, DWORD PTR _i$[ebp]
	mov	eax, DWORD PTR _p$[ebp]
	mov	DWORD PTR _rgpparseword[edx*4], eax
	mov	ecx, DWORD PTR _i$[ebp]
	add	ecx, 1
	mov	DWORD PTR _i$[ebp], ecx
$LN12@VOX_ParseS:
...
; 111  : 	if( Q_isdigit( pSentenceName ) && (i = Q_atoi( pSentenceName )) < g_numSentences )
	...
	mov	ecx, DWORD PTR _pSentenceName$[ebp]
	push	ecx
	call	_Q_atoi
	add	esp, 4
	mov	DWORD PTR _i$[ebp], eax
	mov	edx, DWORD PTR _i$[ebp]
	cmp	edx, DWORD PTR _g_numSentences
...
; 114  : 		return (g_Sentences[i].pName + Q_strlen( g_Sentences[i].pName ) + 1 );		
	...
	mov	edx, DWORD PTR _i$[ebp]
	mov	eax, DWORD PTR _g_Sentences[edx*8]
	push	eax
	call	_Q_strlen
	add	esp, 4
	mov	ecx, DWORD PTR _i$[ebp]
	mov	edx, DWORD PTR _g_Sentences[ecx*8]
...
; 121  : 			if( psentencenum ) *psentencenum = i;
	...
	mov	edx, DWORD PTR _psentencenum$[ebp]
	mov	eax, DWORD PTR _i$[ebp]
	mov	DWORD PTR [edx], eax
$LN8@VOX_Lookup:
...
; File c:\users\user\documents\github\xashtasks\xash_build4529_src\engine\client\s_vox.c
_TEXT	SEGMENT
_startingOffset$ = -12					; size = 4
_timeCompress$1 = -8					; size = 4
_outputCount$2 = -4					; size = 4
_pchan$ = 8						; size = 4
_sampleCount$ = 12					; size = 4
_outputRate$ = 16					; size = 4
_outputOffset$ = 20					; size = 4
_VOX_MixDataToDevice PROC
...
; 429  : 		int	outputCount = S_MixDataToDevice( pchan, sampleCount, outputRate, outputOffset, timeCompress );
	...
	mov	DWORD PTR _outputCount$2[ebp], eax

; 430  : 
; 431  : 		outputOffset += outputCount;

	mov	eax, DWORD PTR _outputOffset$[ebp]
	add	eax, DWORD PTR _outputCount$2[ebp]
	mov	DWORD PTR _outputOffset$[ebp], eax

; 432  : 		sampleCount -= outputCount;

	mov	ecx, DWORD PTR _sampleCount$[ebp]
	sub	ecx, DWORD PTR _outputCount$2[ebp]
...
_i$ = -2924						; size = 4
_psz$ = -2920						; size = 4
_rgvoxword$ = -2916					; size = 2304
_buffer$ = -612						; size = 512
_pathbuffer$ = -100					; size = 64
_szpath$ = -36						; size = 32
__$ArrayPad$ = -4					; size = 4
_pchan$ = 8						; size = 4
_pszin$ = 12						; size = 4
...
; 463  : 	memset( rgvoxword, 0, sizeof( voxword_t ) * CVOXWORDMAX );
	...
	push	2304					; 00000900H
	push	0
	lea	edx, DWORD PTR _rgvoxword$[ebp]
	push	edx
	call	_memset
	add	esp, 12					; 0000000cH
...
; 497  : 	while( rgpparseword[i] )
	...
	mov	edx, DWORD PTR _i$[ebp]
	cmp	DWORD PTR _rgpparseword[edx*4], 0
	je	$LN3@VOX_LoadSo
...
; 504  : 			Q_strncat( pathbuffer, rgpparseword[i], sizeof( pathbuffer ));
	...
	push	64					; 00000040H
	mov	ecx, DWORD PTR _i$[ebp]
	mov	edx, DWORD PTR _rgpparseword[ecx*4]
	push	edx
	lea	eax, DWORD PTR _pathbuffer$[ebp]
	push	eax
	call	_Q_strncat
...
; 509  : 			rgvoxword[cword].sfx = S_FindName( pathbuffer, &( rgvoxword[cword].fKeepCached ));
	...
	imul	edx, DWORD PTR _cword$[ebp], 36
	lea	eax, DWORD PTR _rgvoxword$[ebp+edx+20]
	push	eax
	lea	ecx, DWORD PTR _pathbuffer$[ebp]
	push	ecx
	call	_S_FindName
	add	esp, 8
	imul	edx, DWORD PTR _cword$[ebp], 36
	mov	DWORD PTR _rgvoxword$[ebp+edx+32], eax
...
; 518  : 	pchan->sfx = rgvoxword[0].sfx;
	...
	imul	eax, edx, 0
	mov	ecx, DWORD PTR _pchan$[ebp]
	mov	edx, DWORD PTR _rgvoxword$[ebp+eax+32]
...
; 349  : 		wavdata_t	*pSource = S_LoadSound( pchan->words[pchan->wordIndex].sfx );
	...
	call	_S_LoadSound
	add	esp, 4
	mov	DWORD PTR _pSource$3[ebp], eax

; 350  : 
; 351  : 		if( pSource )

	cmp	DWORD PTR _pSource$3[ebp], 0
	je	$LN8@VOX_LoadWo
...
; 358  : 			pchan->currentWord->pData = pSource; 
	...
	mov	edx, DWORD PTR _pchan$[ebp]
	mov	eax, DWORD PTR [edx+168]
	mov	ecx, DWORD PTR _pSource$3[ebp]
...
; 361  : 			if( end <= start ) end = 0;
	...
	mov	edx, DWORD PTR _end$4[ebp]
	cmp	edx, DWORD PTR _start$2[ebp]
	jg	SHORT $LN4@VOX_LoadWo
	mov	DWORD PTR _end$4[ebp], 0
$LN4@VOX_LoadWo:

; 362  : 
; 363  : 			if( start || end )

	cmp	DWORD PTR _start$2[ebp], 0
	jne	SHORT $LN6@VOX_LoadWo
	cmp	DWORD PTR _end$4[ebp], 0
...
; 365  : 				int	sampleCount = pSource->samples;
	...
	mov	eax, DWORD PTR _pSource$3[ebp]
...
; 369  : 					S_SetSampleStart( pchan, pSource, (int)(sampleCount * 0.01f * start));
	...
	mulss	xmm0, DWORD PTR __real@3c23d70a
	cvtsi2ss xmm1, DWORD PTR _start$2[ebp]
	mulss	xmm0, xmm1
	cvttss2si edx, xmm0
	push	edx
	mov	eax, DWORD PTR _pSource$3[ebp]
...
; 374  : 					S_SetSampleEnd( pchan, pSource, (int)(sampleCount * 0.01f * end));
	...
	cvtsi2ss xmm0, DWORD PTR _sampleCount$1[ebp]
	mulss	xmm0, DWORD PTR __real@3c23d70a
	cvtsi2ss xmm1, DWORD PTR _end$4[ebp]
	mulss	xmm0, xmm1
	cvttss2si edx, xmm0
	push	edx
	mov	eax, DWORD PTR _pSource$3[ebp]
