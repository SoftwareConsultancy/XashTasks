; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27045.0 
	...
	TITLE	C:\Users\USER\Documents\GitHub\XashTasks\xash_build4529_src\engine\client\vgui\vgui_surf.cpp
	.686P
	.XMM
	include listing.inc
	.model	flat
...
CONST	SEGMENT
$SG136443 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\client\vgui\vgui_surf.cpp', 00H
	ORG $+3
$SG136444 DB	'assert failed at %s:%i', 0aH, 00H
$SG136450 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\client\vgui\vgui_surf.cpp', 00H
	ORG $+3
$SG136451 DB	'top >= 0', 00H
	ORG $+7
$SG136452 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\client\vgui\vgui_surf.cpp', 00H
	ORG $+3
$SG136453 DB	'paintStack[top].m_pPanel == panel', 00H
CONST	ENDS
...
PUBLIC	?flushBuffer@CEngineSurface@@UAEXXZ		; CEngineSurface::flushBuffer
...
_BSS	ENDS
;	COMDAT ?hasColor@?1??drawPrintText@CEngineSurface@@MAEXPBDH@Z@4_NA
_BSS	SEGMENT
...
??_R4SurfaceBase@vgui@@6B@ DD 00H			; vgui::SurfaceBase::`RTTI Complete Object Locator'
	...
	DD	FLAT:??_R3SurfaceBase@vgui@@8
rdata$r	ENDS
;	COMDAT ?numColor@?1??drawPrintText@CEngineSurface@@MAEXPBDH@Z@4HA
_DATA	SEGMENT
...
??_7CEngineSurface@@6B@ DD FLAT:??_R4CEngineSurface@@6B@ ; CEngineSurface::`vftable'
	...
	DD	FLAT:?flushBuffer@CEngineSurface@@UAEXXZ
...
; File c:\users\user\documents\github\xashtasks\xash_build4529_src\engine\client\vgui\vgui_surf.cpp
...
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\user\documents\github\xashtasks\xash_build4529_src\engine\client\vgui\vgui_main.h
...
; 85   : 	virtual void applyChanges( void ) { }
...
; 84   : 	virtual void setAsTopMost( bool state ) { }
...
; 83   : 	virtual void invalidate( Panel *panel ) { }
...
; 82   : 	virtual void enableMouseCapture( bool state ) { }
...
; 81   : 	virtual bool recreateContext( void ) { return false; }
...
; 80   : 	virtual bool createPlat( void ) { return false; }
...
_top$ = -4						; size = 4
_panel$ = 8						; size = 4
?popMakeCurrent@CEngineSurface@@MAEXPAVPanel@vgui@@@Z PROC ; CEngineSurface::popMakeCurrent
; _this$ = ecx
...
; 450  : 	int top = staticPaintStackPos - 1;
	...
	mov	ecx, DWORD PTR ?staticPaintStackPos@@3HA
	sub	ecx, 1
...
$LN5@popMakeCur:
	push	0
	push	453					; 000001c5H
	push	OFFSET $SG136450
	push	OFFSET $SG136451
...
; 460  : 	if( top > 0 ) SetupPaintState( &paintStack[top-1] );
	...
	sub	ecx, 1
	imul	edx, ecx, 28
	add	edx, OFFSET ?paintStack@@3PAUPaintStack@@A
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
...
_TEXT	SEGMENT
_this$ = -60						; size = 4
_paintState$ = -56					; size = 4
_absExtents$ = -52					; size = 16
_clipRect$ = -36					; size = 16
_insets$ = -20						; size = 16
__$ArrayPad$ = -4					; size = 4
_panel$ = 8						; size = 4
_useInsets$ = 12					; size = 1
?pushMakeCurrent@CEngineSurface@@MAEXPAVPanel@vgui@@_N@Z PROC ; CEngineSurface::pushMakeCurrent
; _this$ = ecx
...
; 437  : 	paintState->iScissorLeft = clipRect[0];
	...
	imul	edx, ecx, 0
	mov	eax, DWORD PTR _paintState$[ebp]
	mov	ecx, DWORD PTR _clipRect$[ebp+edx]
...
; 443  : 	staticPaintStackPos++;
	...
	mov	ecx, DWORD PTR ?staticPaintStackPos@@3HA
	add	ecx, 1
	mov	DWORD PTR ?staticPaintStackPos@@3HA, ecx
...
_this$ = -4						; size = 4
_cursor$ = 8						; size = 4
?setCursor@CEngineSurface@@MAEXPAVCursor@vgui@@@Z PROC	; CEngineSurface::setCursor
; _this$ = ecx
...
_lr$ = 12						; size = 4
_color$ = 16						; size = 4
?addCharToBuffer@CEngineSurface@@MAEXPBUvpoint_t@@0QAH@Z PROC ; CEngineSurface::addCharToBuffer
; _this$ = ecx
...
; 242  : 	g_VertexBuffer[g_iVertexBufferEntriesUsed + 0].coord[0] = ul->coord[0];
	...
	mov	ecx, 4
	imul	edx, ecx, 0
	imul	eax, DWORD PTR ?g_iVertexBufferEntriesUsed@@3HA, 20
	mov	ecx, 4
	imul	ecx, ecx, 0
	mov	esi, DWORD PTR _ul$[ebp]
	mov	edx, DWORD PTR [esi+edx+8]
	mov	DWORD PTR ?g_VertexBuffer@@3PAUvpoint_t@@A[eax+ecx+8], edx
...
; 244  : 	g_VertexBuffer[g_iVertexBufferEntriesUsed + 0].point[0] = ul->point[0];
	...
	mov	DWORD PTR ?g_VertexBuffer@@3PAUvpoint_t@@A[eax+ecx], edx
...
; 246  : 	g_VertexBuffer[g_iVertexBufferEntriesUsed + 0].color[0] = color[0];
	...
	mov	BYTE PTR ?g_VertexBuffer@@3PAUvpoint_t@@A[eax+ecx+16], dl
...
; 257  : 	g_VertexBuffer[g_iVertexBufferEntriesUsed + 1].color[2] = color[2];
	...
	mov	esi, DWORD PTR _color$[ebp]
	mov	dl, BYTE PTR [esi+edx]
	mov	BYTE PTR ?g_VertexBuffer@@3PAUvpoint_t@@A[ecx+eax+16], dl
...
; 278  : 	g_iVertexBufferEntriesUsed += 4;
	...
	mov	edx, DWORD PTR ?g_iVertexBufferEntriesUsed@@3HA
	add	edx, 4
	mov	DWORD PTR ?g_iVertexBufferEntriesUsed@@3HA, edx
...
_t1$ = 36						; size = 4
_color$ = 40						; size = 4
?drawPrintChar@CEngineSurface@@MAEXHHHHMMMMQAH@Z PROC	; CEngineSurface::drawPrintChar
; _this$ = ecx
...
; 295  : 	ul.point[1] = y;
	...
	mov	edx, 4
	shl	edx, 0
	movss	DWORD PTR _ul$[ebp+edx], xmm0
...
; 307  : 	if( !ClipRect( ul, lr, &clippedRect[0], &clippedRect[1] ))
	...
	shl	edx, 0
	lea	eax, DWORD PTR _clippedRect$[ebp+edx]
	push	eax
...
_x1$ = 16						; size = 4
_y1$ = 20						; size = 4
?drawTexturedRect@CEngineSurface@@MAEXHHHH@Z PROC	; CEngineSurface::drawTexturedRect
; _this$ = ecx
...
; 406  : 	InitVertex( rect[1], x1, y1, 1, 1 );
	...
	mov	ecx, 20					; 00000014H
	shl	ecx, 0
	lea	edx, DWORD PTR _rect$[ebp+ecx]
	push	edx
	mov	ecx, DWORD PTR _this$[ebp]
	call	?InitVertex@CEngineSurface@@AAEXAAUvpoint_t@@HHMM@Z ; CEngineSurface::InitVertex
...
_this$ = -4						; size = 4
_id$ = 8						; size = 4
?drawSetTexture@CEngineSurface@@MAEXH@Z PROC		; CEngineSurface::drawSetTexture
; _this$ = ecx
...
_wide$ = 16						; size = 4
_tall$ = 20						; size = 4
?drawSetTextureRGBA@CEngineSurface@@MAEXHPBDHH@Z PROC	; CEngineSurface::drawSetTextureRGBA
; _this$ = ecx
...
_j$10 = -40						; size = 4
_j$11 = -36						; size = 4
_iTotalWidth$ = -32					; size = 4
_curCh$12 = -28						; size = 4
_this$ = -24						; size = 4
_curTextColor$ = -20					; size = 16
__$ArrayPad$ = -4					; size = 4
_text$ = 8						; size = 4
_textLen$ = 12						; size = 4
?drawPrintText@CEngineSurface@@MAEXPBDH@Z PROC		; CEngineSurface::drawPrintText
; _this$ = ecx
...
; 333  : 	if( numColor != 7 && vgui_colorstrings->value )
	...
	mov	ecx, DWORD PTR _vgui_colorstrings
...
; 341  : 			curTextColor[j] = _drawTextColor[j];
	...
	mov	DWORD PTR _curTextColor$[ebp+edx*4], eax
...
; 343  : 	curTextColor[3] = _drawTextColor[3]; // copy alpha
	...
	imul	ecx, eax, 3
	mov	eax, DWORD PTR _this$[ebp]
	mov	edx, DWORD PTR [eax+edx+60]
	mov	DWORD PTR _curTextColor$[ebp+ecx], edx
...
; 364  : 		int curCh = (byte)text[i];
	...
	mov	DWORD PTR _curCh$12[ebp], edx

; 365  : 
; 366  : 		staticFont->getCharABCwide( curCh, abcA, abcB, abcC );

	lea	eax, DWORD PTR _abcC$1[ebp]
	push	eax
	lea	ecx, DWORD PTR _abcB$7[ebp]
	push	ecx
	lea	edx, DWORD PTR _abcA$6[ebp]
	push	edx
	mov	eax, DWORD PTR _curCh$12[ebp]
	push	eax
	mov	ecx, DWORD PTR ?staticFont@@3PAVFont@vgui@@A
	mov	edx, DWORD PTR [ecx]
	mov	ecx, DWORD PTR ?staticFont@@3PAVFont@vgui@@A
...
; 368  : 		float s0 = staticFontInfo->texCoord[curCh][0];
	...
	mov	ecx, DWORD PTR _curCh$12[ebp]
	shl	ecx, 5
	...
	movss	DWORD PTR _s0$2[ebp], xmm0
...
; 370  : 		float s1 = staticFontInfo->texCoord[curCh][2];
	...
	movss	DWORD PTR _s1$4[ebp], xmm0

; 371  : 		float t1 = staticFontInfo->texCoord[curCh][3];

	mov	edx, DWORD PTR _curCh$12[ebp]
	shl	edx, 5
	mov	eax, DWORD PTR ?staticFontInfo@@3PAUFontInfo@@A
	lea	ecx, DWORD PTR [eax+edx+1064]
	mov	edx, 4
	imul	eax, edx, 3
	movss	xmm0, DWORD PTR [ecx+eax]
	movss	DWORD PTR _t1$5[ebp], xmm0

; 372  : 		int wide = abcB;

	mov	ecx, DWORD PTR _abcB$7[ebp]
	mov	DWORD PTR _wide$8[ebp], ecx

; 373  : 
; 374  : 		iTotalWidth += abcA;

	mov	edx, DWORD PTR _iTotalWidth$[ebp]
	add	edx, DWORD PTR _abcA$6[ebp]
	mov	DWORD PTR _iTotalWidth$[ebp], edx
...
; 376  : 		drawPrintChar( x + iTotalWidth, y, wide, tall, s0, t0, s1, t1, curTextColor );
	...
	push	eax
	push	ecx
	movss	xmm0, DWORD PTR _t1$5[ebp]
	movss	DWORD PTR [esp], xmm0
	push	ecx
	movss	xmm0, DWORD PTR _s1$4[ebp]
	movss	DWORD PTR [esp], xmm0
	push	ecx
	movss	xmm0, DWORD PTR _t0$3[ebp]
	movss	DWORD PTR [esp], xmm0
	push	ecx
	movss	xmm0, DWORD PTR _s0$2[ebp]
	movss	DWORD PTR [esp], xmm0
	mov	ecx, DWORD PTR _tall$[ebp]
	push	ecx
	mov	edx, DWORD PTR _wide$8[ebp]
	push	edx
	mov	eax, DWORD PTR _y$[ebp]
	push	eax
...
; 377  : 		iTotalWidth += wide + abcC;
	...
	mov	eax, DWORD PTR _wide$8[ebp]
	add	eax, DWORD PTR _abcC$1[ebp]
...
_x$ = 8							; size = 4
_y$ = 12						; size = 4
?drawSetTextPos@CEngineSurface@@MAEXHH@Z PROC		; CEngineSurface::drawSetTextPos
; _this$ = ecx
...
_y$9 = -16						; size = 4
_i$10 = -12						; size = 4
_currentPage$11 = -8					; size = 4
_buildFont$12 = -1					; size = 1
_font$ = 8						; size = 4
?drawSetTextFont@CEngineSurface@@MAEXPAVFont@vgui@@@Z PROC ; CEngineSurface::drawSetTextFont
; _this$ = ecx
...
; 155  : 				if( staticFontInfo->contextCount != staticContextCount )
	...
	mov	edx, DWORD PTR ?staticFontInfo@@3PAUFontInfo@@A
	mov	eax, DWORD PTR [edx+9256]
	cmp	eax, DWORD PTR ?staticContextCount@@3HA
...
; 160  : 		if( !staticFontInfo || buildFont )
	...
	movzx	ecx, BYTE PTR _buildFont$12[ebp]
	test	ecx, ecx
	je	$LN11@drawSetTex
$LN12@drawSetTex:
...
; 162  : 			staticFontInfo = new FontInfo;
	...
	mov	DWORD PTR ?staticFontInfo@@3PAUFontInfo@@A, edx
...
; 170  : 			staticFontInfo->contextCount = -1;
	...
	mov	ecx, DWORD PTR ?staticFontInfo@@3PAUFontInfo@@A
	mov	DWORD PTR [ecx+9256], -1

; 171  : 			staticFontInfo->id = staticFont->getId();

	mov	edx, DWORD PTR ?staticFont@@3PAVFont@vgui@@A
	mov	eax, DWORD PTR [edx]
	mov	ecx, DWORD PTR ?staticFont@@3PAVFont@vgui@@A
...
; 175  : 			int currentPage = 0;
	...
	mov	DWORD PTR _currentPage$11[ebp], 0
...
$LN7@drawSetTex:
	cmp	DWORD PTR _i$10[ebp], 256		; 00000100H
	jge	$LN6@drawSetTex
...
; 183  : 				staticFont->getCharABCwide( i, abcA, abcB, abcC );
	...
	lea	eax, DWORD PTR _abcC$2[ebp]
	push	eax
	lea	ecx, DWORD PTR _abcB$3[ebp]
	push	ecx
	lea	edx, DWORD PTR _abcA$1[ebp]
	push	edx
...
; 185  : 				int wide = abcB;
	...
	mov	ecx, DWORD PTR _abcB$3[ebp]
	mov	DWORD PTR _wide$5[ebp], ecx
...
; 189  : 				int tall = staticFont->getTall();
	...
	mov	eax, DWORD PTR [edx+16]
	call	eax
	mov	DWORD PTR _tall$6[ebp], eax

; 190  : 
; 191  : 				if( x + wide + 1 > FONT_SIZE )

	mov	ecx, DWORD PTR _wide$5[ebp]
...
; 194  : 					y += tall + 1;
	...
	mov	ecx, DWORD PTR _tall$6[ebp]
	mov	edx, DWORD PTR _y$9[ebp]
	lea	eax, DWORD PTR [edx+ecx+1]
...
; 199  : 					if( !staticFontInfo->bindIndex[currentPage] )
	...
	mov	ecx, DWORD PTR _currentPage$11[ebp]
	mov	edx, DWORD PTR ?staticFontInfo@@3PAUFontInfo@@A
	cmp	DWORD PTR [edx+ecx*4+1032], 0
...
; 201  : 					drawSetTextureRGBA( staticFontInfo->bindIndex[currentPage], staticRGBA, FONT_SIZE, FONT_SIZE );
	...
	push	512					; 00000200H
	push	OFFSET ?staticRGBA@@3PADA
	mov	eax, DWORD PTR _currentPage$11[ebp]
	mov	ecx, DWORD PTR ?staticFontInfo@@3PAUFontInfo@@A
...
; 202  : 					currentPage++;
	...
	mov	ecx, DWORD PTR _currentPage$11[ebp]
	add	ecx, 1
	mov	DWORD PTR _currentPage$11[ebp], ecx

; 203  : 
; 204  : 					if( currentPage == FONT_PAGES )

	cmp	DWORD PTR _currentPage$11[ebp], 8
...
; 213  : 				staticFontInfo->texCoord[i][0] = (float)((double)x / (double)FONT_SIZE );
	...
	cvtsi2sd xmm0, DWORD PTR _x$8[ebp]
...
; 214  : 				staticFontInfo->texCoord[i][1] = (float)((double)y / (double)FONT_SIZE );
	...
	cvtsi2sd xmm0, DWORD PTR _y$9[ebp]
	divsd	xmm0, QWORD PTR __real@4080000000000000
	cvtsd2ss xmm0, xmm0
	mov	eax, DWORD PTR _i$10[ebp]
	shl	eax, 5
...
_x1$ = 16						; size = 4
_y1$ = 20						; size = 4
?drawOutlinedRect@CEngineSurface@@MAEXHHHH@Z PROC	; CEngineSurface::drawOutlinedRect
; _this$ = ecx
...
_x1$ = 16						; size = 4
_y1$ = 20						; size = 4
?drawFilledRect@CEngineSurface@@MAEXHHHH@Z PROC		; CEngineSurface::drawFilledRect
; _this$ = ecx
...
_b$ = 16						; size = 4
_a$ = 20						; size = 4
?drawSetTextColor@CEngineSurface@@MAEXHHHH@Z PROC	; CEngineSurface::drawSetTextColor
; _this$ = ecx
...
_b$ = 16						; size = 4
_a$ = 20						; size = 4
?drawSetColor@CEngineSurface@@MAEXHHHH@Z PROC		; CEngineSurface::drawSetColor
; _this$ = ecx
...
_TEXT	SEGMENT
_this$ = -4						; size = 4
?createNewTextureID@CEngineSurface@@MAEHXZ PROC		; CEngineSurface::createNewTextureID
; _this$ = ecx
...
_TEXT	SEGMENT
_this$ = -4						; size = 4
?flushBuffer@CEngineSurface@@UAEXXZ PROC		; CEngineSurface::flushBuffer
; _this$ = ecx
...
; 288  : }
	...
	pop	ebp
	ret	0
?flushBuffer@CEngineSurface@@UAEXXZ ENDP		; CEngineSurface::flushBuffer
_TEXT	ENDS
; Function compile flags: /Odtp
; File c:\users\user\documents\github\xashtasks\xash_build4529_src\engine\client\vgui\vgui_main.h
...
?SetupPaintState@CEngineSurface@@QAEXPBUPaintStack@@@Z PROC ; CEngineSurface::SetupPaintState
; _this$ = ecx
...
_TEXT	SEGMENT
_this$ = -4						; size = 4
??1CEngineSurface@@QAE@XZ PROC				; CEngineSurface::~CEngineSurface
; _this$ = ecx
...
__$EHRec$ = -12						; size = 12
_embeddedPanel$ = 8					; size = 4
??0CEngineSurface@@QAE@PAVPanel@vgui@@@Z PROC		; CEngineSurface::CEngineSurface
; _this$ = ecx
...
; 48   : {
	...
	mov	ecx, DWORD PTR _this$[ebp]
	mov	DWORD PTR [ecx], OFFSET ??_7CEngineSurface@@6B@
...
; 57   : 	staticContextCount++;
	...
	mov	ecx, DWORD PTR ?staticContextCount@@3HA
	add	ecx, 1
	mov	DWORD PTR ?staticContextCount@@3HA, ecx
...
_u$ = 20						; size = 4
_v$ = 24						; size = 4
?InitVertex@CEngineSurface@@AAEXAAUvpoint_t@@HHMM@Z PROC ; CEngineSurface::InitVertex
; _this$ = ecx
