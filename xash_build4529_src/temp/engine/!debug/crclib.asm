; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27045.0 
	...
	TITLE	C:\Users\USER\Documents\GitHub\XashTasks\xash_build4529_src\engine\common\crclib.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
$SG138395 DB	'rb', 00H
	ORG $+5
$SG138397 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\common\crclib.c', 00H
	ORG $+1
$SG138398 DB	'crcvalue != NULL', 00H
	ORG $+3
$SG138430 DB	'rb', 00H
	ORG $+1
$SG138509 DB	'rb', 00H
...
; File c:\users\user\documents\github\xashtasks\xash_build4529_src\engine\common\crclib.c
_TEXT	SEGMENT
_d$ = -16						; size = 4
_c$ = -12						; size = 4
_b$ = -8						; size = 4
...
; 455  : 	MD5STEP( F1, a, b, c, d, in[0] + 0xd76aa478, 7 );
	...
	lea	edx, DWORD PTR [ecx+edx-680876936]
...
; 459  : 	MD5STEP( F1, a, b, c, d, in[4] + 0xf57c0faf, 7 );
	...
	mov	edx, DWORD PTR _a$[ebp]
	lea	eax, DWORD PTR [edx+ecx-176418897]
	mov	DWORD PTR _a$[ebp], eax
	mov	ecx, DWORD PTR _a$[ebp]
	shl	ecx, 7
	mov	edx, DWORD PTR _a$[ebp]
...
; 460  : 	MD5STEP( F1, d, a, b, c, in[5] + 0x4787c62a, 12 );
	...
	mov	eax, DWORD PTR _d$[ebp]
	lea	ecx, DWORD PTR [eax+ecx+1200080426]
	mov	DWORD PTR _d$[ebp], ecx
	mov	edx, DWORD PTR _d$[ebp]
...
; 461  : 	MD5STEP( F1, c, d, a, b, in[6] + 0xa8304613, 17 );
	...
	add	edx, DWORD PTR [eax+ecx]
	mov	ecx, DWORD PTR _c$[ebp]
	lea	edx, DWORD PTR [ecx+edx-1473231341]
	mov	DWORD PTR _c$[ebp], edx
	mov	eax, DWORD PTR _c$[ebp]
	shl	eax, 17					; 00000011H
	mov	ecx, DWORD PTR _c$[ebp]
...
; 463  : 	MD5STEP( F1, a, b, c, d, in[8] + 0x698098d8, 7 );
	...
	add	ecx, DWORD PTR [eax+edx]
	mov	edx, DWORD PTR _a$[ebp]
	lea	eax, DWORD PTR [edx+ecx+1770035416]
	mov	DWORD PTR _a$[ebp], eax
	mov	ecx, DWORD PTR _a$[ebp]
	shl	ecx, 7
	mov	edx, DWORD PTR _a$[ebp]
...
; 473  : 	MD5STEP( F2, d, a, b, c, in[6] + 0xc040b340, 9 );
	...
	add	edx, DWORD PTR [eax+ecx]
	mov	ecx, DWORD PTR _d$[ebp]
	lea	edx, DWORD PTR [ecx+edx-1069501632]
	mov	DWORD PTR _d$[ebp], edx
	mov	eax, DWORD PTR _d$[ebp]
	shl	eax, 9
	mov	ecx, DWORD PTR _d$[ebp]
...
; 475  : 	MD5STEP( F2, b, c, d, a, in[0] + 0xe9b6c7aa, 20 );
	...
	add	ecx, DWORD PTR [edx+eax]
	mov	eax, DWORD PTR _b$[ebp]
	lea	ecx, DWORD PTR [eax+ecx-373897302]
	mov	DWORD PTR _b$[ebp], ecx
	mov	edx, DWORD PTR _b$[ebp]
...
; 476  : 	MD5STEP( F2, a, b, c, d, in[5] + 0xd62f105d, 5 );
	...
	add	edx, DWORD PTR [eax+ecx]
	mov	ecx, DWORD PTR _a$[ebp]
	lea	edx, DWORD PTR [ecx+edx-701558691]
	mov	DWORD PTR _a$[ebp], edx
	mov	eax, DWORD PTR _a$[ebp]
	shl	eax, 5
	mov	ecx, DWORD PTR _a$[ebp]
...
; 478  : 	MD5STEP( F2, c, d, a, b, in[15] + 0xd8a1e681, 14 );
	...
	add	ecx, DWORD PTR [edx+eax]
	mov	eax, DWORD PTR _c$[ebp]
	lea	ecx, DWORD PTR [eax+ecx-660478335]
	mov	DWORD PTR _c$[ebp], ecx
	mov	edx, DWORD PTR _c$[ebp]
...
; 480  : 	MD5STEP( F2, a, b, c, d, in[9] + 0x21e1cde6, 5 );
	...
	add	edx, DWORD PTR [eax+ecx]
	mov	ecx, DWORD PTR _a$[ebp]
	lea	edx, DWORD PTR [ecx+edx+568446438]
	mov	DWORD PTR _a$[ebp], edx
	mov	eax, DWORD PTR _a$[ebp]
	shl	eax, 5
	mov	ecx, DWORD PTR _a$[ebp]
...
; 482  : 	MD5STEP( F2, c, d, a, b, in[3] + 0xf4d50d87, 14 );
	...
	add	ecx, DWORD PTR [edx+eax]
	mov	eax, DWORD PTR _c$[ebp]
	lea	ecx, DWORD PTR [eax+ecx-187363961]
	mov	DWORD PTR _c$[ebp], ecx
	mov	edx, DWORD PTR _c$[ebp]
	shl	edx, 14					; 0000000eH
	mov	eax, DWORD PTR _c$[ebp]
...
; 487  : 	MD5STEP( F2, b, c, d, a, in[12] + 0x8d2a4c8a, 20 );
	...
	add	ecx, DWORD PTR [edx+eax]
	mov	eax, DWORD PTR _b$[ebp]
	lea	ecx, DWORD PTR [eax+ecx-1926607734]
	mov	DWORD PTR _b$[ebp], ecx
	mov	edx, DWORD PTR _b$[ebp]
	shl	edx, 20					; 00000014H
	mov	eax, DWORD PTR _b$[ebp]
...
; 492  : 	MD5STEP( F3, b, c, d, a, in[14] + 0xfde5380c, 23 );
	...
	add	ecx, DWORD PTR [edx+eax]
	mov	eax, DWORD PTR _b$[ebp]
	lea	ecx, DWORD PTR [eax+ecx-35309556]
	mov	DWORD PTR _b$[ebp], ecx
	mov	edx, DWORD PTR _b$[ebp]
...
; 493  : 	MD5STEP( F3, a, b, c, d, in[1] + 0xa4beea44, 4 );
	...
	add	edx, DWORD PTR [ecx+eax]
	mov	eax, DWORD PTR _a$[ebp]
	lea	ecx, DWORD PTR [eax+edx-1530992060]
	mov	DWORD PTR _a$[ebp], ecx
	mov	edx, DWORD PTR _a$[ebp]
	shl	edx, 4
	mov	eax, DWORD PTR _a$[ebp]
...
; 494  : 	MD5STEP( F3, d, a, b, c, in[4] + 0x4bdecfa9, 11 );
	...
	add	edx, DWORD PTR [ecx+eax]
	mov	eax, DWORD PTR _d$[ebp]
	lea	ecx, DWORD PTR [eax+edx+1272893353]
	mov	DWORD PTR _d$[ebp], ecx
	mov	edx, DWORD PTR _d$[ebp]
...
; 504  : 	MD5STEP( F3, b, c, d, a, in[2] + 0xc4ac5665, 23 );
	...
	add	edx, DWORD PTR [ecx+eax]
	mov	eax, DWORD PTR _b$[ebp]
	lea	ecx, DWORD PTR [eax+edx-995338651]
	mov	DWORD PTR _b$[ebp], ecx
	mov	edx, DWORD PTR _b$[ebp]
	shl	edx, 23					; 00000017H
	mov	eax, DWORD PTR _b$[ebp]
...
; 506  : 	MD5STEP( F4, a, b, c, d, in[0] + 0xf4292244, 6 );
	...
	add	edx, DWORD PTR [eax+ecx]
	mov	ecx, DWORD PTR _a$[ebp]
	lea	edx, DWORD PTR [ecx+edx-198630844]
	mov	DWORD PTR _a$[ebp], edx
	mov	eax, DWORD PTR _a$[ebp]
	shl	eax, 6
	mov	ecx, DWORD PTR _a$[ebp]
...
; 508  : 	MD5STEP( F4, c, d, a, b, in[14] + 0xab9423a7, 15 );
	...
	add	ecx, DWORD PTR [edx+eax]
	mov	eax, DWORD PTR _c$[ebp]
	lea	ecx, DWORD PTR [eax+ecx-1416354905]
	mov	DWORD PTR _c$[ebp], ecx
	mov	edx, DWORD PTR _c$[ebp]
...
; 509  : 	MD5STEP( F4, b, c, d, a, in[5] + 0xfc93a039, 21 );
	...
	add	edx, DWORD PTR [eax+ecx]
	mov	ecx, DWORD PTR _b$[ebp]
	lea	edx, DWORD PTR [ecx+edx-57434055]
	mov	DWORD PTR _b$[ebp], edx
	mov	eax, DWORD PTR _b$[ebp]
...
; 511  : 	MD5STEP( F4, d, a, b, c, in[3] + 0x8f0ccc92, 10 );
	...
	add	ecx, DWORD PTR [edx+eax]
	mov	eax, DWORD PTR _d$[ebp]
	lea	ecx, DWORD PTR [eax+ecx-1894986606]
	mov	DWORD PTR _d$[ebp], ecx
	mov	edx, DWORD PTR _d$[ebp]
...
; 512  : 	MD5STEP( F4, c, d, a, b, in[10] + 0xffeff47d, 15 );
	...
	add	edx, DWORD PTR [eax+ecx]
	mov	ecx, DWORD PTR _c$[ebp]
	lea	edx, DWORD PTR [ecx+edx-1051523]
	mov	DWORD PTR _c$[ebp], edx
	mov	eax, DWORD PTR _c$[ebp]
...
; 520  : 	MD5STEP( F4, c, d, a, b, in[2] + 0x2ad7d2bb, 15 );
	...
	add	ecx, DWORD PTR [eax+edx]
	mov	edx, DWORD PTR _c$[ebp]
	lea	eax, DWORD PTR [edx+ecx+718787259]
	mov	DWORD PTR _c$[ebp], eax
	mov	ecx, DWORD PTR _c$[ebp]
...
; 521  : 	MD5STEP( F4, b, c, d, a, in[9] + 0xeb86d391, 21 );
	...
	add	ecx, DWORD PTR [edx+eax]
	mov	eax, DWORD PTR _b$[ebp]
	lea	ecx, DWORD PTR [eax+ecx-343485551]
	mov	DWORD PTR _b$[ebp], ecx
	mov	edx, DWORD PTR _b$[ebp]
...
; 583  : 		Q_strncat( szReturn, szChunk, sizeof( szReturn ));
	...
	push	64					; 00000040H
	lea	ecx, DWORD PTR _szChunk$[ebp]
	push	ecx
	push	OFFSET ?szReturn@?1??MD5_Print@@9@9
	call	_Q_strncat
	add	esp, 12					; 0000000cH
...
; 321  : 	ctx->buf[3] = 0x10325476;
	...
	imul	edx, ecx, 3
	mov	eax, DWORD PTR _ctx$[ebp]
	mov	DWORD PTR [eax+edx], 271733878		; 10325476H
...
; File c:\users\user\documents\github\xashtasks\xash_build4529_src\engine\common\crclib.c
_TEXT	SEGMENT
_version$ = -2084					; size = 4
_hdr_size$ = -2080					; size = 4
_header$ = -2076					; size = 4
tv84 = -2072						; size = 4
_lumplen$ = -2068					; size = 4
_i$ = -2064						; size = 4
_num_bytes$ = -2060					; size = 4
_f$ = -2056						; size = 4
_headbuf$ = -2052					; size = 1024
_buffer$ = -1028					; size = 1024
__$ArrayPad$ = -4					; size = 4
_crcvalue$ = 8						; size = 4
_filename$ = 12						; size = 4
...
; 232  : 	char	headbuf[1024], buffer[1024];
...
; 255  : 	num_bytes = FS_Read( f, headbuf, hdr_size );
	...
	mov	edx, DWORD PTR _hdr_size$[ebp]
	push	edx
...
; 258  : 	if( num_bytes != hdr_size )
	...
	mov	edx, DWORD PTR _num_bytes$[ebp]
	cmp	edx, DWORD PTR _hdr_size$[ebp]
...
; 267  : 	switch( header->version )
	...
	jl	SHORT $LN14@CRC32_MapF
	cmp	DWORD PTR tv84[ebp], 30			; 0000001eH
	jle	SHORT $LN13@CRC32_MapF
	cmp	DWORD PTR tv84[ebp], 844124994		; 32505342H
	je	SHORT $LN13@CRC32_MapF
	jmp	SHORT $LN14@CRC32_MapF
$LN13@CRC32_MapF:
...
; 291  : 			if( num_bytes > 0 )
	...
	jle	SHORT $LN17@CRC32_MapF

; 292  : 			{
; 293  : 				lumplen -= num_bytes;

	mov	ecx, DWORD PTR _lumplen$[ebp]
	sub	ecx, DWORD PTR _num_bytes$[ebp]
...
; 105  : 	ulCrc ^= ch;
	...
	xor	edx, DWORD PTR _ulCrc$[ebp]
	mov	DWORD PTR _ulCrc$[ebp], edx
...
; 119  : 	case 7: ulCrc  = crc32table[*pb++ ^ (byte)ulCrc] ^ (ulCrc >> 8);
	...
	movzx	ecx, BYTE PTR _ulCrc$[ebp]
	xor	eax, ecx
	mov	edx, DWORD PTR _ulCrc$[ebp]
	shr	edx, 8
	xor	edx, DWORD PTR _crc32table[eax*4]
	mov	DWORD PTR _ulCrc$[ebp], edx
...
; 120  : 	case 6: ulCrc  = crc32table[*pb++ ^ (byte)ulCrc] ^ (ulCrc >> 8);
	...
	mov	ecx, DWORD PTR _ulCrc$[ebp]
	shr	ecx, 8
	xor	ecx, DWORD PTR _crc32table[edx*4]
	mov	DWORD PTR _ulCrc$[ebp], ecx
	mov	edx, DWORD PTR _pb$[ebp]
	add	edx, 1
	mov	DWORD PTR _pb$[ebp], edx
...
; 124  : 		ulCrc  = crc32table[(byte)ulCrc] ^ (ulCrc >> 8);
	...
	mov	edx, DWORD PTR _ulCrc$[ebp]
	shr	edx, 8
	xor	edx, DWORD PTR _crc32table[ecx*4]
	mov	DWORD PTR _ulCrc$[ebp], edx
...
; 126  : 		ulCrc  = crc32table[(byte)ulCrc] ^ (ulCrc >> 8);
	...
	mov	eax, DWORD PTR _ulCrc$[ebp]
	shr	eax, 8
	xor	eax, DWORD PTR _crc32table[edx*4]
	mov	DWORD PTR _ulCrc$[ebp], eax
...
; 141  : 	nFront = ((uint)pb) & 3;
	...
	mov	ecx, DWORD PTR _pb$[ebp]
	and	ecx, 3
	mov	DWORD PTR _nFront$[ebp], ecx

; 142  : 	nBuffer -= nFront;

	mov	edx, DWORD PTR _nBuffer$[ebp]
	sub	edx, DWORD PTR _nFront$[ebp]
	mov	DWORD PTR _nBuffer$[ebp], edx
...
; 167  : 	nBuffer &= 7;
	...
	mov	ecx, DWORD PTR _nBuffer$[ebp]
	and	ecx, 7
	mov	DWORD PTR _nBuffer$[ebp], ecx
...
; 191  : 	buffer[length+1] = ptr[1];
	...
	mov	BYTE PTR _buffer$[ebp+edx+1], cl
...
; 192  : 	buffer[length+2] = ptr[2];
	...
	mov	BYTE PTR _buffer$[ebp+eax+2], dl
