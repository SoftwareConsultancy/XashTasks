; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27045.0 
	...
	TITLE	C:\Users\USER\Downloads\xash_build4529_src\engine\client\gl_alias.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
$SG144888 DB	'%s:frame%i', 00H
	ORG $+1
$SG144796 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\gl_alias.c', 00H
$SG144866 DB	'player', 00H
	ORG $+5
$SG144867 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\gl_alias.c', 00H
	ORG $+4
$SG144868 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\gl_alias.c', 00H
...
$SG145007 DB	'^1Error:^7 %s has wrong version number (%i should be %i)'
	DB	0aH, 00H
	ORG $+2
$SG145010 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\gl_alias.c', 00H
$SG145011 DB	'^2%s^7', 00H
	ORG $+5
$SG145012 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\gl_alias.c', 00H
$SG145014 DB	'^1Error:^7 model %s has too many vertices', 0aH, 00H
	ORG $+1
$SG145032 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\gl_alias.c', 00H
$SG145033 DB	'mod != NULL', 00H
$SG145037 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\gl_alias.c', 00H
$SG145222 DB	'^3Warning:^7 R_GetAliasFrame: no such frame %d (%s)', 0aH
	DB	00H
_DATA	ENDS
; Function compile flags: /Odtp
; File c:\users\user\downloads\xash_build4529_src\engine\client\gl_alias.c
_TEXT	SEGMENT
