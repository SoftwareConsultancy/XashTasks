; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27045.0 
	...
	TITLE	C:\Users\USER\Documents\GitHub\XashTasks\xash_build4529_src\engine\client\cl_demo.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
_demo_cmd DD	FLAT:$SG143551
	...
	DD	FLAT:$SG143556
	DD	FLAT:$SG143557
$SG143551 DB	'dem_unknown', 00H
$SG143552 DB	'dem_norewind', 00H
	ORG $+3
$SG143553 DB	'dem_read', 00H
	ORG $+3
$SG143554 DB	'dem_jumptime', 00H
	ORG $+3
$SG143555 DB	'dem_userdata', 00H
	ORG $+3
$SG143556 DB	'dem_usercmd', 00H
$SG143557 DB	'dem_stop', 00H
_DATA	ENDS
...
_DATA	SEGMENT
	ORG $+3
$SG143601 DB	'w+b', 00H
$SG143602 DB	'demoheader.tmp', 00H
	ORG $+1
$SG143604 DB	'^1Error:^7 couldn''t open temporary header file.', 0aH, 00H
	ORG $+3
$SG143605 DB	'Spooling demo header.', 0aH, 00H
	ORG $+1
$SG143647 DB	'UserCmd', 00H
$SG143696 DB	'recording to %s.', 0aH, 00H
	ORG $+2
$SG143629 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\client\cl_demo.c', 00H
$SG143630 DB	'cmd >= 1 && cmd <= dem_lastcmd', 00H
	ORG $+1
$SG143697 DB	'wb', 00H
	ORG $+1
$SG143661 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\client\cl_demo.c', 00H
$SG143662 DB	'file != NULL', 00H
	ORG $+3
$SG143699 DB	'^1Error:^7 couldn''t open %s.', 0aH, 00H
	ORG $+2
$SG143702 DB	'fullupdate', 0aH, 00H
$SG143700 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\client\cl_demo.c', 00H
$SG143743 DB	'*cmd >= 1 && *cmd <= dem_lastcmd', 00H
	ORG $+3
$SG143719 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\client\cl_demo.c', 00H
$SG143720 DB	'Completed demo', 0aH, 'Recording time: %02d:%02d, frames'
	DB	' %i', 0aH, 00H
	ORG $+3
$SG143732 DB	'^1RECORDING:^7 %s: %s time: %02d:%02d', 00H
	ORG $+2
$SG143760 DB	'UserCmd', 00H
$SG143788 DB	'net_qport', 00H
	ORG $+2
$SG143742 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\client\cl_demo.c', 00H
$SG143794 DB	'v_dark', 00H
	ORG $+1
$SG143799 DB	'v_dark', 00H
	ORG $+1
$SG143821 DB	'^1Error:^7 Demo message length < 0', 0aH, 00H
$SG143816 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\client\cl_demo.c', 00H
$SG143817 DB	'buffer != NULL', 00H
	ORG $+1
$SG143823 DB	'^1Error:^7 Demo message %i > %i', 0aH, 00H
	ORG $+3
$SG143818 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\client\cl_demo.c', 00H
$SG143819 DB	'length != NULL', 00H
	ORG $+1
$SG143826 DB	'^1Error:^7 Error reading demo message data', 0aH, 00H
$SG143849 DB	'^1Error:^7 Demo message length < 0', 0aH, 00H
$SG143851 DB	'^1Error:^7 Demo message %i > %i', 0aH, 00H
	ORG $+3
$SG143854 DB	'^1Error:^7 Error reading demo message data', 0aH, 00H
$SG143951 DB	'%i frames %5.3f seconds %5.3f fps', 0aH, 00H
	ORG $+1
$SG143894 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\client\cl_demo.c', 00H
$SG143964 DB	'0', 00H
	ORG $+2
$SG143896 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\client\cl_demo.c', 00H
$SG143984 DB	'rb', 00H
	ORG $+1
$SG143960 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\client\cl_demo.c', 00H
$SG143965 DB	'cl_background', 00H
	ORG $+2
$SG143988 DB	'<corrupted>', 00H
$SG143991 DB	'<invalid protocol>', 00H
	ORG $+1
$SG143994 DB	'<corrupted>', 00H
$SG143995 DB	'%g sec', 00H
	ORG $+1
$SG144003 DB	'no demos listed with startdemos', 0aH, 00H
	ORG $+3
$SG144004 DB	'playdemo %s', 0aH, 00H
	ORG $+3
$SG144011 DB	'v_dark', 00H
	ORG $+1
$SG144024 DB	'demo9999', 00H
	ORG $+3
$SG144025 DB	'demo%i%i%i%i', 00H
	ORG $+3
$SG144037 DB	'new', 00H
$SG144040 DB	'Usage: record <demoname>', 0aH, 00H
	ORG $+2
$SG144042 DB	'Already recording.', 0aH, 00H
$SG144044 DB	'Can''t record during demo playback.', 0aH, 00H
$SG144047 DB	'You must be in a level to record.', 0aH, 00H
	ORG $+1
$SG144050 DB	'new', 00H
$SG144052 DB	'%s.dem', 00H
	ORG $+1
$SG144054 DB	'^1Error:^7 no free slots for demo recording', 0aH, 00H
	ORG $+3
$SG144055 DB	'%s.dem', 00H
	ORG $+1
$SG144076 DB	'Usage: playdemo <demoname>', 0aH, 00H
$SG144079 DB	'Can''t playback during demo record.', 0aH, 00H
$SG144080 DB	'%s.dem', 00H
	ORG $+1
$SG144083 DB	'lastdemo', 00H
	ORG $+3
$SG144085 DB	'^1Error:^7 couldn''t open %s', 0aH, 00H
	ORG $+3
$SG144086 DB	'rb', 00H
	ORG $+1
$SG144092 DB	'^1Error:^7 %s is not a demo file', 0aH, 00H
	ORG $+2
$SG144096 DB	'^1Error:^7 playdemo: demo protocol outdated (%i should b'
	DB	'e %i)', 0aH, 00H
	ORG $+1
$SG144098 DB	'^1Error:^7 playdemo: net protocol outdated (%i should be'
	DB	' %i)', 0aH, 00H
	ORG $+2
$SG144101 DB	'^1Error:^7 demo had bogus # of directory entries: %i', 0aH
	DB	00H
	ORG $+2
$SG144106 DB	'Usage: timedemo <demoname>', 0aH, 00H
$SG144102 DB	'c:\users\user\documents\github\xashtasks\xash_build4529_'
	DB	'src\engine\client\cl_demo.c', 00H
$SG144115 DB	'''startdemos'' is not valid from the console', 0aH, 00H
$SG144117 DB	'^3Warning:^7 Host_StartDemos: max %i demos in demoloop', 0aH
	DB	00H
$SG144118 DB	's', 00H
	ORG $+2
$SG144120 DB	'%i demo%s in loop', 0aH, 00H
	ORG $+1
$SG144124 DB	'''demos'' is not valid from the console', 0aH, 00H
_DATA	ENDS
; Function compile flags: /Odtp
; File c:\users\user\documents\github\xashtasks\xash_build4529_src\engine\client\cl_demo.c
_TEXT	SEGMENT
_d$ = -16						; size = 4
_a$ = -12						; size = 4
_b$ = -8						; size = 4
...
; 1108 : 	time = host.realtime - cls.td_starttime;
	...
	subsd	xmm0, QWORD PTR _cls+287360
...
_prev$ = 16						; size = 4
_next$ = 20						; size = 4
_CL_DemoFindInterpolatedViewAngles PROC
...
; 1019 : 			at = demo.cmds[imod & ANGLE_MASK].starttime;
	...
	and	edx, 15					; 0000000fH
	shl	edx, 4
	movss	xmm0, DWORD PTR _demo[edx+260]
...
; 811  : 				cls.td_starttime = host.realtime;
	...
	movsd	xmm0, QWORD PTR _host+1440
	movsd	QWORD PTR _cls+287360, xmm0
$LN6@CL_DemoRea:
...
; 835  : 		a = &demo.cmds[demo.angle_position];
	...
	mov	ecx, DWORD PTR _demo+516
	shl	ecx, 4
	add	ecx, OFFSET _demo+260
...
; 867  : 	cls.netchan.last_received = host.realtime;
	...
	movsd	xmm0, QWORD PTR _host+1440
	movsd	QWORD PTR _cls+23552, xmm0

; 868  : 	cls.netchan.total_received += msglen;

	mov	edx, DWORD PTR _cls+287316
	add	edx, DWORD PTR _msglen$[ebp]
	mov	DWORD PTR _cls+287316, edx
...
; 774  : 	cls.netchan.total_received += msglen;
	...
	mov	eax, DWORD PTR _cls+287316
	add	eax, DWORD PTR _msglen$[ebp]
	mov	DWORD PTR _cls+287316, eax
...
; File c:\users\user\documents\github\xashtasks\xash_build4529_src\engine\client\cl_demo.c
_TEXT	SEGMENT
_CL_DemoMoveToNextSection PROC
...
; 727  : 	demo.entry = &demo.directory.entries[demo.entryIndex];
	...
	imul	edx, DWORD PTR _demo+256, 88
	add	edx, DWORD PTR _demo+228
	mov	DWORD PTR _demo+224, edx
...
; 679  : 	if( cls.demofile )
	...
	cmp	DWORD PTR _cls+297860, 0
	je	SHORT $LN2@CL_DemoAbo

; 680  : 		FS_Close( cls.demofile );

	mov	eax, DWORD PTR _cls+297860
	push	eax
	call	_FS_Close
	add	esp, 4
$LN2@CL_DemoAbo:
...
; 611  : 	FS_Read( cls.demofile, &incoming_acknowledged, sizeof( int ));
	...
	push	4
	lea	edx, DWORD PTR _incoming_acknowledged$[ebp]
	push	edx
	mov	eax, DWORD PTR _cls+297860
	push	eax
	call	_FS_Read
...
; 612  : 	FS_Read( cls.demofile, &incoming_reliable_acknowledged, sizeof( int ));
	...
	push	4
	lea	ecx, DWORD PTR _incoming_reliable_acknowledged$[ebp]
	push	ecx
	mov	edx, DWORD PTR _cls+297860
	push	edx
	call	_FS_Read
...
; 614  : 	FS_Read( cls.demofile, &outgoing_sequence, sizeof( int ));
	...
	push	4
	lea	edx, DWORD PTR _outgoing_sequence$[ebp]
	push	edx
	mov	eax, DWORD PTR _cls+297860
	push	eax
	call	_FS_Read
...
; 615  : 	FS_Read( cls.demofile, &reliable_sequence, sizeof( int ));
	...
	push	4
	lea	ecx, DWORD PTR _reliable_sequence$[ebp]
	push	ecx
	mov	edx, DWORD PTR _cls+297860
	push	edx
	call	_FS_Read
...
_TEXT	SEGMENT
_buf$1 = -1120						; size = 20
_outgoing_sequence$ = -1100				; size = 4
_cmdnumber$ = -1096					; size = 4
_bytes$ = -1092						; size = 2
_a$2 = -1088						; size = 4
_pcmd$ = -1084						; size = 4
_nullcmd$3 = -1080					; size = 52
_data$ = -1028						; size = 1024
__$ArrayPad$ = -4					; size = 4
_discard$ = 8						; size = 4
_CL_ReadDemoUserCmd PROC
...
; 547  : 	FS_Read( cls.demofile, &cmdnumber, sizeof( int ));
	...
	push	4
	lea	edx, DWORD PTR _cmdnumber$[ebp]
	push	edx
	mov	eax, DWORD PTR _cls+297860
	push	eax
	call	_FS_Read
...
; 569  : 		cl.cmd = &pcmd->cmd;
	...
	mov	DWORD PTR _cl+1568604, edx

; 570  : 
; 571  : 		MSG_ReadDeltaUsercmd( &buf, &nullcmd, cl.cmd );

	mov	eax, DWORD PTR _cl+1568604
	push	eax
...
; 589  : 		cls.netchan.outgoing_sequence = outgoing_sequence;
	...
	mov	ecx, DWORD PTR _outgoing_sequence$[ebp]
	mov	DWORD PTR _cls+23600, ecx
$LN2@CL_ReadDem:
...
$LN4@CL_ReadDem:
	push	0
	push	524					; 0000020cH
	push	OFFSET $SG143742
	push	OFFSET $SG143743
...
; 383  : 	demo.directory.entries = Mem_Calloc( cls.mempool, sizeof( demoentry_t ) * demo.directory.numentries );
	...
	push	383					; 0000017fH
	push	OFFSET $SG143700
	push	1
	imul	edx, DWORD PTR _demo+232, 88
	push	edx
...
; 407  : 	cls.td_startframe = host.framecount;
	...
	mov	edx, DWORD PTR _host+1464
	mov	DWORD PTR _cls+287356, edx

; 408  : 	cls.td_lastframe = -1;			// get a new message this frame

	mov	DWORD PTR _cls+287352, -1
...
$LN4@CL_WriteDe:
	push	0
	push	271					; 0000010fH
	push	OFFSET $SG143661
	push	OFFSET $SG143662
	mov	eax, DWORD PTR tv69[ebp]
	push	eax
	call	_DBG_AssertFunction
	add	esp, 20					; 00000014H
...
; 1341 : 		name = "new";
	...
	mov	DWORD PTR _name$[ebp], OFFSET $SG144037
...
; 1376 : 			CL_DemoGetName( n, demoname );
	...
	lea	edx, DWORD PTR _demoname$[ebp]
	push	edx
...
; 1390 : 	Q_sprintf( demopath, "%s.dem", demoname );
	...
	lea	edx, DWORD PTR _demopath$[ebp]
	push	edx
	call	_Q_sprintf
	add	esp, 12					; 0000000cH
...
; 1577 : 	Con_Printf( "%i demo%s in loop\n", c, (c > 1) ? "s" : "" );
	...
	mov	DWORD PTR tv72[ebp], OFFSET $SG144118
	jmp	SHORT $LN9@CL_StartDe
$LN8@CL_StartDe:
	mov	DWORD PTR tv72[ebp], OFFSET $SG144119
$LN9@CL_StartDe:
...
_c$2 = -140						; size = 4
_i$ = -136						; size = 4
_filename$ = -132					; size = 64
_demoname$ = -68					; size = 64
__$ArrayPad$ = -4					; size = 4
_CL_PlayDemo_f PROC
...
; 1469 : 			else cls.forcetrack = cls.forcetrack * 10 + (c - '0');
	...
	imul	ecx, DWORD PTR _cls+287368, 10
	mov	edx, DWORD PTR _c$2[ebp]
	lea	eax, DWORD PTR [ecx+edx-48]
	mov	DWORD PTR _cls+287368, eax
$LN15@CL_PlayDem:
...
; 1518 : 	demo.entry = &demo.directory.entries[demo.entryIndex];
	...
	imul	ecx, DWORD PTR _demo+256, 88
	add	ecx, DWORD PTR _demo+228
	mov	DWORD PTR _demo+224, ecx
...
; 472  : 	cls.demorecording = false;
	...
	mov	DWORD PTR _cls+297576, 0

; 473  : 	cls.demoname[0] = '\0';

	mov	eax, 1
	imul	ecx, eax, 0
	mov	BYTE PTR _cls[ecx+297592], 0
...
_q1$3 = -20						; size = 16
__$ArrayPad$ = -4					; size = 4
_CL_DemoInterpolateAngles PROC
...
; 918  : 		if( !cls.timedemo ) bSkipMessage = ((demo.timestamp - cl_serverframetime()) >= fElapsedTime) ? true : false;
	...
	mov	eax, 8
	shl	eax, 0
	movsd	xmm1, QWORD PTR _cl[edx+32]
	subsd	xmm1, QWORD PTR _cl[eax+32]
	subsd	xmm0, xmm1
...
$LN31@CL_DemoRea:
	...
	mov	DWORD PTR _bSkipMessage$1[ebp], ecx
$LN13@CL_DemoRea:
...
; 956  : 			FS_Read( cls.demofile, userbuf, size );
	...
	push	ecx
	mov	edx, DWORD PTR _userbuf$[ebp]
	push	edx
	mov	eax, DWORD PTR _cls+297860
	push	eax
	call	_FS_Read
...
; 975  : 	if( cls.timedemo && ( tdlastdemoframe == host.framecount ))
	...
	mov	edx, DWORD PTR ?tdlastdemoframe@?1??CL_DemoReadMessage@@9@9
	cmp	edx, DWORD PTR _host+1464
...
; 981  : 	tdlastdemoframe = host.framecount;
	...
	mov	edx, DWORD PTR _host+1464
	mov	DWORD PTR ?tdlastdemoframe@?1??CL_DemoReadMessage@@9@9, edx
...
; 125  : 	cls.demoheader = FS_Open( "demoheader.tmp", "w+b", true );
	...
	push	1
	push	OFFSET $SG143601
	push	OFFSET $SG143602
	call	_FS_Open
	add	esp, 12					; 0000000cH
	mov	DWORD PTR _cls+297864, eax
...
; 1250 : 	if( !cls.demos[cls.demonum][0] || cls.demonum == MAX_DEMOS )
	...
	mov	eax, DWORD PTR _cls+293464
	shl	eax, 6
	mov	ecx, 1
	imul	edx, ecx, 0
	movsx	eax, BYTE PTR _cls[eax+edx+293472]
	test	eax, eax
	je	SHORT $LN4@CL_NextDem
	cmp	DWORD PTR _cls+293464, 32		; 00000020H
...
; 1253 : 		if( !cls.demos[cls.demonum][0] )
	...
	mov	ecx, DWORD PTR _cls+293464
	shl	ecx, 6
	mov	edx, 1
	imul	eax, edx, 0
	movsx	ecx, BYTE PTR _cls[ecx+eax+293472]
	test	ecx, ecx
	jne	SHORT $LN3@CL_NextDem
...
; File c:\users\user\documents\github\xashtasks\xash_build4529_src\engine\client\cl_demo.c
_TEXT	SEGMENT
_directory$ = -336					; size = 8
_playtime$ = -328					; size = 4
_i$ = -324						; size = 4
_demfile$ = -320					; size = 4
_entry$ = -316						; size = 88
_demohdr$ = -228					; size = 224
__$ArrayPad$ = -4					; size = 4
_demoname$ = 8						; size = 4
_comment$ = 12						; size = 4
_CL_GetDemoComment PROC
...
; 1191 : 	FS_Read( demfile, &demohdr, sizeof( demoheader_t ));
	...
	push	224					; 000000e0H
	lea	edx, DWORD PTR _demohdr$[ebp]
	push	edx
...
; 1208 : 	FS_Seek( demfile, demohdr.directory_offset, SEEK_SET );
	...
	push	0
	mov	edx, DWORD PTR _demohdr$[ebp+216]
	push	edx
	mov	eax, DWORD PTR _demfile$[ebp]
	push	eax
	call	_FS_Seek
...
; 1209 : 	FS_Read( demfile, &directory.numentries, sizeof( int ));
	...
	push	4
	lea	ecx, DWORD PTR _directory$[ebp+4]
	push	ecx
	mov	edx, DWORD PTR _demfile$[ebp]
	push	edx
	call	_FS_Read
	add	esp, 12					; 0000000cH
...
; 1226 : 	Q_strncpy( comment + CS_SIZE, demohdr.comment, CS_SIZE );
	...
	push	64					; 00000040H
	lea	edx, DWORD PTR _demohdr$[ebp+88]
	push	edx
