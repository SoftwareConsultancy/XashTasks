; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27045.0 
	...
	TITLE	C:\Users\USER\Downloads\xash_build4529_src\engine\client\cl_demo.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
$SG143696 DB	'recording to %s.', 0aH, 00H
	ORG $+2
$SG143629 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\cl_demo.c', 00H
	ORG $+1
...
$SG143697 DB	'wb', 00H
	ORG $+1
$SG143661 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\cl_demo.c', 00H
	ORG $+1
...
$SG143700 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\cl_demo.c', 00H
	ORG $+1
$SG143743 DB	'*cmd >= 1 && *cmd <= dem_lastcmd', 00H
	ORG $+3
$SG143719 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\cl_demo.c', 00H
	ORG $+1
...
$SG143788 DB	'net_qport', 00H
	ORG $+2
$SG143742 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\cl_demo.c', 00H
	ORG $+1
...
$SG143816 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\cl_demo.c', 00H
	ORG $+1
...
$SG143823 DB	'^1Error:^7 Demo message %i > %i', 0aH, 00H
	ORG $+3
$SG143818 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\cl_demo.c', 00H
	ORG $+1
...
$SG143951 DB	'%i frames %5.3f seconds %5.3f fps', 0aH, 00H
	ORG $+1
$SG143894 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\cl_demo.c', 00H
	ORG $+1
$SG143964 DB	'0', 00H
	ORG $+2
$SG143896 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\cl_demo.c', 00H
	ORG $+1
$SG143984 DB	'rb', 00H
	ORG $+1
$SG143960 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\cl_demo.c', 00H
	ORG $+1
...
; File c:\users\user\downloads\xash_build4529_src\engine\client\cl_demo.c
_TEXT	SEGMENT
_d$ = -16						; size = 4
_a$ = -12						; size = 4
_b$ = -8						; size = 4
