; Listing generated by Microsoft (R) Optimizing Compiler Version 19.16.27045.0 
	...
	TITLE	C:\Users\USER\Downloads\xash_build4529_src\engine\client\gl_rmain.c
	.686P
	.XMM
	include listing.inc
	.model	flat
...
$SG143823 DB	'RI.currententity != NULL', 00H
	ORG $+3
$SG143821 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\gl_rmain.c', 00H
$SG143833 DB	'RI.currententity != NULL', 00H
	ORG $+3
$SG143822 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\gl_rmain.c', 00H
$SG143846 DB	'RI.currententity != NULL', 00H
	ORG $+3
$SG143824 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\gl_rmain.c', 00H
$SG143825 DB	'RI.currentmodel != NULL', 00H
$SG143940 DB	'arg >= 0 && arg < 6', 00H
$SG143830 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\gl_rmain.c', 00H
$SG144015 DB	'Sky', 00H
$SG143831 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\gl_rmain.c', 00H
$SG144016 DB	'Env', 00H
$SG143832 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\gl_rmain.c', 00H
$SG144056 DB	'number >= 0 && number < MAX_DLIGHTS', 00H
$SG143834 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\gl_rmain.c', 00H
$SG143835 DB	'RI.currentmodel != NULL', 00H
$SG144063 DB	'number >= 0 && number < MAX_ELIGHTS', 00H
$SG143837 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\gl_rmain.c', 00H
$SG144140 DB	'CL_LoadProgs: ^2initailized extended RenderAPI ^7ver. %i'
	DB	0aH, 00H
	ORG $+2
$SG143839 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\gl_rmain.c', 00H
	ORG $+4
$SG143841 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\gl_rmain.c', 00H
	ORG $+4
$SG143845 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\gl_rmain.c', 00H
	ORG $+4
$SG143847 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\gl_rmain.c', 00H
$SG143848 DB	'RI.currentmodel != NULL', 00H
	ORG $+4
$SG143854 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\gl_rmain.c', 00H
	ORG $+4
$SG143856 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\gl_rmain.c', 00H
	ORG $+4
$SG143858 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\gl_rmain.c', 00H
	ORG $+4
$SG143860 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\gl_rmain.c', 00H
...
$SG143907 DB	'failed to swap buffers', 0aH, 'Check your video driver a'
	...
	ORG $+1
$SG143939 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\gl_rmain.c', 00H
$SG144017 DB	'^1Error:^7 R_%sShot: subsystem is busy, try for next fra'
	DB	'me.', 0aH, 00H
	ORG $+7
$SG144048 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\gl_rmain.c', 00H
$SG144049 DB	'number >= 0 && number < MAX_LIGHTSTYLES', 00H
	ORG $+4
$SG144055 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\gl_rmain.c', 00H
	ORG $+4
$SG144062 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\gl_rmain.c', 00H
	ORG $+4
$SG144111 DB	'c:\users\user\downloads\xash_build4529_src\engine\client'
	DB	'\gl_rmain.c', 00H
	ORG $+4
...
; File c:\users\user\downloads\xash_build4529_src\engine\client\gl_rmain.c
_TEXT	SEGMENT
_fileindex$ = 8						; size = 4
