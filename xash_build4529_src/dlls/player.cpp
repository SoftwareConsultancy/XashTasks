...
int CBasePlayer::Save( CSave &save )
{
	...
	return save.WriteFields( "PLAYER", this, m_playerSaveData, ARRAYSIZE_XASH(m_playerSaveData) );
}
...
int CBasePlayer::Restore( CRestore &restore )
{
	...
	int status = restore.ReadFields( "PLAYER", this, m_playerSaveData, ARRAYSIZE_XASH(m_playerSaveData) );
