...
Schedule_t	slGruntCombatFail[] =
{
	{
		tlGruntCombatFail,
		ARRAYSIZE_XASH ( tlGruntCombatFail ),
		bits_COND_CAN_RANGE_ATTACK1	|
		bits_COND_CAN_RANGE_ATTACK2,
		0,
		"Grunt Combat Fail"
...
Schedule_t	slGruntVictoryDance[] =
{
	{ 
		tlGruntVictoryDance,
		ARRAYSIZE_XASH ( tlGruntVictoryDance ), 
		bits_COND_NEW_ENEMY		|
...
Schedule_t slGruntEstablishLineOfFire[] =
{
	{ 
		...
		ARRAYSIZE_XASH ( tlGruntEstablishLineOfFire ),
		bits_COND_NEW_ENEMY			|
...
Schedule_t	slGruntFoundEnemy[] =
{
	{ 
		tlGruntFoundEnemy,
		ARRAYSIZE_XASH ( tlGruntFoundEnemy ), 
		bits_COND_HEAR_SOUND,
...
Schedule_t	slGruntCombatFace[] =
{
	{ 
		tlGruntCombatFace1,
		ARRAYSIZE_XASH ( tlGruntCombatFace1 ), 
		bits_COND_NEW_ENEMY				|
		bits_COND_ENEMY_DEAD			|
		bits_COND_CAN_RANGE_ATTACK1		|
		bits_COND_CAN_RANGE_ATTACK2,
...
Schedule_t	slGruntSignalSuppress[] =
{
	{ 
		...
		ARRAYSIZE_XASH ( tlGruntSignalSuppress ), 
		bits_COND_ENEMY_DEAD		|
		bits_COND_LIGHT_DAMAGE		|
		bits_COND_HEAVY_DAMAGE		|
		bits_COND_HEAR_SOUND		|
...
Schedule_t	slGruntSuppress[] =
{
	{ 
		tlGruntSuppress,
		ARRAYSIZE_XASH ( tlGruntSuppress ), 
		bits_COND_ENEMY_DEAD		|
		bits_COND_LIGHT_DAMAGE		|
		bits_COND_HEAVY_DAMAGE		|
		bits_COND_HEAR_SOUND		|
...
Schedule_t	slGruntWaitInCover[] =
{
	{ 
		tlGruntWaitInCover,
		ARRAYSIZE_XASH ( tlGruntWaitInCover ), 
		bits_COND_NEW_ENEMY			|
		bits_COND_HEAR_SOUND		|
		bits_COND_CAN_RANGE_ATTACK1	|
		bits_COND_CAN_RANGE_ATTACK2	|
...
Schedule_t	slGruntTakeCover[] =
{
	{ 
		tlGruntTakeCover1,
		ARRAYSIZE_XASH ( tlGruntTakeCover1 ), 
		0,
		0,
		"TakeCover"
	},
...
Schedule_t	slGruntGrenadeCover[] =
{
	{ 
		...
		ARRAYSIZE_XASH ( tlGruntGrenadeCover1 ), 
		0,
		0,
		"GrenadeCover"
	},
...
Schedule_t	slGruntTossGrenadeCover[] =
{
	{ 
		...
		ARRAYSIZE_XASH ( tlGruntTossGrenadeCover1 ), 
		0,
		0,
		"TossGrenadeCover"
	},
...
Schedule_t	slGruntTakeCoverFromBestSound[] =
{
	{ 
		...
		ARRAYSIZE_XASH ( tlGruntTakeCoverFromBestSound ), 
		0,
		0,
...
Schedule_t slGruntHideReload[] = 
{
	{
		tlGruntHideReload,
		ARRAYSIZE_XASH ( tlGruntHideReload ),
		bits_COND_HEAVY_DAMAGE	|
		bits_COND_HEAR_SOUND,
...
Schedule_t	slGruntRangeAttack1A[] =
{
	{ 
		...
		ARRAYSIZE_XASH ( tlGruntRangeAttack1A ), 
		bits_COND_NEW_ENEMY			|
		bits_COND_ENEMY_DEAD		|
		bits_COND_HEAVY_DAMAGE		|
...
Schedule_t	slGruntRangeAttack1B[] =
{
	{ 
		...
		ARRAYSIZE_XASH ( tlGruntRangeAttack1B ), 
		bits_COND_NEW_ENEMY			|
		bits_COND_ENEMY_DEAD		|
		bits_COND_HEAVY_DAMAGE		|
		bits_COND_ENEMY_OCCLUDED	|
...
Schedule_t	slGruntRangeAttack2[] =
{
	{ 
		tlGruntRangeAttack2,
		ARRAYSIZE_XASH ( tlGruntRangeAttack2 ), 
		0,
		0,
		"RangeAttack2"
	},
...
Schedule_t	slGruntRepelAttack[] =
{
	{ 
		tlGruntRepelAttack,
		ARRAYSIZE_XASH ( tlGruntRepelAttack ), 
		bits_COND_ENEMY_OCCLUDED,
		0,
		"Repel Attack"
	},
...
Schedule_t	slGruntRepelLand[] =
{
	{ 
		tlGruntRepelLand,
		ARRAYSIZE_XASH ( tlGruntRepelLand ), 
		bits_COND_SEE_ENEMY			|
		bits_COND_NEW_ENEMY			|
		bits_COND_LIGHT_DAMAGE		|
		bits_COND_HEAVY_DAMAGE		|
