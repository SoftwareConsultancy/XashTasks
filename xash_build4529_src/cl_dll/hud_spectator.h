...
public:
	...
	bool AddOverviewEntityToList( HSPRITE_XASH sprite, cl_entity_t * ent, double killTime);
...
private:
	...
	HSPRITE_XASH		m_hsprPlayerBlue;
	HSPRITE_XASH		m_hsprPlayerRed;
	HSPRITE_XASH		m_hsprPlayer;
	HSPRITE_XASH		m_hsprCamera;
	HSPRITE_XASH		m_hsprPlayerDead;
	HSPRITE_XASH		m_hsprViewcone;
	HSPRITE_XASH		m_hsprUnkownMap;
	HSPRITE_XASH		m_hsprBeam;
	HSPRITE_XASH		m_hCrosshair;
