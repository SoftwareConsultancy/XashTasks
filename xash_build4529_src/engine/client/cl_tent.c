...
void CL_AddClientResources( void )
{
	...
	// check sprites first
	for( i = 0; i < ARRAYSIZE_XASH( cl_default_sprites ); i++ )
	{
	...
	// then check sounds
	for( i = 0; i < ARRAYSIZE_XASH( cl_player_shell_sounds ); i++ )
	{
	...
	for( i = 0; i < ARRAYSIZE_XASH( cl_weapon_shell_sounds ); i++ )
	{
	...
	for( i = 0; i < ARRAYSIZE_XASH( cl_explode_sounds ); i++ )
	{
	...
	for( i = 0; i < ARRAYSIZE_XASH( cl_ricochet_sounds ); i++ )
	{
