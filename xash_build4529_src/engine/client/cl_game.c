...
=========
*/
HSPRITE_XASH pfnSPR_LoadExt( const char *szPicName, uint texFlags )
{
	model_t	*spr;
...
=============
*/
const model_t *CL_GetSpritePointer( HSPRITE_XASH hSprite )
{
	model_t	*mod;
...
=========
*/
static int pfnSPR_Frames( HSPRITE_XASH hPic )
{
	int	numFrames;
...
=========
*/
static int pfnSPR_Height( HSPRITE_XASH hPic, int frame )
{
	int	sprHeight;
...
=========
*/
static int pfnSPR_Width( HSPRITE_XASH hPic, int frame )
{
	int	sprWidth;
...
=========
*/
static void pfnSPR_Set( HSPRITE_XASH hPic, int r, int g, int b )
{
...
=============
*/
static void pfnSetCrosshair( HSPRITE_XASH hspr, wrect_t rc, int r, int g, int b )
{
