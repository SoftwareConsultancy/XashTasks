...
_BSS	ENDS
CONST	SEGMENT
$SG16392 DB	'player/pl_wade1.wav', 00H
$SG16394 DB	'player/pl_wade2.wav', 00H
$SG16396 DB	'player/pl_wade3.wav', 00H
$SG16398 DB	'player/pl_wade4.wav', 00H
$SG16466 DB	'Bogus pmove player movetype %i on (%i) 0=cl 1=sv', 0aH, 00H
	ORG $+6
$SG16538 DB	'c', 00H, ':', 00H, '\', 00H, 'u', 00H, 's', 00H, 'e', 00H
...
$SG16539 DB	'i', 00H, 'd', 00H, 'x', 00H, ' ', 00H, '<', 00H, ' ', 00H
	...
	ORG $+2
$SG16546 DB	'c', 00H, ':', 00H, '\', 00H, 'u', 00H, 's', 00H, 'e', 00H
	DB	'r', 00H, 's', 00H, '\', 00H, 'u', 00H, 's', 00H, 'e', 00H, 'r'
	DB	00H, '\', 00H, 'd', 00H, 'o', 00H, 'w', 00H, 'n', 00H, 'l', 00H
	DB	'o', 00H, 'a', 00H, 'd', 00H, 's', 00H, '\', 00H, 'x', 00H, 'a'
	DB	00H, 's', 00H, 'h', 00H, 'x', 00H, 't', 00H, '_', 00H, 'v', 00H
	...
	DB	'm', 00H, 'o', 00H, 'v', 00H, 'e', 00H, '.', 00H, 'c', 00H, 'p'
	DB	00H, 'p', 00H, 00H, 00H
$SG15351 DB	'sound/materials.txt', 00H
$SG16564 DB	'c', 00H, ':', 00H, '\', 00H, 'u', 00H, 's', 00H, 'e', 00H
	DB	'r', 00H, 's', 00H, '\', 00H, 'u', 00H, 's', 00H, 'e', 00H, 'r'
	DB	00H, '\', 00H, 'd', 00H, 'o', 00H, 'w', 00H, 'n', 00H, 'l', 00H
	DB	'o', 00H, 'a', 00H, 'd', 00H, 's', 00H, '\', 00H, 'x', 00H, 'a'
	DB	00H, 's', 00H, 'h', 00H, 'x', 00H, 't', 00H, '_', 00H, 'v', 00H
	...
	DB	'm', 00H, 'o', 00H, 'v', 00H, 'e', 00H, '.', 00H, 'c', 00H, 'p'
	DB	00H, 'p', 00H, 00H, 00H
$SG16565 DB	'!', 00H, 'p', 00H, 'm', 00H, '_', 00H, 's', 00H, 'h', 00H
	DB	'a', 00H, 'r', 00H, 'e', 00H, 'd', 00H, '_', 00H, 'i', 00H, 'n'
	DB	00H, 'i', 00H, 't', 00H, 'i', 00H, 'a', 00H, 'l', 00H, 'i', 00H
	DB	'z', 00H, 'e', 00H, 'd', 00H, 00H, 00H
	ORG $+2
$SG15352 DB	'sound/materials.txt', 00H
$SG15370 DB	'c', 00H, ':', 00H, '\', 00H, 'u', 00H, 's', 00H, 'e', 00H
	DB	'r', 00H, 's', 00H, '\', 00H, 'u', 00H, 's', 00H, 'e', 00H, 'r'
	DB	00H, '\', 00H, 'd', 00H, 'o', 00H, 'w', 00H, 'n', 00H, 'l', 00H
	DB	'o', 00H, 'a', 00H, 'd', 00H, 's', 00H, '\', 00H, 'x', 00H, 'a'
	DB	00H, 's', 00H, 'h', 00H, 'x', 00H, 't', 00H, '_', 00H, 'v', 00H
	...
	DB	'm', 00H, 'o', 00H, 'v', 00H, 'e', 00H, '.', 00H, 'c', 00H, 'p'
	DB	00H, 'p', 00H, 00H, 00H
$SG15371 DB	'p', 00H, 'm', 00H, '_', 00H, 's', 00H, 'h', 00H, 'a', 00H
	DB	'r', 00H, 'e', 00H, 'd', 00H, '_', 00H, 'i', 00H, 'n', 00H, 'i'
	DB	00H, 't', 00H, 'i', 00H, 'a', 00H, 'l', 00H, 'i', 00H, 'z', 00H
	DB	'e', 00H, 'd', 00H, 00H, 00H
$SG15471 DB	'lsnd', 00H
...
$SG15482 DB	'ssnd', 00H
	ORG $+3
$SG15484 DB	'stype', 00H
	ORG $+2
$SG15490 DB	'player/pl_step1.wav', 00H
$SG15492 DB	'player/pl_step3.wav', 00H
$SG15494 DB	'player/pl_step2.wav', 00H
$SG15496 DB	'player/pl_step4.wav', 00H
$SG15499 DB	'player/pl_metal1.wav', 00H
	ORG $+3
$SG15501 DB	'player/pl_metal3.wav', 00H
	ORG $+3
$SG15503 DB	'player/pl_metal2.wav', 00H
	ORG $+3
$SG15505 DB	'player/pl_metal4.wav', 00H
	ORG $+3
$SG15508 DB	'player/pl_dirt1.wav', 00H
$SG15510 DB	'player/pl_dirt3.wav', 00H
$SG15512 DB	'player/pl_dirt2.wav', 00H
$SG15514 DB	'player/pl_dirt4.wav', 00H
$SG15517 DB	'player/pl_duct1.wav', 00H
$SG15519 DB	'player/pl_duct3.wav', 00H
$SG15521 DB	'player/pl_duct2.wav', 00H
$SG15523 DB	'player/pl_duct4.wav', 00H
$SG15526 DB	'player/pl_grate1.wav', 00H
	ORG $+3
$SG15528 DB	'player/pl_grate3.wav', 00H
	ORG $+3
$SG15530 DB	'player/pl_grate2.wav', 00H
	ORG $+3
$SG15532 DB	'player/pl_grate4.wav', 00H
	ORG $+3
$SG15536 DB	'player/pl_tile1.wav', 00H
$SG15538 DB	'player/pl_tile3.wav', 00H
$SG15540 DB	'player/pl_tile2.wav', 00H
$SG15542 DB	'player/pl_tile4.wav', 00H
$SG15544 DB	'player/pl_tile5.wav', 00H
$SG15547 DB	'player/pl_slosh1.wav', 00H
	ORG $+3
$SG15549 DB	'player/pl_slosh3.wav', 00H
	ORG $+3
$SG15551 DB	'player/pl_slosh2.wav', 00H
	ORG $+3
$SG15553 DB	'player/pl_slosh4.wav', 00H
	ORG $+3
$SG15558 DB	'player/pl_wade1.wav', 00H
$SG15560 DB	'player/pl_wade2.wav', 00H
$SG15562 DB	'player/pl_wade3.wav', 00H
$SG15564 DB	'player/pl_wade4.wav', 00H
$SG15567 DB	'player/pl_ladder1.wav', 00H
	ORG $+2
$SG15569 DB	'player/pl_ladder3.wav', 00H
	ORG $+2
$SG15571 DB	'player/pl_ladder2.wav', 00H
	ORG $+2
$SG15573 DB	'player/pl_ladder4.wav', 00H
	ORG $+2
$SG15650 DB	'Too many entities were touched!', 0aH, 00H
	ORG $+3
$SG15660 DB	'PM  Got a NaN velocity %i', 0aH, 00H
	ORG $+1
$SG15662 DB	'PM  Got a NaN origin on %i', 0aH, 00H
$SG15665 DB	'PM  Got a velocity too high on %i', 0aH, 00H
	ORG $+1
$SG15667 DB	'PM  Got a velocity too low on %i', 0aH, 00H
	ORG $+2
$SG16302 DB	'tfc', 00H
$SG16313 DB	'player/pl_wade1.wav', 00H
$SG16315 DB	'player/pl_wade2.wav', 00H
$SG16317 DB	'player/pl_wade3.wav', 00H
$SG16319 DB	'player/pl_wade4.wav', 00H
$SG16324 DB	'player/plyrjmp8.wav', 00H
$SG16325 DB	'slj', 00H
$SG16369 DB	'player/pl_fallpain3.wav', 00H
$SG16372 DB	'tfc', 00H
$SG16374 DB	'player/pl_fallpain3.wav', 00H
CONST	ENDS
