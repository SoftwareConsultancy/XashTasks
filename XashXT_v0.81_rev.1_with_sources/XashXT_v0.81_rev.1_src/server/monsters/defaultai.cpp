...
Schedule_t	slAlertSmallFlinch[] =
{
	{ 
		tlAlertSmallFlinch,
		ARRAYSIZE_XASH ( tlAlertSmallFlinch ),
		0,
		0,
		"Alert Small Flinch"
	},
...
Schedule_t	slInvestigateSound[] =
{
	{ 
		tlInvestigateSound,
		ARRAYSIZE_XASH ( tlInvestigateSound ), 
		bits_COND_NEW_ENEMY			|
		bits_COND_SEE_FEAR			|
		bits_COND_LIGHT_DAMAGE		|
		bits_COND_HEAVY_DAMAGE		|
...
Schedule_t	slPrimaryMeleeAttack[] =
{
	{ 
		...
		ARRAYSIZE_XASH ( tlPrimaryMeleeAttack1 ), 
		bits_COND_NEW_ENEMY			|
		bits_COND_ENEMY_DEAD		|
		bits_COND_LIGHT_DAMAGE		|
		bits_COND_HEAVY_DAMAGE		|
...
Schedule_t	slSecondaryMeleeAttack[] =
{
	{ 
		...
		ARRAYSIZE_XASH ( tlSecondaryMeleeAttack1 ), 
		bits_COND_NEW_ENEMY			|
		bits_COND_ENEMY_DEAD		|
		bits_COND_LIGHT_DAMAGE		|
		bits_COND_HEAVY_DAMAGE		|
...
Schedule_t	slSpecialAttack1[] =
{
	{ 
		tlSpecialAttack1,
		ARRAYSIZE_XASH ( tlSpecialAttack1 ), 
		bits_COND_NEW_ENEMY			|
		bits_COND_ENEMY_DEAD		|
		bits_COND_LIGHT_DAMAGE		|
		bits_COND_HEAVY_DAMAGE		|
...
Schedule_t	slSpecialAttack2[] =
{
	{ 
		tlSpecialAttack2,
		ARRAYSIZE_XASH ( tlSpecialAttack2 ), 
		bits_COND_NEW_ENEMY			|
		bits_COND_ENEMY_DEAD		|
		bits_COND_LIGHT_DAMAGE		|
		bits_COND_HEAVY_DAMAGE		|
...
Schedule_t	slChaseEnemyFailed[] =
{
	{ 
		tlChaseEnemyFailed,
		ARRAYSIZE_XASH ( tlChaseEnemyFailed ), 
		bits_COND_NEW_ENEMY			|
		bits_COND_CAN_RANGE_ATTACK1	|
		bits_COND_CAN_MELEE_ATTACK1	|
		bits_COND_CAN_RANGE_ATTACK2	|
...
{
	{
		...
		ARRAYSIZE_XASH ( tlBarnacleVictimGrab ),
		0,
		0,
		"Barnacle Victim"
	}
...
{
	{
		...
		ARRAYSIZE_XASH ( tlBarnacleVictimChomp ),
		0,
		0,
		"Barnacle Chomp"
	}
...
Schedule_t	slTakeCoverFromOrigin[] =
{
	{ 
		...
		ARRAYSIZE_XASH ( tlTakeCoverFromOrigin ), 
		bits_COND_NEW_ENEMY,
		0,
		"TakeCoverFromOrigin"
	},
...
Schedule_t	slTakeCoverFromBestSound[] =
{
	{ 
		...
		ARRAYSIZE_XASH ( tlTakeCoverFromBestSound ), 
		bits_COND_NEW_ENEMY,
		0,
...
Schedule_t	slTakeCoverFromEnemy[] =
{
	{ 
		...
		ARRAYSIZE_XASH ( tlTakeCoverFromEnemy ), 
		bits_COND_NEW_ENEMY,
		0,
		"tlTakeCoverFromEnemy"
	},
...
{
	return ScheduleInList( pName, m_scheduleList, ARRAYSIZE_XASH(m_scheduleList) );
}
